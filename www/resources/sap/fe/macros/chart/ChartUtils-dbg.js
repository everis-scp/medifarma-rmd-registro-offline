...
sap.ui.define(["sap/ui/model/Filter", "sap/fe/macros/filter/FilterUtils", "sap/ui/model/FilterOperator"], function(
	Filter,
	FilterUtil,
	FilterOperator
) {
	...
	var oChartUtils = {
		 ...
		 * @returns {object} The filterbar filters
		 */
		 ...
		 *
		 * @param {object} oChart The inner chart control
		 * @returns {object} The new filter having both chart and filterbar filters
		 */
