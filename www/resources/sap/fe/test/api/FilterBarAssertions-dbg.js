...
sap.ui.define(
	...
	function(FilterBarAPI, Utils, FEBuilder, OpaBuilder, EditState) {
			...
			return this.prepareResult(
				OpaBuilder.create(this)
					...
					.check(function(aVisualFilters) {
						...
						return (
							sTitle ===
								sMeasureDimensionTitle.getText() + (sScaleUOMTitle.getText() === " | " ? "" : sScaleUOMTitle.getText()) &&
		...
		FilterBarAssertions.prototype.iCheckVisualFilterOverlayText = function(sVisualFilterIdentifier, sOverlayText) {
			return this.prepareResult(
				OpaBuilder.create(this)
					.hasType("sap.fe.core.controls.filterbar.VisualFilter")
					.check(function(aVisualFilters) {
						...
						var oVBox = oVisualFilter.getItems()[1].getItems()[1];
