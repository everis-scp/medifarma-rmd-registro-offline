sap.ui.define(["sap/ui/base/Object",
	...
	], function(BaseObject, SelectionVariant, Device, UIState, listUtils, ControllerExtension, FeLogger, deepEqual, extend, deepExtend, FeError, semanticDateRangeTypeHelper, placeholderHelper, controlStateWrapperFactory) {
	"use strict";
	...
	function getMethods(oState, oController, oTemplateUtils) {
		...
		oSmartChartWrapper = oState.oSmartChart && controlStateWrapperFactory.getControlStateWrapper(oState.oSmartChart);
		oSmartTableWrapper = oState.oSmartTable && controlStateWrapperFactory.getControlStateWrapper(oState.oSmartTable);
		/**
