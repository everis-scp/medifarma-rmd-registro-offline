	...
	"sap/suite/ui/generic/template/js/placeholderHelper"
], function(Controller, listUtils, FeLogger, merge, deepExtend, Device, placeholderHelper) {
		"use strict";
		...
		var cController = Controller.extend("sap.suite.ui.generic.template.AnalyticalListPage.controller.SmartChartController", {
			...
			_onDataReceived: function(oEvent){
				...
				placeholderHelper.resetPlaceHolders(this.oState.oTemplateUtils);
			},
					...
					*/
					this.oState.oSmartChart.attachSelectionDetailsActionPress(function(oEvent) {
						...
						oState.oTemplateUtils.oCommonUtils.fnProcessDataLossOrDraftDiscardConfirmation(function() {
							...
							// // internal navigation
							var oTemplatePrivateGlobalModel = this.oState.oController.getOwnerComponent().getModel("_templPrivGlobal");
