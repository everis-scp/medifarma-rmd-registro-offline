	...
	function(BaseObject, Device, JSONModel, MessageToast, ActionSheet, Dialog, Popover, deletionHelper,
		...
		function getMethods(oTemplateContract) {
			...
			function fnOnBackButtonPressed(){
				...
				if (oCurrentIdentity.treeNode.isDraft && oTemplateContract.oNavigationControllerProxy.isBackLeavingTheMainObject()){
					oTemplateContract.oPageLeaveHandler.performAfterDiscardOrKeepDraft(function(){
