...
sap.ui.define(["sap/ui/thirdparty/jquery"],
	...
	var AggregationUtils = {
		...
		_isLabelEnabled : function (oChild) {
			return this.oGantt && this.oGantt.getSelectOnlyGraphicalShape() && oChild.getVisible() && oChild.renderElement ? true : false;
		},
			...
			aKeySorted.forEach(function(sName){
				...
				if (Array.isArray(aChild)) {
					aChild.forEach(function(oChild) {
						if (this._isLabelEnabled(oChild)){
					...
					if (this._isLabelEnabled(aChild)){
