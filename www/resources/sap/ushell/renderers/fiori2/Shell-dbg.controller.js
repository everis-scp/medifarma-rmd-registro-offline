...
sap.ui.define([
    ...
    return Controller.extend("sap.ushell.renderers.fiori2.Shell", {
        ...
        onInit: function () {
            ...
            }.bind(this)).then(initShellNavigation);
                ...
                .then(function (oResolvedHashFragment, oParsedShellHash) {
                    ...
                    oShellController._handleEarlyNavigation(sFixedShellHash, sAppPart, oResolvedHashFragment).then(function (bProcessed) {
                        if (bProcessed !== true) {
                            ...
                            oInMemoryApplicationInstance = AppLifeCycle.getInMemoryInstance(sIntent, sFixedShellHash, sAppPart, sOldShellHash);
        ...
        _openAppViaNWBC: function (oResolvedHashFragment) {
            ...
            return new Promise(function (fnResolve) {
                ...
                oPromiseParams = new Promise(function (fnResolveParams) {
                    try {
                        ...
                        if (sAppType === "GUI" || sAppType === "TR" || sAppType === "WDA" || sFrameworkId === "GUI" || sFrameworkId === "WDA") {
                ...
                oPromiseParams.then(
                    ...
                    function (oPostBodyParams) {
                        try {
                            ...
                            that._restorePreviousHashAfterOpenNewWindow(oResolvedHashFragment, true);
        ...
        _handleEmbeddedNavMode: function (sFixedShellHash, oParsedShellHash, oMetadata, oResolvedHashFragment) {
            ...
            if (this.currentAppBeforeNav) {
                ...
                oPreviousStatefulContainer = AppLifeCycle.getWebGuiV1StatefulContainer(this.currentAppBeforeNav.url);
