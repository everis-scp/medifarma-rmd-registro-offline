...
sap.ui.define([
    ...
    return Controller.extend("sap.ushell.components.homepage.DashboardContent", {
        ...
        _scrollToGroup: function (sChannelId, sEventId, oData) {
            ...
            oTopElement.scrollIntoView();

            var pPro;
            if (Device.system.desktop) {
                pPro = ComponentKeysHandler.getInstance().then(function (ComponentKeysHandlerInstsance) {
                    ...
                    if (oData.restoreLastFocusedTile) {
                        ...
                        ComponentKeysHandlerInstsance.goToLastVisitedTile(jqTileContainer, bLookForLastVisitedInSameGroup);
                        ...
                        if (jqGroupContent.length) {
                            ComponentKeysHandlerInstsance.moveScrollDashboard(jqGroupContent);
                        }
                    }
                });
            } else {
