    ...
    function compactURLParameters (sUrlExpanded) {
        return new Promise(function (fnResolve, fnReject) {
            ...
            sap.ushell.Container.getService("ShellNavigation")
                .compactParams(
                    oParams,
                    ["sap-language", "sap-theme", "sap-shell", "sap-ui-app-id", "transaction", "sap-iframe-hint", "sap-keep-alive", "sap-ui-versionedLibCss"] /* retain list */,
    ...
    function generateURLTemplateResolutionResult (oMatchingTarget, sBaseUrl, fnExternalSystemAliasResolver) {
        ...
        */
        ...
        return new Promise(function (fnResolve) {
            handleURLTransformation(oResult.url, oCapabilities, oTemplateContext)
                .then(function (sTransformedURL) {
                    oResult.url = sTransformedURL;
                    compactURLParameters(oResult.url)
