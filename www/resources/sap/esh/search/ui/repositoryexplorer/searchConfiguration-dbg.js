 ...
 */
function (SearchResultSetFormatter, SuggestionResultSetFormatter, MetadataFormatter, SearchResultTableExtend, CharMapper, LogicalOperator, ComparisonOperator, ComplexCondition, SimpleCondition, Label, // sap.m
ListMode, Column, ColumnListItem, TableSelectDialog, MessageBox, Filter, // sap.ui
FilterOperator, JSONModel, TextDirection) {
    "use strict";
    /**
     * @type {CharMapper}
     */
    ...
    var configuration = {
        ...
        assembleFilteredDataSources: function (sina) {
            ...
            dataSource.label = sap.esh.search.ui.resources.i18n.getText("all");
            ...
            dataSource = sina.createDataSource({
                id: "recent",
                label: sap.esh.search.ui.resources.i18n.getText("collectionRecentObjects"),
            ...
            dataSource = sina.createDataSource({
                id: "myobjects",
                label: sap.esh.search.ui.resources.i18n.getText("collectionMyObjects"),
            ...
            dataSource = sina.createDataSource({
                id: "shared",
                label: sap.esh.search.ui.resources.i18n.getText("collectionShared"),
            ...
            dataSource = sina.createDataSource({
                id: "favorites",
                label: sap.esh.search.ui.resources.i18n.getText("collectionFavorites"),
        ...
        setQuickSelectDataSourceAllAppearsNotSelected: function (attributeFacet, model) {
            ...
            if (currentDataSource && currentDataSource.id === "SEARCH_DESIGN") {
                var searchFacetQuickSelectSource = "sapUshellSearchFacetQuickSelectDataSource"; // ToDo: ID
        ...
        openSpaceShowMoreDialog: function (dimension, oSearchModel) {
            ...
            return chartQuery.getResultSetAsync().then(function (resultSet) {
                ...
                var oDialog = new TableSelectDialog("", {
                    title: sap.esh.search.ui.resources.i18n.getText("selectspace"),
                    contentWidth: "30rem",
