    ...
    var FioriIntentsResolver = /** @class */ (function (_super) {
        ...
        function FioriIntentsResolver(properties) {
            ...
            if (typeof window !== "undefined" &&
                ...
                window.sap.ushell.Container.getService) {
                _this._launchpadNavigation =
                    window.sap.ushell.Container.getService("SmartNavigation") ||
                        window.sap.ushell.Container.getService("CrossApplicationNavigation");
        ...
        FioriIntentsResolver.prototype._doResolveIntents = function (vArgs) {
            ...
            var primaryIntentProm = new Promise(function (resolve, reject) {
                if (that._launchpadNavigation.getPrimaryIntent) {
                    that._launchpadNavigation
                        .getPrimaryIntent(semanticObjectType, semanticObjectTypeAttrsAsParams)
                        .done(function (primaryIntent) {
