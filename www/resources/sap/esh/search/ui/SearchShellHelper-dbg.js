...
sap.ui.define([
...
], function (SearchFieldGroup, SearchHelper, ButtonType, InvisibleText, Log, Device) {
    "use strict";
    var module = {};
    ...
    jQuery.extend(module, {
        init: function () {
            ...
            var oLabel = new InvisibleText("selectLabel", {
                text: sap.esh.search.ui.resources.i18n.getText("searchIn"),
            });
            if (oLabel) {
                // avoid grunt error: "oLabel" is defined but never used
                that.oSearchSelect.addAriaLabelledBy("selectLabel");
            }
            that.oSearchSelect.setTooltip(sap.esh.search.ui.resources.i18n.getText("searchInTooltip"));
            that.oSearchSelect.addEventDelegate({
                onAfterRendering: function () {
                    jQuery('[id$="searchFieldInShell-select-icon"]').attr("title", sap.esh.search.ui.resources.i18n.getText("searchIn"));
                },
            }, that.oSearchSelect);
            that.oSearchSelect.setTooltip(sap.esh.search.ui.resources.i18n.getText("searchIn"));
