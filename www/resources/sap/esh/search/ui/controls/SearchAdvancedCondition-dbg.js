...
sap.ui.define([
    ...
    "sap/ui/core/Item",
    "sap/m/Label",
], function (HorizontalLayout, Button, ButtonType, Input, Select, CheckBox, DateRangeSelection, InvisibleText, Item, Label) {
    "use strict";
        ...
        contentFactory: function (options) {
            ...
            if (!oAdvancedCheckBoxLabel) {
                oAdvancedCheckBoxLabel = new InvisibleText("advancedCheckBoxLabel", {
                    text: sap.esh.search.ui.resources.i18n.getText("checkBox"),
                });
            }
            ...
            if (!oOperatorLabel) {
                oOperatorLabel = new InvisibleText("operatorLabel", {
                    text: sap.esh.search.ui.resources.i18n.getText("operator"),
                });
            }
            ...
            switch (options.type) {
                ...
                case "string":
                    ...
                    oInputBox = new Input({
                        width: "57%",
                        placeholder: sap.esh.search.ui.resources.i18n.getText("filterCondition"),
                    ...
                    oSelect = new Select({
                        width: "40%",
                        tooltip: sap.esh.search.ui.resources.i18n.getText("operator"),
                        items: [
                            new Item({
                                text: sap.esh.search.ui.resources.i18n.getText("equals"),
                                key: "eq",
                            }),
                            new Item({
                                text: sap.esh.search.ui.resources.i18n.getText("beginsWith"),
                                key: "bw",
                            }),
                            new Item({
                                text: sap.esh.search.ui.resources.i18n.getText("endsWith"),
                                key: "ew",
                            }),
                            new Item({
                                text: sap.esh.search.ui.resources.i18n.getText("contains"),
                                key: "co",
                            }),
                        ],
                    ...
                    oButton = new Button({
                        ...
                        tooltip: sap.esh.search.ui.resources.i18n.getText("removeButton"),
                ...
                case "text":
                    ...
                    oSelect = new Select({
                        ...
                        items: [
                            new Item({
                                text: sap.esh.search.ui.resources.i18n.getText("containsWords"),
                                key: "co",
                            }),
                        ],
                    }).addStyleClass("sapUshellSearchFacetDialogDetailPageConditionSelect");
                ...
                case "number":
                    var oInputBoxLeft = new Input({
                        width: "46.5%",
                        placeholder: sap.esh.search.ui.resources.i18n.getText("fromPlaceholder"),
                        liveChange: function (oEvent) {
                    ...
                    var oInputBoxRight = new Input({
                        width: "46.5%",
                        placeholder: sap.esh.search.ui.resources.i18n.getText("toPlaceholder"),
                        liveChange: function (oEvent) {
                            that.onAdvancedNumberInputChange(oEvent);
                        },
                    }).addStyleClass("sapUshellSearchFacetDialogDetailPageConditionInput");
