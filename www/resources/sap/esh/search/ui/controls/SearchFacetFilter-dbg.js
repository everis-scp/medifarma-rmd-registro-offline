...
sap.ui.define([
...
], function (IconTabFilter, Button, errors, SearchFacetQuickSelectDataSource, SearchFacetHierarchy, SearchFacet, SearchFacetTabBar, SearchFacetBarChart, SearchFacetPieChart) {
    "use strict";
    SearchFacetTabBar.extend("my.IconTabBar", {
    ...
    return sap.ui.core.Control.extend("sap.esh.search.ui.controls.SearchFacetFilter", {
        ...
        constructor: function (oOptions) {
            ...
            this.bindAggregation("facets", "/facets", function (id, context) {
                var facet = context.getObject();
                ...
                switch (facet.facetType) {
                    case "attribute":
                        ...
                        var oIconTabBar = new my.IconTabBar(sId, {
                            items: [
                                new IconTabFilter({
                                    text: sap.esh.search.ui.resources.i18n.getText("facetList"),
                                    icon: "sap-icon://list",
                                    key: "list" + arguments[0],
                                    content: new SearchFacet("list" + arguments[0]),
                                }),
                                new IconTabFilter({
                                    text: sap.esh.search.ui.resources.i18n.getText("facetBarChart"),
                                    icon: "sap-icon://horizontal-bar-chart",
                                    key: "barChart" + arguments[0],
                                    content: new SearchFacetBarChart(barchartOptions),
                                }),
                                new IconTabFilter({
                                    text: sap.esh.search.ui.resources.i18n.getText("facetPieChart"),
                        ...
                        return oIconTabBar;
                    case "datasource":
                        return new SearchFacet((id ? id + "-" : "") + "dataSourceFacet");
                    case "quickSelectDataSource":
                        return new SearchFacetQuickSelectDataSource(config && config.id
                            ? config.id + "-sapUshellSearchFacetQuickSelectDataSource"
            ...
            for (var i = 0, len = oControl.getFacets().length; i < len; i++) {
                ...
                switch (facetModel.facetType) {
                    case "attribute":
                        ...
                        if (facetModel.position > 999) {
                            ...
                            if (isFirstAttributeFacet) {
                                facet.setHeaderText(sap.esh.search.ui.resources.i18n.getText("filterBy"));
                    ...
                    case "datasource":
                        ...
                        break;
                    case "quickSelectDataSource":
                        facet.setHeaderText(sap.esh.search.ui.resources.i18n.getText("quickSelectDataSourcesHeader"));
                        oRm.renderControl(facet);
                        break;
                    case "hierarchy":
                        if (facetModel.position > 999) {
