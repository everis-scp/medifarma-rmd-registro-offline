 ...
 */
sap.ui.define(["sap/m/Select", "sap/m/SelectType", "sap/ui/core/Item", "sap/ui/model/BindingMode"], function (Select, SelectType, Item, BindingMode) {
    "use strict";
    return Select.extend("sap.esh.search.ui.controls.SearchSelect", {
        constructor: function (sId, options) {
            options = jQuery.extend({}, {
                ...
                tooltip: sap.esh.search.ui.resources.i18n.getText("searchIn") +
                    " {/uiFilter/dataSource/labelPlural}",
                change: function () {
