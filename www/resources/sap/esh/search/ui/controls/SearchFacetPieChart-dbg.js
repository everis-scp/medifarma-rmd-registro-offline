...
*/
                    ...
                    if (percMissing > 0) {
                        ...
                        item.tooltip = sap.esh.search.ui.resources.i18n.getText("facetPieChartOverflowText", [
                            label,
                        ]);
                        item.filtered = false;
                        item.removed = false;
            ...
            if (model) {
                ...
                if ($(piechartParent).parent()[0].className === "sapMLIBContent") {
                    ...
                    if (that.iMissingCnt > 0) {
                        ...
                        var message = sap.esh.search.ui.resources.i18n.getText("infoZeileNumberMoreSelected", [that.iMissingCnt]);
