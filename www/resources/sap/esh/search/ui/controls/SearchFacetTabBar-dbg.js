...
sap.ui.define([
...
], function (Control, Button, ButtonRenderer, SegmentedButtonItem, Log, SearchFacetDialogModel, Title, List, CustomListItem, Toolbar, ToolbarSpacer, GroupHeaderListItemRenderer, GroupHeaderListItem, ListSeparators, ActionSheet, PlacementType, Link, Label, VBox) {
    "use strict";
    ...
    sap.esh.search.ui.controls.SearchGroupHeaderListItemRenderer.renderCounterContent = function (rm, oLI, btn) {
        rm.write("<div>");
    ...
    return Control.extend("sap.esh.search.ui.controls.SearchFacetTabBar", {
        ...
        renderer: function (oRm, oControl) {
            ...
            var createOpenFacetDialogFn = function (iSelectedTabBarIndex, aTabBarItems) {
                return function () {
                    ...
                    oFacetDialogModel.initBusinessObjSearch().then(function () {
                        ...
                        // DWC exit, open specific show more for space facet
            ...
            oDropDownButton.onAfterRendering = function () {
                $(this.getDomRef()).attr("aria-label", sap.esh.search.ui.resources.i18n.getText("dropDown"));
            };
            // RENDERING
            ...
            if (oControl.getHeaderText()) {
                ...
                oResetButton.onAfterRendering = function () {
                    $(this.getDomRef()).attr("aria-label", sap.esh.search.ui.resources.i18n.getText("resetFilterButton_tooltip"));
                };
            ...
            var oShowMore = new Link({
                text: sap.esh.search.ui.resources.i18n.getText("showMore"),
