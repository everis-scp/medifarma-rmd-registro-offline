...
sap.ui.define([
    ...
    "sap/m/ValueColor",
    "sap/ui/core/Control",
], function (ComparisonMicroChart, ComparisonMicroChartData, ValueColor, Control) {
    "use strict";
    return Control.extend("sap.ushell.renderers.fiori2.search.controls.SearchFacetBarChart", {
        ...
        onAfterRendering: function () {
            ...
            if (that.iMissingCnt > 0) {
                ...
                var message = sap.esh.search.ui.resources.i18n.getText("infoZeileNumberMoreSelected", [
                    that.iMissingCnt,
                ]);
