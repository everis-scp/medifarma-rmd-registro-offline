 ...
 */
// @ts-check
sap.ui.define(["sap/ui/base/Object", "sap/base/Log", "sap/m/MessageBox", "sap/ui/core/TextDirection"], 
/**
 * @param {sap.ui.base.Object} BaseObject
 * @param {*} Log
 * @param {sap.m.MessageBox} MessageBox
 */
function (BaseObject, Log, MessageBox, TextDirection) {
    ("use strict");
    var ErrorHandler = sap.ui.base.Object.extend("sap.esh.search.ui.error.ErrorHandler", {
        ...
        defaultErrorHandler: function (error) {
            ...
            var title = error.name || sap.esh.search.ui.resources.i18n.getText("searchError");
            var message = error.message || sap.esh.search.ui.resources.i18n.getText("error.message");
            var solution = error.solution || sap.esh.search.ui.resources.i18n.getText("error.solution");
            var details = sap.esh.search.ui.resources.i18n.getText("error.details");
            // Special error handling, should only be necessary if not already done in errors.js:
            switch (error.name) {
                case "TypeError":
                    {
                        message = sap.esh.search.ui.resources.i18n.getText("error.TypeError.message");
                        solution = sap.esh.search.ui.resources.i18n.getText("error.TypeError.solution");
                    }
                    break;
                case "URIError":
                    {
                        solution = sap.esh.search.ui.resources.i18n.getText("error.URIError.solution");
                    }
                    break;
                case "DataSourceAttributeMetadataNotFoundError":
                    {
                        message = sap.esh.search.ui.resources.i18n.getText("error.sina.DataSourceAttributeMetadataNotFoundError.message");
                        solution = sap.esh.search.ui.resources.i18n.getText("error.sina.DataSourceAttributeMetadataNotFoundError.solution");
                    }
                    break;
                case "NoValidEnterpriseSearchAPIConfigurationFoundError":
                    {
                        message =
                            sap.esh.search.ui.resources.i18n.getText("error.sina.NoValidEnterpriseSearchAPIConfigurationFoundError.message") +
                                "\n" +
                                error.message; // add tried providers
                        solution = sap.esh.search.ui.resources.i18n.getText("error.sina.NoValidEnterpriseSearchAPIConfigurationFoundError.solution");
                    }
                    break;
                case "InBetweenConditionInConsistent": {
                    message = sap.esh.search.ui.resources.i18n.getText("error.sina.InBetweenConditionInConsistent.description");
                    solution = sap.esh.search.ui.resources.i18n.getText("error.sina.InBetweenConditionInConsistent.solution");
                }
            }
