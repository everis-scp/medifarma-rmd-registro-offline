...
sap.ui.define([
    ...
    "sap/m/ActionSheet",
    "sap/m/PlacementType",
], function (SearchFacetPieChart, Log, ComparisonMicroChart, Label, IconTabFilter, Button, Bar, BarDesign, Filter, FilterOperator, ResizeHandler, ComparisonMicroChartData, ValueColor, ActionSheet, PlacementType) {
    "use strict";
    var module = {};
    jQuery.extend(module, {
        ...
        testWhetherPieWedgeOrLabelIsDummy: function (oEvent) {
            ...
            try {
                ...
                if (label ===
                    sap.esh.search.ui.resources.i18n.getText("facetPieChartOverflowText2", [
                        possibleNumPerc,
                        possibleNumTop,
                    ])) {
                    res = true;
