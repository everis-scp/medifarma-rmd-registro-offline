 ...
 */
sap.ui.define(["./SearchHelper", "./error/errors"], function (SearchHelper, errors) {
    "use strict";
                ...
                switch (dataSourceJson.Type) {
                    ...
                    case "BusinessObject":
                        ...
                        if (!dataSource) {
                            ...
                            sap.m.MessageBox.show(sap.esh.search.ui.resources.i18n.getText("searchUrlParsingErrorLong") +
                                "\n(Unknow datasource " +
                                dataSourceId +
                                ")", {
