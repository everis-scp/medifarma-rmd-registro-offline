...
sap.ui.define(["sap/ui/model/json/JSONModel", "sap/esh/search/ui/SearchHelper"], function (JSONModel, SearchHelper) {
    "use strict";
    ...
    return JSONModel.extend(path, {
        ...
        asyncInit: function () {
            ...
            that.initializePromise = SearchHelper.convertJQueryDeferredToPromise(that.searchModel.initBusinessObjSearch()).then(function () {
            ...
            this.searchModel.getUserCategoryManager().then(function (userCategoryManager) {
                ...
                for (var _a = 0, undefinedSubDataSources_1 = undefinedSubDataSources; _a < undefinedSubDataSources_1.length; _a++) {
                    ...
                    newDS.unshift({
                        ...
                        label: undefinedSubDataSource +
                            " " +
                            sap.esh.search.ui.resources.i18n.getText("sp.connectorNotExists"),
                        selected: true,
                        undefined: true,
                    });
                }
        ...
        shortStatus: function () {
            return this.asyncInit().then(function () {
                return this.getProperty("/personalizedSearch")
                    ? sap.esh.search.ui.resources.i18n.getText("sp.on")
                    : sap.esh.search.ui.resources.i18n.getText("sp.off");
            }.bind(this));
        },
