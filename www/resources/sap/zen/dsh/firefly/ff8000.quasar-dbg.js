...
{
	this.sendEventWithName(event, oFF.UiEventDef.ON_SELECT);
};
oFF.QuasarEngine.prototype.onSelectionChange = function(event)
{
	this.sendEventWithName(event, oFF.UiEventDef.ON_SELECTION_CHANGE);
};
oFF.QuasarEngine.prototype.onChange = function(event)
{
	this.sendEventWithName(event, oFF.UiEventDef.ON_CHANGE);
};
oFF.QuasarEngine.prototype.onLiveChange = function(event)
{
	this.sendEventWithName(event, oFF.UiEventDef.ON_LIVE_CHANGE);
};
oFF.QuasarEngine.prototype.onDelete = function(event)
{
	this.sendEventWithName(event, oFF.UiEventDef.ON_DELETE);
};
oFF.QuasarEngine.prototype.onDetailPress = function(event)
{
	this.sendEventWithName(event, oFF.UiEventDef.ON_DETAIL_PRESS);
};
oFF.QuasarEngine.prototype.onMove = function(event)
{
	this.sendEventWithName(event, oFF.UiEventDef.ON_MOVE);
};
oFF.QuasarEngine.prototype.onMoveStart = function(event)
{
	this.sendEventWithName(event, oFF.UiEventDef.ON_MOVE_START);
};
oFF.QuasarEngine.prototype.onMoveEnd = function(event)
{
	this.sendEventWithName(event, oFF.UiEventDef.ON_MOVE_END);
};
oFF.QuasarEngine.prototype.onResize = function(event)
{
	this.sendEventWithName(event, oFF.UiEventDef.ON_RESIZE);
};
oFF.QuasarEngine.prototype.onSuggestionSelect = function(event)
{
	this.sendEventWithName(event, oFF.UiEventDef.ON_SUGGESTION_SELECT);
};
oFF.QuasarEngine.prototype.onScroll = function(event)
{
	this.sendEventWithName(event, oFF.UiEventDef.ON_SCROLL);
};
oFF.QuasarEngine.prototype.onScrollLoad = function(event)
{
	this.sendEventWithName(event, oFF.UiEventDef.ON_SCROLL_LOAD);
};
oFF.QuasarEngine.prototype.onHover = function(event)
{
	this.sendEventWithName(event, oFF.UiEventDef.ON_HOVER);
};
oFF.QuasarEngine.prototype.onHoverEnd = function(event)
{
	this.sendEventWithName(event, oFF.UiEventDef.ON_HOVER_END);
};
oFF.QuasarEngine.prototype.onPaste = function(event)
{
	this.sendEventWithName(event, oFF.UiEventDef.ON_PASTE);
};
oFF.QuasarEngine.prototype.onEnter = function(event)
{
	this.sendEventWithName(event, oFF.UiEventDef.ON_ENTER);
};
oFF.QuasarEngine.prototype.onPress = function(event)
{
	this.sendEventWithName(event, oFF.UiEventDef.ON_PRESS);
};
oFF.QuasarEngine.prototype.onEditingBegin = function(event)
{
	this.sendEventWithName(event, oFF.UiEventDef.ON_EDITING_BEGIN);
};
oFF.QuasarEngine.prototype.onEditingEnd = function(event)
{
	this.sendEventWithName(event, oFF.UiEventDef.ON_EDITING_END);
};
oFF.QuasarEngine.prototype.onBack = function(event)
{
	this.sendEventWithName(event, oFF.UiEventDef.ON_BACK);
};
oFF.QuasarEngine.prototype.onRefresh = function(event)
{
	this.sendEventWithName(event, oFF.UiEventDef.ON_REFRESH);
};
oFF.QuasarEngine.prototype.onLoadFinished = function(event)
{
	this.sendEventWithName(event, oFF.UiEventDef.ON_LOAD_FINISHED);
};
oFF.QuasarEngine.prototype.onOpen = function(event)
{
	this.sendEventWithName(event, oFF.UiEventDef.ON_OPEN);
};
oFF.QuasarEngine.prototype.onClose = function(event)
{
	this.sendEventWithName(event, oFF.UiEventDef.ON_CLOSE);
};
oFF.QuasarEngine.prototype.onBeforeOpen = function(event)
{
	this.sendEventWithName(event, oFF.UiEventDef.ON_BEFORE_OPEN);
};
oFF.QuasarEngine.prototype.onBeforeClose = function(event)
{
	this.sendEventWithName(event, oFF.UiEventDef.ON_BEFORE_CLOSE);
};
oFF.QuasarEngine.prototype.onAfterOpen = function(event)
{
	this.sendEventWithName(event, oFF.UiEventDef.ON_AFTER_OPEN);
};
oFF.QuasarEngine.prototype.onAfterClose = function(event)
{
	this.sendEventWithName(event, oFF.UiEventDef.ON_AFTER_CLOSE);
};
oFF.QuasarEngine.prototype.onClick = function(event)
{
	this.sendEventWithName(event, oFF.UiEventDef.ON_CLICK);
};
oFF.QuasarEngine.prototype.onContextMenu = function(event)
{
	this.sendEventWithName(event, oFF.UiEventDef.ON_CONTEXT_MENU);
};
oFF.QuasarEngine.prototype.onDoubleClick = function(event)
{
	this.sendEventWithName(event, oFF.UiEventDef.ON_DOUBLE_CLICK);
};
oFF.QuasarEngine.prototype.onCollapse = function(event)
{
	this.sendEventWithName(event, oFF.UiEventDef.ON_COLLAPSE);
};
oFF.QuasarEngine.prototype.onExpand = function(event)
{
	this.sendEventWithName(event, oFF.UiEventDef.ON_EXPAND);
};
oFF.QuasarEngine.prototype.onSelectionFinish = function(event)
{
	this.sendEventWithName(event, oFF.UiEventDef.ON_SELECTION_FINISH);
};
oFF.QuasarEngine.prototype.onSearch = function(event)
{
	this.sendEventWithName(event, oFF.UiEventDef.ON_SEARCH);
};
oFF.QuasarEngine.prototype.onButtonPress = function(event)
{
	this.sendEventWithName(event, oFF.UiEventDef.ON_BUTTON_PRESS);
};
oFF.QuasarEngine.prototype.onError = function(event)
{
	this.sendEventWithName(event, oFF.UiEventDef.ON_ERROR);
};
oFF.QuasarEngine.prototype.onReadLineFinished = function(event)
{
	this.sendEventWithName(event, oFF.UiEventDef.ON_READ_LINE_FINISHED);
};
oFF.QuasarEngine.prototype.onExecute = function(event)
{
	this.sendEventWithName(event, oFF.UiEventDef.ON_EXECUTE);
};
oFF.QuasarEngine.prototype.onTerminate = function(event)
{
	this.sendEventWithName(event, oFF.UiEventDef.ON_TERMINATE);
};
oFF.QuasarEngine.prototype.onFileDrop = function(event)
{
	this.sendEventWithName(event, oFF.UiEventDef.ON_FILE_DROP);
};
oFF.QuasarEngine.prototype.onDrop = function(event)
{
	this.sendEventWithName(event, oFF.UiEventDef.ON_DROP);
};
...
oFF.QuasarProgram.prototype.getDefaultProgramName = function()
{
	return "Quasar";
};
