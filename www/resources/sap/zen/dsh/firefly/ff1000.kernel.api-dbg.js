...
oFF.ProgramType.STANDARD = null;
oFF.ProgramType.SUBSYSTEM = null;
oFF.ProgramType.s_lookup = null;
oFF.ProgramType.staticSetup = function()
{
	oFF.ProgramType.s_lookup = oFF.XHashMapByString.create();
	oFF.ProgramType.STANDARD = oFF.ProgramType.create("Standard");
	oFF.ProgramType.SUBSYSTEM = oFF.ProgramType.create("SubSystem");
};
oFF.ProgramType.create = function(name)
{
	var theConstant = oFF.XConstant.setupName(new oFF.ProgramType(), name);
...
oFF.ProcessEventType.INITIALIZED = null;
...
oFF.ProcessEventType.SHUTDOWN_FINISHED = null;
oFF.ProcessEventType.staticSetup = function()
{
	oFF.ProcessEventType.INITIALIZED = oFF.ProcessEventType.create("Initialized");
	...
	oFF.ProcessEventType.SHUTDOWN_FINISHED = oFF.ProcessEventType.create("ShutdownFinished");
};
