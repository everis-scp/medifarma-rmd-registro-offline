...
sap.ui.define(
[
"sap/zen/dsh/firefly/ff2040.shell","sap/zen/dsh/firefly/ff8100.studio","sap/zen/dsh/firefly/ff2210.ui.native","sap/zen/dsh/firefly/ff8050.application.ui","sap/zen/dsh/firefly/ff8090.poseidon","sap/zen/dsh/firefly/ff4220.olap.catalog.api","sap/zen/dsh/firefly/ff4410.olap.ip.providers","sap/zen/dsh/firefly/ff4330.olap.catalog.impl","sap/zen/dsh/firefly/ff4340.olap.reference"
],
function(oFF)
{
"use strict";
...
oFF.ClientUIComponents = {
	...
	addUiElements:function(headBuffer, pathToSources)
	{
		...
		oFF.ClientUIComponents.addSrc(headBuffer, oFF.ClientUIComponents.preparePackageName("oFF.UxTabStrip", false), pathDef, "text/javascript");
		oFF.ClientUIComponents.addSrc(headBuffer, oFF.ClientUIComponents.preparePackageName("oFF.UxTabStripItem", false), pathDef, "text/javascript");
...
oFF.SxValueHelpDialogDimMember.prototype.setupDialog = function(root, valueHelp, callback, customIdentifier, mode)
{
	...
	this.m_dialog.setWidthExt(200, oFF.UiSizeUnit.EM).setHeightExt(200, oFF.UiSizeUnit.EM);
...
{
	var selectedItem = event.getSelectedItem();
	var node = selectedItem.getCustomObject();
...
oFF.SxValueHelpDialogDimMember.prototype.onExpand = function(event)
{
	...
	{
		selectedItem.addNewItem().setCustomObject(oFF.SxValueHelpElement.FETCHING).setText(oFF.SxValueHelpElement.FETCHING.getText());
		node.processValueHelpFetch(oFF.SyncType.NON_BLOCKING, this, selectedItem);
	}
};
...
oFF.SxVarDimMemberLine.prototype.setupLine = function(uiVariable, row, filterElement, dimMemberVariable)
{
	...
	if (oFF.notNull(supportedSetSign))
	{
		...
		this.m_setSign.setWidthExt(10, oFF.UiSizeUnit.EM);
	...
	if (oFF.notNull(supportedComparisonOperators) && supportedComparisonOperators.size() > 0)
	{
		...
		this.m_comparison.setWidthExt(10, oFF.UiSizeUnit.EM);
	...
	this.m_inputLow.setWidthExt(10, oFF.UiSizeUnit.EM);
	...
	if (oFF.notNull(supportedComparisonOperators) && supportedComparisonOperators.contains(oFF.ComparisonOperator.BETWEEN))
	{
		...
		this.m_inputHigh.setWidthExt(10, oFF.UiSizeUnit.EM);
...
oFF.SxVarScreen.prototype.buildTree = function(uiParent, simplex, variableManager)
{
	...
	if (this.m_isVerbose)
	{
		...
		headerRow.getMatrixLayoutCell(0).setWidthExt(5, oFF.UiSizeUnit.EM);
		headerRow.getMatrixLayoutCell(1).setWidthExt(5, oFF.UiSizeUnit.EM);
		headerRow.getMatrixLayoutCell(2).setWidthExt(5, oFF.UiSizeUnit.EM);
		headerRow.getMatrixLayoutCell(3).setWidthExt(15, oFF.UiSizeUnit.EM);
		headerRow.getMatrixLayoutCell(4).setWidthExt(30, oFF.UiSizeUnit.EM);
		headerRow.getMatrixLayoutCell(5).setWidthExt(20, oFF.UiSizeUnit.EM);
		headerRow.getMatrixLayoutCell(6).setWidthExt(20, oFF.UiSizeUnit.EM);
		headerRow.getMatrixLayoutCell(7).setWidthExt(20, oFF.UiSizeUnit.EM);
		headerRow.getMatrixLayoutCell(8).setWidthExt(20, oFF.UiSizeUnit.EM);
		headerRow.getMatrixLayoutCell(9).setWidthExt(5, oFF.UiSizeUnit.EM);
		headerRow.getMatrixLayoutCell(10).setWidthExt(5, oFF.UiSizeUnit.EM);
	}
...
oFF.SxVarSimpleTypeLine.prototype.setupLine = function(uiVariable, row, value, simpleTypeVariable)
{
	...
	this.m_input.setWidthExt(5, oFF.UiSizeUnit.EM);
	if (oFF.notNull(value))
	{
...
oFF.SxVarSimpleTypeSingle.prototype.renderLine = function(line, row)
{
	...
	this.m_input.setWidthExt(20, oFF.UiSizeUnit.EM);
	return this;
};
...
oFF.PivotTableSettings.prototype.getWidthValue = function()
{
	return 0;
};
oFF.PivotTableSettings.prototype.setWidthValue = function(value)
{
	return null;
};
oFF.PivotTableSettings.prototype.setHeightCss = function(height)
{
	return null;
};
oFF.PivotTableSettings.prototype.getHeightValue = function()
{
	return 0;
};
...
oFF.PivotTableSettings.prototype.setHeightValue = function(value)
{
	return null;
};
oFF.PivotTableSettings.prototype.getWidthUnit = function()
{
	return null;
};
oFF.PivotTableSettings.prototype.setWidthUnit = function(unit)
{
	return null;
};
oFF.PivotTableSettings.prototype.setWidthExt = function(width, unit)
{
	return null;
};
oFF.PivotTableSettings.prototype.setHeightExt = function(height, unit)
{
	return null;
};
oFF.PivotTableSettings.prototype.getHeightUnit = function()
{
	return null;
};
oFF.PivotTableSettings.prototype.setHeightUnit = function(unit)
{
	return null;
};
oFF.PivotTableSettings.prototype.getWidthCss = function()
{
	return null;
};
oFF.PivotTableSettings.prototype.setWidthCss = function(width)
{
	return null;
};
oFF.PivotTableSettings.prototype.getHeightCss = function()
{
	return null;
};
...
oFF.SxInASpec.addCapabilities = function(parent)
{
	...
	capabilities.addCapability(oFF.InACapabilities.V122_CUSTOM_DIMENSION_2);
	...
	capabilities.addCapability(oFF.InACapabilities.V121_UNIFIED_DATA_CELLS);
...
oFF.SxInADocu.prototype.buildUi = function(genesis)
{
	...
	this.m_tree = uiSplitter.setNew(oFF.UiType.TREE, oFF.UiPosition.LEFT);
	this.m_tree.registerOnSelect(this);
	this.m_tree.registerOnExpand(this).registerOnCollapse(this);
	this.m_text = uiSplitter.setNew(oFF.UiType.TEXT_AREA, oFF.UiPosition.RIGHT);
...
{
	var selectedItem = event.getSelectedItem();
	var customObject = selectedItem.getCustomObject();
...
oFF.SxUiLab.prototype.buildUi = function(genesis)
{
	...
	var uiSplitter = genesis.newControl(oFF.UiType.VERTICAL_SPLITTER);
	uiSplitter.useMaxSpace();
	var tree = uiSplitter.setNew(oFF.UiType.TREE, oFF.UiPosition.LEFT);
	tree.registerOnContextMenu(this).registerOnSelect(this);
...
oFF.SxUiLab.prototype.setTextForItem = function(action, newModelComponent)
{
	...
	{
		if (action.m_type === oFF.UiType.BUTTON || action.m_type === oFF.UiType.TEXT_AREA || action.m_type === oFF.UiType.TAB_STRIP_ITEM || action.m_type === oFF.UiType.TREE_ITEM || action.m_type === oFF.UiType.DROPDOWN_ITEM)
		{
...
oFF.SxVariablePrompt.prototype.buildUi = function(genesis)
{
	...
	this.m_datasourceDd.setWidthExt(280, oFF.UiSizeUnit.PIXEL);
	...
	this.m_textArea.setHeightExt(300, oFF.UiSizeUnit.PIXEL);
...
oFF.HrEpiphagi.prototype.getDefaultWindowSize = function()
{
...
oFF.HrEpiphagi.prototype.getDefaultProgramName = function()
{
...
oFF.HrEpiphagi.prototype.buildUi = function(genesis)
{
	...
	mainWrapperLayout.setPaddingCss("10px");
	...
	programRenderWrapperLayout.setHeightCss("50px");
	...
	programRenderWrapperLayout.addNewItemOfType(oFF.UiType.SPACER).setWidthCss("10px");
	...
	saveOutputWrapperLayout.setHeightCss("50px");
	...
	this.m_outputFileInput.setWidthCss("50%");
	saveOutputWrapperLayout.addNewItemOfType(oFF.UiType.SPACER).setWidthCss("10px");
	...
	textWrapperLayout.setHeightCss("100%");
	...
	this.m_renderTemplateTextArea.setHeightCss("100%");
	this.m_renderTemplateTextArea.setWidthCss("50%");
	this.m_renderTemplateTextArea.setText(oFF.HrEpiphagi.HTML_TEMPLATE);
	this.m_renderOutputText = textWrapperLayout.addNewItemOfType(oFF.UiType.TEXT).setHeaderHeightCss("300px");
	this.m_renderOutputText.setName("renderOutputText");
	this.m_renderOutputText.setText("HTML Output");
	this.m_renderOutputText.setHeightCss("100%");
	this.m_renderOutputText.setWidthCss("50%");
};
oFF.HrEpiphagi.prototype.renderHeadless = function(prgName, prgArgs, template)
{
	...
	if (oFF.notNull(prgFactory))
	{
		...
		var newSubSession = session.newSubSession();
...
oFF.SxQuery.prototype.buildUi = function(genesis)
{
	...
	this.resolveArgs();
	this.setTitle("Query");
	this.m_tabStrip = genesis.newControl(oFF.UiType.TAB_STRIP);
	...
	this.m_queryText.setWidthValue(100).setWidthUnit(oFF.UiSizeUnit.PERCENT);
	this.m_queryText.setHeightValue(600).setHeightUnit(oFF.UiSizeUnit.PIXEL);
...
oFF.SxQuery.prototype.createVariablesTabDialog = function(varProcessor)
{
	...
	var genesis = oFF.UiGenesis.create(tab, oFF.UiPosition.CONTENT, oFF.UiOperation.SET, 0, 0);
	var layout = genesis.newControl(oFF.UiType.VERTICAL_LAYOUT);
