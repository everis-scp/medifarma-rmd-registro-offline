...
oFF.SxAppStoreAppItem.prototype.buildAppItem = function()
{
	...
	this.m_appItemListItem.setMargin(oFF.UiUnitValue.createByCss("5px"));
	this.m_appItemListItem.setBorderSize(oFF.UiUnitValue.createByCss("0px"));
	...
	appItemWrapperLayout.setBackgroundColor(oFF.UiColor.createByString("#f0f2f4"));
	appItemWrapperLayout.setCornerRadiusCss("10px");
	appItemWrapperLayout.setBorderSizeCss("1px");
	appItemWrapperLayout.setBorderColor(oFF.UiColor.createByString("#a0a8b0"));
	appItemWrapperLayout.setPaddingCss("5px");
	...
	appAppIcon.setHeightCss("77px");
	appAppIcon.setPaddingCss("0px");
	var appTileTitleDescWrapper = appItemWrapperLayout.addNewItemOfType(oFF.UiType.FLEX_LAYOUT);
	appTileTitleDescWrapper.setHeightCss("100%");
	...
	appTileTitleDescWrapper.setMarginCss("5px");
	...
	appDescriptionLbl.setHeightCss("75%");
	appDescriptionLbl.setFontSizeCss("100%");
	appDescriptionLbl.setMarginCss("5px");
	...
	var buttonSpacer = appItemWrapperLayout.addNewItemOfType(oFF.UiType.SPACER);
	buttonSpacer.setFlex("0 0 20px");
...
oFF.SxDlgUserSettings.createUserSettingsDialog = function(genesis, launchWallpaperSrc, listener)
{
	if (oFF.isNull(genesis))
	{
	...
	userSettingsDlg.setupDialog(genesis, launchWallpaperSrc, listener);
...
oFF.SxDlgUserSettings.prototype.setupDialog = function(genesis, launchWallpaperSrc, listener)
{
	this.m_genesis = genesis;
	this.m_listener = listener;
	this.buildDialogUi(genesis, launchWallpaperSrc);
};
oFF.SxDlgUserSettings.prototype.buildDialogUi = function(genesis, launchWallpaperSrc)
{
	...
	this.m_userSettingsDialog.setWidthCss("500px");
	this.m_userSettingsDialog.setPaddingCss("20px");
	...
	dialogLayout.addNewItemOfType(oFF.UiType.SPACER).setHeightCss("5px");
	...
	dialogLayout.addNewItemOfType(oFF.UiType.SPACER).setHeightCss("5x");
	...
	desktopWallpaperButtonsContainer.setWidthCss("100%");
	...
	desktopWallpaperButtonsContainer.addNewItemOfType(oFF.UiType.SPACER).setWidthCss("10px");
	...
	dialogLayout.addNewItemOfType(oFF.UiType.SPACER).setHeightCss("10px");
	...
	restoreLaunchpadIconsBtn.setWidthCss("200px");
	restoreLaunchpadIconsBtn.registerOnPress(this);
	dialogLayout.addNewItemOfType(oFF.UiType.SPACER).setWidthCss("10px");
	...
	restoreIconPositionsBtn.setWidthCss("200px");
...
oFF.SxAppStoreDialog.prototype.getDefaultProgramName = function()
{
...
oFF.SxAppStoreDialog.prototype.getDefaultWindowSize = function()
{
	return oFF.UiSizeValue.createByCss("700px", "80vh");
};
...
oFF.SxAppStoreDialog.prototype.buildUi = function(genesis)
{
	...
	this.m_searchInput.setPaddingCss("10px");
	this.m_searchInput.setHeightCss("45px");
	...
	this.m_appStoreAppList.setPaddingCss("20px");
	this.prepareAppList();
	this.updateAppList();
...
oFF.StudioClient.prototype.m_runningPrgs = null;
...
{
	this.m_runningPrgs.clear();
	this.m_runningPrgs = oFF.XObjectExt.release(this.m_runningPrgs);
...
oFF.StudioClient.prototype.getDefaultProgramName = function()
{
...
oFF.StudioClient.prototype.setupInternal = function()
{
	this.initApps();
	this.m_runningPrgs = oFF.XList.create();
...
oFF.StudioClient.prototype.buildUi = function(genesis)
{
	...
	headerArea.setBackgroundColor(oFF.UiColor.create(63, 81, 97, 1.0));
	headerArea.addNewItemOfType(oFF.UiType.SPACER).setWidthCss(oFF.StudioClient.STATUS_BAR_EDGE_SPACING);
	...
	this.m_input.setWidthCss("300px");
	...
	headerArea.addNewItemOfType(oFF.UiType.SPACER).setWidthCss("10px");
	...
	this.m_userInfoSection.addNewItemOfType(oFF.UiType.SPACER).setWidthCss("8px");
	...
	this.m_userPhotoThumbnail.setHeightCss("28px");
	this.m_userPhotoThumbnail.setWidthCss("28px");
	this.m_userPhotoThumbnail.setCornerRadiusCss("50%");
	...
	notificationIcon.setFontSizeCss("20px");
	...
	clockControl.setFontSizeCss("15px");
...
oFF.StudioClient.prototype.signalExit = function(container, exitCode)
{
	this.m_runningPrgs.removeElement(container);
};
...
oFF.StudioClient.prototype.executeProgram = function(startCfg)
{
	...
	startCfgBase.setIsPersistentProgram(true);
	startCfgBase.processExecution(oFF.SyncType.NON_BLOCKING, this, null);
};
...
oFF.StudioClient.prototype.addAppToLaunchpad = function(studioApp)
{
	if (oFF.notNull(studioApp))
	{
		...
		{
			var iconPos = oFF.UiPositionValue.createByPositionString(positionStr);
...
{
	layout.addNewItemOfType(oFF.UiType.SPACER).setWidthCss("10px");
	layout.addNewItemOfType(oFF.UiType.SPACER).setWidthCss("1px").setHeightCss("24px").setBackgroundColor(oFF.UiColor.create(0, 0, 0, 0.3));
	layout.addNewItemOfType(oFF.UiType.SPACER).setWidthCss("10px");
};
oFF.StudioClient.prototype.requestUserInfo = function()
{
	var userManager = this.getApplication().getUserManager();
	userManager.processGetUserProfile(oFF.SyncType.NON_BLOCKING, this, null);
};
oFF.StudioClient.prototype.openUserSettings = function()
{
	...
	{
		var wallpaperSrc = this.getApplication().getUserManager().getUserSettings().getStringByKeyExt(oFF.StudioClient.LAUNCHPAD_WALLPAPER_SRC_KEY, oFF.StudioClient.DEFAULT_LAUNCHPAD_WALLPAPER_URL);
		this.m_userSettingsDialog = oFF.SxDlgUserSettings.createUserSettingsDialog(this.m_genesis, wallpaperSrc, this);
	}
...
oFF.StudioClient.prototype.openNotificationArea = function(notifcationIcon)
{
	if (oFF.isNull(this.m_notificationAreaPopover))
	{
		...
		this.m_notificationAreaPopover.setBackgroundColor(oFF.UiColor.createByString("#659DBD"));
		this.m_notificationAreaPopover.setPlacement(oFF.UiPlacementType.BOTTOM);
		this.m_notificationAreaPopover.setWidthCss("400px");
		this.m_notificationAreaPopover.setHeightCss("50%");
		this.m_notificationAreaPopover.setPaddingCss("5px");
		this.m_notificationAreaPopover.setMarginCss("5x");
		...
		noNewMessagesLbl.setFontSizeCss("17px");
	}
...
oFF.StudioClient.prototype.onMoveEnd = function(event)
{
	...
	if (control.getUiType() === oFF.UiType.APP_ICON)
	{
		...
		var positionStr = newPosition.getAsString();
		this.getApplication().getUserManager().getUserSettings().putString(positionStorageKey, positionStr);
	}
};
oFF.StudioClient.prototype.onUserProfileReady = function(extResult, userProfile, customIdentifier)
{
	if (extResult.isValid() && oFF.notNull(userProfile))
	{
		...
		if (oFF.XStringUtils.isNotNullAndNotEmpty(this.m_userProfile.getThumbnailPhoto()))
		{
			this.m_userPhotoThumbnail.setSrc(this.m_userProfile.getThumbnailPhoto());
		}
...
oFF.StudioClient.prototype.onProgramStarted = function(extResult, program, customIdentifier)
{
	var prgContainer = program.getProgramContainer();
	if (!prgContainer.isModalContainer())
	{
		var windowContainer = prgContainer;
		windowContainer.addTaskBarButtonToTaskBar(this.m_taskBarSection, this.getSession());
	}
};
