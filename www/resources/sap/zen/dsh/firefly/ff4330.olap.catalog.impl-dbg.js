...
oFF.OlapCatalogManager2.prototype.createAndAddFilterOp = function(textFilter, mainOrRootFilter, comparisonOperator, objectType, pType)
{
	...
	var filterName = oFF.QFactory.createFilterOperationWithOperator(selectionStateContainer, null, comparisonOperator);
	if (oFF.notNull(objectType))
	{
		var dimensionByNameCNObject = queryModel.getDimensionByName(objectType);
