...
//		}
            ...
            var supportedChartType = [constants.COLUMNSTACKED_CHARTTYPE, constants.DONUT_CHARTTYPE, constants.COLUMN_CHARTTYPE, constants.BAR_CHARTTYPE, constants.VERTICALBULLET_CHARTTYPE, constants.LINE_CHARTTYPE,constants.COMBINATION_CHARTTYPE, constants.BUBBLE_CHARTTYPE];

            if (!bEnableStableColors && supportedChartType.indexOf(chartContext.ChartType.$EnumMember) >= 0 &&
