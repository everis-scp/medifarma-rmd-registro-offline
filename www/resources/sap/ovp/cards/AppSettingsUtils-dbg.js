sap.ui.define([
        ...
        "sap/base/util/merge"
], function (Dialog, Button, JSONModel, ViewType, ResourceModel, OvpResources, merge) {
        "use strict";
            ...
            getDialogBox: function (oComponentContainer) {
                return new Promise(function (resolve, reject) {
                    ...
                    if (oComponentContainer.getParent()) {
                        ...
                        oAppLevelSettings = merge({}, oOriginalAppLevelSettings);
                        ...
                        oAppSettingsView = new sap.ui.core.mvc.XMLView("appSettingsView", {
