sap.ui.define(["sap/ui/core/UIComponent", "sap/ovp/cards/rta/SettingsDialogConstants",
    ...
    "sap/ui/model/resource/ResourceModel", "sap/ovp/app/resources", "sap/ui/core/CustomData", "sap/ushell/Config", "sap/base/util/merge", "sap/base/util/isEmptyObject", "sap/ovp/cards/ovpLogger", "sap/ui/Device", "sap/ovp/cards/CommonUtils", "sap/ui/generic/app/navigation/service/NavigationHandler", "sap/ui/rta/RuntimeAuthoring" /*Don't Remove this. Important for Personalization to work*/],

    function (UIComponent, SettingsDialogConstants, Router, ObjectPath,
              JSONModel, DashboardLayoutUtil, ViewType, ResourceModel, OvpResources, CustomData, Config, merge, isEmptyObject, ovpLogger, Device, CommonUtils, NavigationHandler) {
        "use strict";
        ...
        return UIComponent.extend("sap.ovp.app.Component", {
            ...
            fnUseMDCFilterBar: function (ovpConfig) {
                var bUseMDCFilterBar = false;
                if (ovpConfig && ovpConfig.filterSettings) {
                    var bUseMDCFilterBar = ovpConfig.filterSettings.filterBarImplementingControl === "sap.ui.mdc.FilterBar";
                    var bUseSmartFilterBar = ovpConfig.filterSettings.filterBarImplementingControl === "sap.ui.comp.smartfilterbar.SmartFilterBar";
                    if (bUseMDCFilterBar && bUseSmartFilterBar) {
                        oLogger.error("Smart filterbar and mdc filter bar cannot be used together");
                        return;
                    }
                }
                return bUseMDCFilterBar;
            },
            createXMLView: function (ovpConfig) {
                ...
                ovpConfig.useMDCFilterBar = this.fnUseMDCFilterBar(ovpConfig);
            ...
            setContainer: function () {
                ...
                if (CommonUtils.isODataV4(oFilterModel)) {
                    aPromises.unshift(oFilterModel.getMetaModel().requestObject("/" + ovpConfig.globalFilterModel));
                } else {
                    aPromises.unshift(oFilterModel.getMetaModel().loaded());
                }
