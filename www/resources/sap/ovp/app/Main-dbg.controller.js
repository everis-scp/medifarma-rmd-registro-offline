sap.ui.define(["sap/ui/core/mvc/Controller", "sap/m/library", "sap/ui/model/odata/ODataUtils", "sap/ovp/cards/generic/Component", "sap/ovp/cards/v4/generic/Component",
    ...
    "sap/base/security/encodeURL", "sap/base/util/ObjectPath", "sap/ui/thirdparty/jquery", "sap/base/util/merge","sap/ui/fl/apply/api/FlexRuntimeInfoAPI","sap/ui/core/CustomData", "sap/ovp/cards/ovpLogger", "sap/base/util/isEmptyObject","sap/ovp/cards/semanticDateRangeTypeHelper", "sap/ui/model/Filter"],
    ...
    function (Controller, SapMLibrary, ODataUtils, Component, ComponentV4, NavigationHandler, MessageBox, CommonUtils, PersonalizationUtils,
        ...
        TemplateBaseExtension, ControllerExtension, OVPUtils, encodeURL, ObjectPath, jQuery, merge, FlexRuntimeInfoAPI, CustomData, ovpLogger, isEmptyObject,semanticDateRangeTypeHelper, FilterModel) {
        ...
        return Controller.extend("sap.ovp.app.Main", {
            ...
            onInit: function () {
                ...
                this.getView().loaded().then(function () {
                    ...
                    this.fnMDCFilterLoaded = undefined;
            ...
            onAfterRendering: function () {
                ...
                Promise.all([
                    ...
                    this.oGlobalFilterLoadedPromise]).then(function () {
                        this.isMDCFilter = this.getMDCFilter() !== undefined;
            ...
            _initGlobalFilter: function () {
                var oGlobalFilter = this.getGlobalFilter();
                if (!oGlobalFilter) {
                    var oMDCFilter = this.getMDCFilter();
                    if (!oMDCFilter) {
                    ...
                    this.oGlobalFilterLoadedPromise = new Promise(function(resolve, reject) {
                        this.fnMDCFilterLoaded = resolve;
                    }.bind(this));
                    return;
                }
            ...
            _initCardModel: function (sCardModel) {
                ...
                if (!CommonUtils.isODataV4(this.oCardsModels[sCardModel]) && !this.isMDCFilter) {
            ...
            _getEntityRelevantFilters: function (oEntityType, aFilters, oEntityModel, oFilterModel) {
                ...
                if (aFilters.length > 0 && oEntityType) {
                    var entityType = this.isMDCFilter ? oEntityType.entityType : this.getGlobalFilter().getEntityType();
            ...
            getMDCFilter: function() {
                if (!this.oMDCFilter) {
                    this.oMDCFilter = this.getView().byId("ovpGlobalMDCFilter");
                }
                return this.oMDCFilter;
            },
            ...
            onMDCSearch: function(oEvent) {
                if (this.fnMDCFilterLoaded !== undefined) {
                    this.fnMDCFilterLoaded();
                }
                ...
                if (aPaths.length > 0) {
                    var aFilters = aPaths.map(function(path) {
                        var value = oConditions[path] && oConditions[path][0];
                ...
                this.globalEventBus.publish("OVPGlobalfilter", "OVPGlobalFilterSeacrhfired", allFilters);
            }
        });
    }
);
