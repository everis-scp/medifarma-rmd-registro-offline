...
sap.ui.define([
	...
	'sap/apf/cloudFoundry/uiHandler'
			...
			textPoolHelper, ViewValidator, modelerConstants, uiHandler) {
	"use strict";
	...
	var constructor = sap.ui.core.mvc.Controller.extend("sap.apf.modeler.ui.controller.requestOptions", {
		...
		handleShowValueHelpRequest : function(oEvent) {
			...
			if (oViewData.oCoreApi && oViewData.oCoreApi.isUsingCloudFoundryProxy()) {
				uiHandler.showValueHelp(oEventData, oViewData.oCoreApi, this);
			} else {
				sap.ui.view({
