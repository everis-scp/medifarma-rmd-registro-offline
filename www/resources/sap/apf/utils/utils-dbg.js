...
sap.ui.define([
...
], function(uiCoreDateFormat, Hashtable, UriParameters, ViewSettingsDialog) {
	'use strict';
	...
	var utils = {
		 ...
		 * @param {string[]|undefined} availableValues
