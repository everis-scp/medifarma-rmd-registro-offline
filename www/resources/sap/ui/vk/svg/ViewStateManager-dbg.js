...
sap.ui.define([
	...
	ViewStateManager.prototype._setContent = function(content) {
		...
		if (scene) {
			...
			if (initialView) {
				...
				this._resetNodesStatusByCurrenView(this._currentView);
			}
		}
	...
	*/
	...
	ViewStateManager.prototype._resetNodesStatusByCurrenView = function(view) {
		var nodeHierarchy = this.getNodeHierarchy();
	...
	ViewStateManager.prototype.activateView = function(view) {
		...
		this._resetNodesStatusByCurrenView(view);
