...
function(
	...
	RedlineCollaboration.prototype._onElementCreated = function(event) {
		...
		if (this.getActiveConversation()) {
			var conversation = sap.ui.getCore().byId(this.getActiveConversation());
		...
		if (this.getActiveComment()) {
			var comment = sap.ui.getCore().byId(this.getActiveComment());
	...
	RedlineCollaboration.prototype.setActiveConversation = function(conversation) {
		var activeConversation = sap.ui.getCore().byId(this.getActiveConversation());
		...
		if (conversation.getViewInfo()) {
			...
			var scene = sap.ui.getCore().byId(viewport.getContentConnector()).getContent();
			...
			if (view) {
				...
				var vm = sap.ui.getCore().byId(vsm.getViewManager());
	...
	RedlineCollaboration.prototype._readyForAnimation = function() {
		...
		var conversation = sap.ui.getCore().byId(this.getActiveConversation());
		if (conversation){
			var animationPlayer = sap.ui.getCore().byId(viewport.getViewStateManager()).getAnimationPlayer();
	...
	RedlineCollaboration.prototype.createElement = function(redlineElement) {
		...
		if (conversation && !conversation.getViewInfo()) {
			...
			conversation.setAnimationOffset(sap.ui.getCore().byId(viewport.getViewStateManager()).getAnimationPlayer().getTime());
		}
		if (!this._tool.getActive()) {
			this._tool.setActive(true, viewport);
		}
	...
	* @returns {Object[]} Array of redline elements
	...
	RedlineCollaboration.prototype.exportJSON = function() {
		var activeId = "";
		if (this.getActiveConversation()) {
			activeId = sap.ui.getCore().byId(this.getActiveConversation()).getElementId();
		}
