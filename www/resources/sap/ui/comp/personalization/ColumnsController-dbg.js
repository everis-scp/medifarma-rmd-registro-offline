...
sap.ui.define([
	...
	ColumnsController.prototype.getAdaptationUI = function(oPayload) {
		return new Promise(function(resolve){
			sap.ui.require([
				...
				var aMapped;
				oSelectionPanel.attachChange(function(o){
					aMapped = o.oSource.getP13nModel().getProperty("/items").map(function(o, iIndex){
						return {
							columnKey: o.name, visible: o.visible, index: iIndex
						};
					});
