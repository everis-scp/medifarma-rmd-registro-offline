...
sap.ui.define([
	...
	SmartChart.prototype._drillDown = function(oEvent, oSource) {
		...
		if (this._oChart) {
			...
			if (Device.system.desktop) {
				...
				var oInvTextSearch = new InvisibleText({
	...
	SmartChart.prototype._toggleFullScreen = function(bValue, bForced) {
		...
		this._oFullScreenUtil.toggleFullScreen(this, this.bFullScreen, this.oFullScreenButton, this._toggleFullScreen, "sapContrastPlus", true);
