...
sap.ui.define([
	...
	/**
	 * Handle AriaLabelledBy for UoM SmartField inside of a SmartTable
	 * @private
	...
	SmartField.prototype._handleUoMAriaLabelledByInSmartTable = function(oUoMNestedSmartField) {
		...
		if (this.getAriaLabelledBy().length > 0) {
			this.getInnerControls().forEach(function(oControl) {
				...
				if (oControl.addAriaLabelledBy && oControl.getAriaLabelledBy && oUoMNestedSmartField) {
					bAlreadyExistingAriaLabelledByAssociation = oControl.getAriaLabelledBy().indexOf(that.getAriaLabelledBy()[0]) > -1;
						...
						if (!oUoMNestedSmartField.getEditable()){
							bAlreadyExistingAriaLabelledByAssociation = oControl.getAriaLabelledBy().indexOf(oUoMNestedSmartField.getId() + "-text") > -1;
							if (!bAlreadyExistingAriaLabelledByAssociation) {
