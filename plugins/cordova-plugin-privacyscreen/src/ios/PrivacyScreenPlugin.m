...
- (void)onAppDidEnterBackground:(UIApplication *)application
{
  ...
  NSString *imgName = [self getImageName:[[UIApplication sharedApplication] statusBarOrientation] delegate:(id<CDVScreenOrientationDelegate>)vc device:[self getCurrentDevice]];
