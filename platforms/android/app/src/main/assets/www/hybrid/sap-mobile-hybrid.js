...
sap.hybrid = {
	...
	openStore: function () {
		...
		var openStoreHANASuccessCallback = function () {
			...
			var uri = sap.hybrid.kapsel.appContext.applicationEndpointURL + "_RMD_SRV_TEST/v2/browse/RMD?$filter=activo eq true";  //JSON format is less verbose than atom/xml
			var oHeaders = {};
			var request = {
					headers: oHeaders,
					requestUri: uri,
