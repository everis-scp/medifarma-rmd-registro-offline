...
sap.ui.define(["require", "exports", "./AttributeType", "./AttributeMetadataBase"], function (require, exports, AttributeType_1, AttributeMetadataBase_1) {
    ...
    var AttributeGroupMetadata = /** @class */ (function (_super) {
        ...
        function AttributeGroupMetadata(properties) {
            ...
            _this.type = (_c = properties.type) !== null && _c !== void 0 ? _c : _this.type;
            _this.label = (_d = properties.label) !== null && _d !== void 0 ? _d : _this.label;
            _this.isSortable = (_e = properties.isSortable) !== null && _e !== void 0 ? _e : _this.isSortable;
            _this.template = (_f = properties.template) !== null && _f !== void 0 ? _f : _this.template;
            _this.attributes = (_g = properties.attributes) !== null && _g !== void 0 ? _g : _this.attributes;
            return _this;
        }
