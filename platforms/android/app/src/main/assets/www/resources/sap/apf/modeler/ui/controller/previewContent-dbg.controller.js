...
sap.ui.define([
	...
	], function(uiUtils, uiUtilsConstants, WrappedChartWithCornerTexts, jQuery) {
	'use strict';
	...
	function _prepareRepresentationInstance() {
		...
		var sRepresentationPath = sRepresentationConstructor.replaceAll(".","/"); 
		sap.ui.require([sRepresentationPath], function(ColumnChart){
		return ColumnChart;
		});
	...
	function _setDisplayText(oController) {
	 ...
	 var previewContent = sap.ui.core.mvc.Controller.extend("sap.apf.modeler.ui.controller.previewContent", {
		onInit : function() {
