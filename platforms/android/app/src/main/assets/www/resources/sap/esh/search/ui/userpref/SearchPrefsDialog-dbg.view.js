...
], function (Button, CheckBox, FlexBox, FlexItemData, Label, List, ListMode, MessageBox, StandardListItem, Title, VBox, BindingMode) {
    "use strict";
    // search preferences dialog view
    // =======================================================================
    return sap.ui.jsview("sap.esh.search.ui.userpref.SearchPrefsDialog", {
        createContent: function () {
            ...
            var oTitlePersSearch = new Title({
                text: sap.esh.search.ui.resources.i18n.getText("sp.personalizedSearch"),
            });
            ...
            var oPersSearchCheckBox = new CheckBox({
                ...
                text: sap.esh.search.ui.resources.i18n.getText("sp.trackPersonalizedSearch"),
                enabled: "{/isPersonalizedSearchEditable}",
                layoutData: new FlexItemData({ growFactor: 1 }),
            });
            // Reset button
            var oResetButton = new Button({
                text: sap.esh.search.ui.resources.i18n.getText("sp.deleteSearchTracks"),
            ...
            var oTitleDefaultSearch = new Title({
                text: sap.esh.search.ui.resources.i18n.getText("sp.defaultSearchScope"),
            });
            ...
            var oCheckBoxScope = new CheckBox({
                ...
                text: sap.esh.search.ui.resources.i18n.getText("sp.usePersSearchScope"),
            });
            // Headline for connector list
            var oListLabel = new Label({
                id: "connectorListLabel",
                text: sap.esh.search.ui.resources.i18n.getText("sp.connectorList"),
                visible: "{/favActive}",
                layoutData: new FlexItemData({ growFactor: 1 }),
            ...
            var oListCount = new Label({
                text: {
                    ...
                    formatter: function (selectedDataSourceCount, dataSourceCount) {
                        return sap.esh.search.ui.resources.i18n.getText("sp.connectorListCount", [
        ...
        resetHistory: function () {
            this.getModel()
                ...
                var errorText = sap.esh.search.ui.resources.i18n.getText("sp.resetFailed");
                errorText += "\n" + response;
                MessageBox.show(errorText, {
                    title: sap.esh.search.ui.resources.i18n.getText("sp.resetFailedTitle"),
