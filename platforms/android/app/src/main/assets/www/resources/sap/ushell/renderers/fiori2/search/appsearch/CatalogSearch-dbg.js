...
sap.ui.define([
    ...
    'sap/base/Log',
    'sap/ui/Device'
], function (jsSearchFactory, Log, device) {
    "use strict";
    ...
    CatalogSearch.prototype = {
            ...
            if (!view) {
                view = new sap.m.GenericTile({
                    ...
                    press: function (oEvent) {
                        ...
                        window.location.hash = binding.url;
                    }
                });
            }
        ...
        _getTileAsync: function (tile) {
            ...
            try {
                ...
                // fix for internal incident, personlized tiles in CDM platform cannot call getCatalogTileSize()
                try {
                    size = this.launchPageService.getCatalogTileSize(tile);
                } catch (e) {
                    size = this.launchPageService.getTileSize(tile);
                }
