...
sap.ui.define(["require", "exports", "./errors"], function (require, exports, errors_1) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [2 /*return*/, new Promise(function (resolve, reject) {
                                ...
                                xhttp.onreadystatechange = function () {
                                    ...
                                    if (xhttp.readyState == 4) {
                                        reject(new errors_1.AjaxError(xhttp, parseHeaders(xhttp.getAllResponseHeaders())));
                                    }
                                };
                    ...
                    case 5: throw new errors_1.AjaxError(res);
                    case 6: return [3 /*break*/, 8];
                    case 7:
                        error_1 = _a.sent();
                        throw new errors_1.AjaxError(error_1);
    ...
    var Client = /** @class */ (function () {
        ...
        Client.prototype._replay = function (url, payload) {
            return __awaiter(this, void 0, void 0, function () {
                var that, key, normalizedRequest, record;
                return __generator(this, function (_a) {
                    that = this;
                    key = url;
    ...
    var _Client = /** @class */ (function () {
        ...
        _Client.prototype.parseError = function (error) {
            var _a, _b, _c, _d, _e, _f, _g, _h;
            try {
                var parsedError = void 0;
                if ((_a = error === null || error === void 0 ? void 0 : error.xhttp) === null || _a === void 0 ? void 0 : _a.responseText) {
                    parsedError = JSON.parse((_b = error.xhttp) === null || _b === void 0 ? void 0 : _b.responseText);
                }
                var message = [];
                if ((_c = parsedError === null || parsedError === void 0 ? void 0 : parsedError.error) === null || _c === void 0 ? void 0 : _c.code) {
                    // abap_odata
                    message.push(parsedError.error.code);
                }
                // InA V2
                if (((_d = parsedError === null || parsedError === void 0 ? void 0 : parsedError.Error) === null || _d === void 0 ? void 0 : _d.Code) && ((_e = parsedError === null || parsedError === void 0 ? void 0 : parsedError.Error) === null || _e === void 0 ? void 0 : _e.Message)) {
                ...
                // abap_odata
                if ((_g = (_f = parsedError === null || parsedError === void 0 ? void 0 : parsedError.error) === null || _f === void 0 ? void 0 : _f.message) === null || _g === void 0 ? void 0 : _g.value) {
                    message.push(parsedError.error.message.value);
                }
                // hana_odata
                if ((_h = parsedError === null || parsedError === void 0 ? void 0 : parsedError.error) === null || _h === void 0 ? void 0 : _h.details) {
                    message.push(parsedError.error.details);
                }
                if (message.length > 0) {
                    error.previous = new Error(message.join("\n"));
                }
                return error;
            }
            catch (e) {
                var extractError = new errors_1.InternalESHClientError("Error while extracting server error");
                extractError.previous = e;
                error.previous = extractError;
                return error;
            }
        };
