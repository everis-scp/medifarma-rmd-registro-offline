...
oFF.QDeltaOperationPhase.METADATA_UPDATE = null;
oFF.QDeltaOperationPhase.staticSetup = function()
{
	...
	oFF.QDeltaOperationPhase.METADATA_UPDATE = oFF.XConstant.setupName(new oFF.QDeltaOperationPhase(), "MetadataUpdate");
};
