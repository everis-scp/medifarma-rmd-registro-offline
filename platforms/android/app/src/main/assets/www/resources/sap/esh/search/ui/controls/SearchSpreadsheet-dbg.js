...
sap.ui.define([
    ...
    "sap/m/MessageBox",
], function (Controller, Spreadsheet, SearchResultListFormatter, MessageBox) {
    "use strict";
    return Controller.extend("sap.ui.export.sample.table.Spreadsheet", {
        onExport: function () {
            ...
            if (that.model.getProperty("/boCount") > 1000) {
                MessageBox.information(sap.esh.search.ui.resources.i18n.getText("exportDataInfo"), {
        ...
        _doExport: function () {
            ...
            var oSettings = {
                ...
                fileName: sap.esh.search.ui.resources.i18n.getText("exportFileName"),
