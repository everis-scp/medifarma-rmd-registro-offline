...
sap.ui.define([
    ...
    Dialog.extend("sap.esh.search.ui.controls.SearchFacetDialog", {
        constructor: function (options) {
            ...
            if (jQuery.sap.getUriParameters().mParams.newpie &&
            ...
            options = jQuery.extend({}, {
                ...
                beginButton: new Button({
                    text: sap.esh.search.ui.resources.i18n.getText("okDialogBtn"),
                ...
                endButton: new Button({
                    text: sap.esh.search.ui.resources.i18n.getText("cancelDialogBtn"),
                    press: function (oEvent) {
        ...
        createMasterPages: function () {
            ...
            var oResetButton = new Button({
                ...
                tooltip: sap.esh.search.ui.resources.i18n.getText("resetFilterButton_tooltip"),
                type: "Transparent",
                enabled: false,
                press: function (oEvent) {
            ...
            var oMasterPage = new Page({
                title: sap.esh.search.ui.resources.i18n.getText("filters"),
        ...
        createDetailPages: function (sId, oContext) {
            ...
            var oSelect = new Select({
                items: [
                    new Item({
                        text: sap.esh.search.ui.resources.i18n.getText("notSorted"),
                        key: "notSorted",
                    }),
                    new Item({
                        text: sap.esh.search.ui.resources.i18n.getText("sortByCount"),
                        key: "sortCount",
                    }),
                    new Item({
                        text: sap.esh.search.ui.resources.i18n.getText("sortByName"),
                        key: "sortName",
                    }),
                ],
            ...
            var oCheckBox = new CheckBox({
                text: sap.esh.search.ui.resources.i18n.getText("showSelectedOnTop"),
                enabled: false,
            ...
            var oBindingInfo = {
                ...
                factory: function (sId, oContext) {
                    ...
                    var oListItem = new StandardListItem({
                        title: "{label}",
                        tooltip: sap.esh.search.ui.resources.i18n.getText("facetListTooltip", [
                            "{label}",
                            "{value}",
                        ]),
                        info: "{valueLabel}",
            ...
            if (sDataType === "string" || sDataType === "text") {
                ...
                var subheader = new Toolbar({
                    content: [
                        new SearchField({
                            placeholder: sap.esh.search.ui.resources.i18n.getText("filterPlaceholder"),
                ...
                var oIconTabBar = new IconTabBar({
                    ...
                    items: [
                        new IconTabFilter({
                            text: sap.esh.search.ui.resources.i18n.getText("selectFromList"),
                            content: [oTabListPage],
                        }),
                        new IconTabFilter({
                            text: sap.esh.search.ui.resources.i18n.getText("defineCondition"),
        ...
        resetIcons: function (oModel, sPath, oControl) {
            ...
            if (isTextDataType) {
                ...
                for (var i = 0; i < allDropdownbuttons.length; i++) {
                    ...
                    var displayAs = sap.esh.search.ui.resources.i18n.getText("displayAs", [asWhat]);
