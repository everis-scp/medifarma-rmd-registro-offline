 ...
 */
sap.ui.define([
    "sap/esh/search/ui/controls/SearchTilesContainerKeyHandler",
    ...
    // Tiles Container
    // =======================================================================
    sap.ui.core.Control.extend("sap.esh.search.ui.controls.SearchTilesContainer", {
        // metadata
        // ===================================================================
        metadata: {
            properties: {
                ...
                resultList: {
                    type: "sap.esh.search.ui.controls.SearchResultList",
                },
                addAccInformation: {
                    type: "boolean",
                    defaultValue: false,
        ...
        init: function () {
            ...
            // sap.ui.getCore().getEventBus().subscribe("searchLayoutChanged", this.delayedRerender, this); control no longer used
        ...
        // ===================================================================
        exit: function () {
            // sap.ui.getCore().getEventBus().unsubscribe("searchLayoutChanged", this.delayedRerender, this); control no longer used
        ...
        renderPlusTile: function (oRm, oControl) {
            ...
            var button = new Button({
                text: sap.esh.search.ui.resources.i18n.getText("showMoreApps"),
                //  styled: false,
                //  lite: true,
                tooltip: sap.esh.search.ui.resources.i18n.getText("showMoreApps"),
                press: function () {
        ...
        addAccessibilityInformation: function () {
            ...
            for (var i = 0; i < children.length; ++i) {
                ...
                if (typeof ariaLabel === "string") {
                    focusableChild.setAttribute("aria-label", sap.esh.search.ui.resources.i18n.getText("tile") + " " + ariaLabel);
                }
        ...
        limitTileSize: function () {
            ...
            for (var i = 0; i < container.children.length; ++i) {
                ...
                if (!this.findElementByStyleClass(tile, "sapMGT") ||
                    !this.findElementByStyleClass(tile, "OneByOne")) {
