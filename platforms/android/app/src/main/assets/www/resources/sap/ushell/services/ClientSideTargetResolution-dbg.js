...
sap.ui.define([
    ...
    ClientSideTargetResolution.prototype._getURLParsing = function () {
        if (!this._oURLParsing) {
            Log.error("ClientSideTargetResolution.js: sap.ushell.Container.getService() - sync call triggered.");
            // TODO: Revisit to see if this fallback can be removed
    ...
    ClientSideTargetResolution.prototype._resolveSingleMatchingTarget = function (oMatchingTarget, fnBoundFallback, sFixedHashFragment) {
        var that = this,
            oDeferred = new jQuery.Deferred(),
            oUrlParsingService = this._getURLParsing(),
            oIntent = oUrlParsingService.parseShellHash(sFixedHashFragment),
    ...
    ClientSideTargetResolution.prototype._getLinks = function (oArgs, oInboundIndex) {
         ...
         */
        function fnConstructBusinessParamsString (oUrlParsing, mParams) {
            var sBusinessParams = oUrlParsing.paramsToString(mParams);
