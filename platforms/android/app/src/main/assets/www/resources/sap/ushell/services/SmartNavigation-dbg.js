...
(function () {
     ...
     * <p>
     * Note that an instance of this service should be obtained with <code>sap.ushell.services.Container#getServiceAsync("SmartNavigation").then(function (SmartNavigation) {});</code>
        ...
        if (!SmartNavigation.instance) {
            Object.defineProperty(SmartNavigation, "instance", {
                value: {
                     ...
                     * @memberof sap.ushell.services.SmartNavigation#
                     */
                    trackNavigation: function (oArgs) {
                            if (!oPrivate.isTrackingEnabled(oServiceConfig, utils)) {
