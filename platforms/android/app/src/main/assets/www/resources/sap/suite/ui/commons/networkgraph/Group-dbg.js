...
sap.ui.define([
	...
	Group.prototype._render = function (mOptions) {
		...
		if (this._iNestedLevel === 0 && oParent._isTwoColumnsLayout()) {
			mOptions.renderManager.unsafeHtml(this._renderTopGroup(mOptions));
			return "";
		}
	...
	Group.prototype._renderHeader = function (mOptions) {
		...
		if (sIcon) {
			mOptions.renderManager.unsafeHtml(this._renderHtmlIcon(sIcon, "sapSuiteUiCommonsNetworkGroupHeaderIcon", null, sContentStyle));
		}
		...
		mOptions.renderManager.unsafeHtml(this._renderHtmlIcon(this.getCollapsed() ? EXPAND_ICON : COLLAPSE_ICON, "sapSuiteUiCommonsNetworkGroupHeaderMenuIcon", "collapse",
			sContentStyle, oResourceBundle.getText("NETWORK_GRAPH_EXPAND_COLLAPSE")));
		mOptions.renderManager.unsafeHtml(this._renderHtmlIcon(MENU_ICON, "sapSuiteUiCommonsNetworkGroupHeaderMenuIcon", "menu",
