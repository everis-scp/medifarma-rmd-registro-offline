...
(function () {
    "use strict";
    sap.ui.define(["sap/esh/search/ui/SearchModel", "sap/m/MessageBox", "sap/ui/core/TextDirection"], function (SearchModel, MessageBox, TextDirection) {
            ...
            facetDialogSingleCall: function (properties) {
                ...
                return that.chartQuery.getResultSetAsync().then(function (resultSet) {
                    ...
                    if (percentageMissingInPie > 0) {
                        ...
                        newItem.label = sap.esh.search.ui.resources.i18n.getText("facetPieChartOverflowText2", [percentageMissingInPie, 9]);
                    ...
                    var errorTitle = sap.esh.search.ui.resources.i18n.getText("searchError");
