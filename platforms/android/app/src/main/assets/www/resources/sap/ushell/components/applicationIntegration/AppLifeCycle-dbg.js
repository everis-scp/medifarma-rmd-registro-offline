                            ...
                            executeServiceCallFn: function (oServiceParams) {
                                ...
                                if (oSetup) {
                                    if (oServiceParams.oContainer.getIsKeepAlive() === true &&
                                        (sAppType === "GUI" || sAppType === "TR" || sAppType === "WDA" || sFrameworkId === "GUI" || sFrameworkId === "WDA")) {
                        ...
                        loadFinished: {
                            executeServiceCallFn: function (oServiceParams) {
                                var sAppType = oServiceParams.oContainer.getApplicationType(),
                                    sFrameworkId = oServiceParams.oContainer.getFrameworkId();
                                if ((sAppType === "GUI" || sAppType === "TR" || sFrameworkId === "GUI") && oServiceParams.oContainer.getIsKeepAlive() === false) {
