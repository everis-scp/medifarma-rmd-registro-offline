...
sap.ui.define([], function () {
    ...
    return {
        readCFlpConfiguration: function (sinaConfigurations) {
            ...
            return sap.ushell.Container.getService("CommonDataModel")
                .getApplications()
        ...
        createContentProviderSinaConfiguration: function (contentProviderId) {
            return sap.ushell.Container.getService("ClientSideTargetResolution")
                .getSystemContext(contentProviderId)
