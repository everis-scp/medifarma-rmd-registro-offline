sap.ui.define(["sap/ui/base/Object", "sap/base/util/extend"], function(BaseObject, extend) {
		...
		function fnRestoreWorklistStateFromIappState(oWorklistState) {
			var oWorklistState = oWorklistState || {};
		...
		function fnWorklistRebindTableOnSearch(oEvent) {
			...
			// Since version 1.88, the SmartControls intialization is delayed since the SmartControls wait for the ODataMetadata and 
			// additionally for Flex change Promises to resolve before the control's initialization logic is executed.
			// We need to wait for the smartTable to initialise before doing rebind.
			// Note: This is a temporary fix until this change from smartControls is adpated in whole sframework.
			var oSmartTable = oState.oSmartTable;
