...
sap.ui.define([
    ...
    jQuery.extend(module, {
        extendTableColumn: {
            column: {
                name: sap.esh.search.ui.resources.i18n.getText("actions"),
            ...
            bindingFunction: function (bindingObject) {
                ...
                var button = new Button({
                    ...
                    tooltip: bindingObject.isFavorite
                        ? sap.esh.search.ui.resources.i18n.getText("unfavorite")
                        : sap.esh.search.ui.resources.i18n.getText("favorite"),
                    ...
                    press: function () {
                        ...
                        if (this.getIcon() === bindingObject.iconUnfavorite) {
                            ...
                            this.getModel()
                                ...
                                // show toast message
                                MessageToast.show(sap.esh.search.ui.resources.i18n.getText("favoriteToast"), oMessageToastParams);
                            }.bind(this), function () {
                                this.setBusy(false);
                            }.bind(this));
                        }
                            ...
                            this.getModel()
                                ...
                                // show toast message
                                MessageToast.show(sap.esh.search.ui.resources.i18n.getText("unfavoriteToast"), oMessageToastParams);
                            }.bind(this), function () {
                                this.setBusy(false);
                            }.bind(this));
                        }
