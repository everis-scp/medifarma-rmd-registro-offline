 ...
 */
// @ts-check
sap.ui.define(["sap/m/Text", "sap/m/Toolbar", "sap/m/ToolbarSpacer", "sap/m/ToolbarDesign", "sap/ui/core/Icon"], function (Text, Toolbar, ToolbarSpacer, ToolbarDesign, Icon) {
    "use strict";
    return sap.m.Toolbar.extend("sap.esh.search.ui.controls.SearchFilterBar", {
        ...
        filterFormatter: function (rootCondition, facets) {
            ...
            return sap.esh.search.ui.resources.i18n.getText("filtered_by", [attributeLabels.join(", ")]);
        },
        /**
         * @this sap.esh.search.ui.controls.SearchFilterBar
         */
        ...
        onAfterRendering: function () {
            ...
            $filterText.attr("aria-label", sap.esh.search.ui.resources.i18n.getText("filtered_by_aria_label"));
        },
    });
});
