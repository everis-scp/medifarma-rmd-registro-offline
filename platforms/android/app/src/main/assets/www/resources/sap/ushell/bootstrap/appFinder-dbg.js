...
(function () {
    ...
    loadScripts([
        ...
        loadScripts([
            ...
            // cascade 3: the appFinder-dev (must be loaded before the core because it needs to set the core configuration)
            sap.ui.require([
                "sap/ushell/bootstrap/appfinder/appFinder-dev"
            ], function (/*appFinderDev*/) {
                // cascade 4: load core and finally boot the core
                sap.ui.require([
                    "sap/ui/core/Core"
                ], function (core) {
                    core.boot();
