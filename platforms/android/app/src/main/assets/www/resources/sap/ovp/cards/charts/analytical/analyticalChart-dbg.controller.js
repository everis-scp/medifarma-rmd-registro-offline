sap.ui.define(["sap/ovp/cards/generic/Card.controller", "sap/ovp/cards/charts/VizAnnotationManager",
    "sap/viz/ui5/data/FlattenedDataset", "sap/ovp/cards/OVPCardAsAPIUtils", "sap/ovp/app/resources", "sap/base/util/each", "sap/ovp/cards/ovpLogger", "sap/ovp/app/FilterHelper"],
    function (CardController, VizAnnotationManager, FlattenedDataset, OVPCardAsAPIUtils, OvpResources, each, ovpLogger, FilterHelper) {
        "use strict";
...
//				this.bFlag = true;
                ...
                this.eventhandler = function (sChannelId, sEventName, aFilters) {
                    ...
                    var oGlobalFilter = that.oMainComponent.getMDCFilter();
                    var oFilterModel = oGlobalFilter.getModel();
                    var oCardModel = that.getView().getController().getModel();
                    if (oEntityType && oFilterModel) {
                        ...
                        try {
                            that.getCardItemsBinding().filter(aAllFilters);
                ...
                if (this.oMainComponent && this.oMainComponent.isMDCFilter && this.oCardComponentData && this.oCardComponentData.mainComponent) {
