...
// }
	...
	FilterBar.prototype.setBasicSearch = function(oBasicSearchField) {
		...
		if (this.getIsRunningInValueHelpDialog() && this._oToolbar) {
			this._oToolbar.removeStyleClass("filterBarButtonsFloatRight");
		}
					...
					var fChange = function(oEvent) {
						...
						if (oItem && oItem.filterItem) {
							if (oItem.filterItem.getMandatory() && !bAdd && !this._hasFilterValue(oItem.filterItem)) {
								...
								this._selectionChangedInFilterDialogByValue(mItem.visible, oItem.filterItem);
							}
						}
					}.bind(this);
...
// }
	...
	FilterBar.prototype.onAfterRendering = function(oEvent) {
		...
		if (this._oToolbar) {
			this.getBasicSearch() ? this._oToolbar.removeStyleClass("filterBarButtonsFloatRight") : this._oToolbar.addStyleClass("filterBarButtonsFloatRight");
		}
	};
