        ...
        initAsync: function () {
            ...
            if (!myFavData) {
                userCategory = this.sina._createDataSource({
                    id: "MyFavorites",
                    label: sap.esh.search.ui.resources.i18n.getText("label_userFavorites"),
                    labelPlural: sap.esh.search.ui.resources.i18n.getText("label_userFavorites"),
            ...
            return jQuery.when(); //jquery promise resolve
        },
