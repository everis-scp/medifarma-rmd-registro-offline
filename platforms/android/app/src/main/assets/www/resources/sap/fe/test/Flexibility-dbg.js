	...
	return {
		...
		assertions: {
			...
			iSeeTheRenameButton: function() {
				return this.iSeeTheButtonByIcon("sap-icon://edit", "the button 'rename'");
			},

			iSeeTheAddButton: function() {
				return this.iSeeTheButtonByIcon("sap-icon://add", "the button 'add'");
			},

			iSeeTheCreateGroupButton: function() {
				return this.iSeeTheButtonByIcon("sap-icon://add-folder", "the button 'create group'");
			},

			iDoNotSeeTheRenameButton: function() {
				return this.iDoNotSeeTheButtonByIcon("sap-icon://edit", "the button 'rename'");
			},

			iDoNotSeeTheAddButton: function() {
				return this.iDoNotSeeTheButtonByIcon("sap-icon://add", "the button 'add'");
			},

			iDoNotSeeTheRemoveButton: function() {
				return this.iDoNotSeeTheButtonByIcon("sap-icon://less", "the button 'remove'");
			},
