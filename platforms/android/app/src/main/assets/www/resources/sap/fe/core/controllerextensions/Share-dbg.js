...
sap.ui.define(
	...
	function(
		...
		var ShareUtils = ControllerExtension.extend("sap.fe.core.controllerextensions.Share", {
			 ...
			 * @param {string} [oShareMetadata.email.url] URL that will be used specifically for 'Send Email'
			 * @param {string} [oShareMetadata.email.title] Title that will be used as "email subject" in 'Send Email'
			 * @param {string} [oShareMetadata.jam.url] URL that will be used specifically for 'Share in SAP Jam'
			 * @param {string} [oShareMetadata.jam.title] Title that will be used as 'share text' in 'Share in SAP Jam'
			 * @param {string} [oShareMetadata.tile.url] URL that will be used specifically for 'Save as Tile'
			 * @param {string} [oShareMetadata.tile.title] Title to be used for the tile.
