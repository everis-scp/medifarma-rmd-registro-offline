    ...
    var oAPIs = {
        "sap.ushell.services.CrossApplicationNavigation": {
            oServiceCalls: {
                ...
                toExternal: {
                    executeServiceCallFn: function (oServiceParams) {
                        var oArgs = deepExtend({}, oServiceParams.oMessageData.body.oArgs);
            ...
            oServiceCalls: {
                ...
                countBookmarks: {
                    executeServiceCallFn: function (oServiceParams) {
                        ...
                        sap.ushell.Container.getServiceAsync("AppLifeCycle").then(function (oAppLifeCycleService) {
                            oAppLifeCycleService.getCurrentApplication().getSystemContext().then(function (oSystemContext) {
                                sap.ushell.Container.getService("Bookmark").countBookmarks(
                ...
                deleteBookmarks: {
                    executeServiceCallFn: function (oServiceParams) {
                        ...
                        sap.ushell.Container.getServiceAsync("AppLifeCycle").then(function (oAppLifeCycleService) {
                            oAppLifeCycleService.getCurrentApplication().getSystemContext().then(function (oSystemContext) {
                                sap.ushell.Container.getService("Bookmark").deleteBookmarks(
                                    oServiceParams.oMessageData.body.sUrl,
                                    oSystemContext.id
                                ).then(oDeferred.resolve);
                            });
                ...
                updateBookmarks: {
                    executeServiceCallFn: function (oServiceParams) {
                        ...
                        sap.ushell.Container.getServiceAsync("AppLifeCycle").then(function (oAppLifeCycleService) {
                            oAppLifeCycleService.getCurrentApplication().getSystemContext().then(function (oSystemContext) {
                                sap.ushell.Container.getService("Bookmark").updateBookmarks(
                                    oServiceParams.oMessageData.body.sUrl,
                                    oServiceParams.oMessageData.body.oParameters,
                                    oSystemContext.id
                                ).then(oDeferred.resolve);
