...
oFF.UiAllOperations = {
	...
	staticSetupLazy:function()
	{
			if (oFF.isNull(oFF.UiAllOperations.s_opMap))
		{
			...
			oFF.UiAllOperations.addProp(oFF.UiProperty.BORDER_SIZE, new oFF.UiClientPropBorderSize(), new oFF.UiClientPropBorderSize());
			...
			oFF.UiAllOperations.addProp(oFF.UiProperty.REQUIRED, new oFF.UiClientPropIsRequired(), new oFF.UiClientPropIsRequired());
			...
			oFF.UiAllOperations.addProp(oFF.UiProperty.MAXIMIZED, new oFF.UiClientPropIsMaximized(), null);
			oFF.UiAllOperations.addProp(oFF.UiProperty.HIDDEN, new oFF.UiClientPropIsHidden(), null);
			...
			oFF.UiAllOperations.addEventListener(oFF.UiEventDef.ON_SELECT, new oFF.UiClientOpRegisterOnSelect());
			oFF.UiAllOperations.addEventListener(oFF.UiEventDef.ON_SELECTION_CHANGE, new oFF.UiClientOpRegisterOnSelectionChange());
			oFF.UiAllOperations.addEventListener(oFF.UiEventDef.ON_CLICK, new oFF.UiClientOpRegisterOnClick());
			oFF.UiAllOperations.addEventListener(oFF.UiEventDef.ON_DOUBLE_CLICK, new oFF.UiClientOpRegisterOnDoubleClick());
			oFF.UiAllOperations.addEventListener(oFF.UiEventDef.ON_OPEN, new oFF.UiClientOpRegisterOnOpen());
			oFF.UiAllOperations.addEventListener(oFF.UiEventDef.ON_CLOSE, new oFF.UiClientOpRegisterOnClose());
			oFF.UiAllOperations.addEventListener(oFF.UiEventDef.ON_BEFORE_OPEN, new oFF.UiClientOpRegisterOnBeforeOpen());
			oFF.UiAllOperations.addEventListener(oFF.UiEventDef.ON_BEFORE_CLOSE, new oFF.UiClientOpRegisterOnBeforeClose());
			oFF.UiAllOperations.addEventListener(oFF.UiEventDef.ON_AFTER_OPEN, new oFF.UiClientOpRegisterOnAfterOpen());
			oFF.UiAllOperations.addEventListener(oFF.UiEventDef.ON_AFTER_CLOSE, new oFF.UiClientOpRegisterOnAfterClose());
			oFF.UiAllOperations.addEventListener(oFF.UiEventDef.ON_CHANGE, new oFF.UiClientOpRegisterOnChange());
			oFF.UiAllOperations.addEventListener(oFF.UiEventDef.ON_LIVE_CHANGE, new oFF.UiClientOpRegisterOnLiveChange());
			oFF.UiAllOperations.addEventListener(oFF.UiEventDef.ON_ENTER, new oFF.UiClientOpRegisterOnEnter());
			oFF.UiAllOperations.addEventListener(oFF.UiEventDef.ON_CONTEXT_MENU, new oFF.UiClientOpRegisterOnContextMenu());
			oFF.UiAllOperations.addEventListener(oFF.UiEventDef.ON_COLLAPSE, new oFF.UiClientOpRegisterOnCollapse());
			oFF.UiAllOperations.addEventListener(oFF.UiEventDef.ON_EXPAND, new oFF.UiClientOpRegisterOnExpand());
			oFF.UiAllOperations.addEventListener(oFF.UiEventDef.ON_PRESS, new oFF.UiClientOpRegisterOnPress());
			oFF.UiAllOperations.addEventListener(oFF.UiEventDef.ON_LOAD_FINISHED, new oFF.UiClientOpRegisterOnLoadFinished());
			oFF.UiAllOperations.addEventListener(oFF.UiEventDef.ON_DELETE, new oFF.UiClientOpRegisterOnDelete());
			oFF.UiAllOperations.addEventListener(oFF.UiEventDef.ON_DETAIL_PRESS, new oFF.UiClientOpRegisterOnDetailPress());
			oFF.UiAllOperations.addEventListener(oFF.UiEventDef.ON_EDITING_BEGIN, new oFF.UiClientOpRegisterOnEditingBegin());
			oFF.UiAllOperations.addEventListener(oFF.UiEventDef.ON_EDITING_END, new oFF.UiClientOpRegisterOnEditingEnd());
			oFF.UiAllOperations.addEventListener(oFF.UiEventDef.ON_BACK, new oFF.UiClientOpRegisterOnBack());
			oFF.UiAllOperations.addEventListener(oFF.UiEventDef.ON_REFRESH, new oFF.UiClientOpRegisterOnRefresh());
			oFF.UiAllOperations.addEventListener(oFF.UiEventDef.ON_MOVE, new oFF.UiClientOpRegisterOnMove());
			oFF.UiAllOperations.addEventListener(oFF.UiEventDef.ON_MOVE_START, new oFF.UiClientOpRegisterOnMoveStart());
			oFF.UiAllOperations.addEventListener(oFF.UiEventDef.ON_MOVE_END, new oFF.UiClientOpRegisterOnMoveEnd());
			oFF.UiAllOperations.addEventListener(oFF.UiEventDef.ON_RESIZE, new oFF.UiClientOpRegisterOnResize());
			oFF.UiAllOperations.addEventListener(oFF.UiEventDef.ON_SUGGESTION_SELECT, new oFF.UiClientOpRegisterOnSuggestionSelect());
			oFF.UiAllOperations.addEventListener(oFF.UiEventDef.ON_SCROLL, new oFF.UiClientOpRegisterOnScroll());
			oFF.UiAllOperations.addEventListener(oFF.UiEventDef.ON_SCROLL_LOAD, new oFF.UiClientOpRegisterOnScrollLoad());
			oFF.UiAllOperations.addEventListener(oFF.UiEventDef.ON_HOVER, new oFF.UiClientOpRegisterOnHover());
			oFF.UiAllOperations.addEventListener(oFF.UiEventDef.ON_HOVER_END, new oFF.UiClientOpRegisterOnHoverEnd());
			oFF.UiAllOperations.addEventListener(oFF.UiEventDef.ON_PASTE, new oFF.UiClientOpRegisterOnPaste());
			oFF.UiAllOperations.addEventListener(oFF.UiEventDef.ON_SELECTION_FINISH, new oFF.UiClientOpRegisterOnSelectionFinish());
			oFF.UiAllOperations.addEventListener(oFF.UiEventDef.ON_SEARCH, new oFF.UiClientOpRegisterOnSearch());
			oFF.UiAllOperations.addEventListener(oFF.UiEventDef.ON_BUTTON_PRESS, new oFF.UiClientOpRegisterOnButtonPress());
			oFF.UiAllOperations.addEventListener(oFF.UiEventDef.ON_ERROR, new oFF.UiClientOpRegisterOnError());
			oFF.UiAllOperations.addEventListener(oFF.UiEventDef.ON_READ_LINE_FINISHED, new oFF.UiClientOpRegisterOnReadLineFinished());
			oFF.UiAllOperations.addEventListener(oFF.UiEventDef.ON_EXECUTE, new oFF.UiClientOpRegisterOnExecute());
			oFF.UiAllOperations.addEventListener(oFF.UiEventDef.ON_TERMINATE, new oFF.UiClientOpRegisterOnTerminate());
			oFF.UiAllOperations.addEventListener(oFF.UiEventDef.ON_FILE_DROP, new oFF.UiClientOpRegisterOnFileDrop());
			oFF.UiAllOperations.addEventListener(oFF.UiEventDef.ON_DROP, new oFF.UiClientOpRegisterOnDrop());
...
oFF.UiDropEvent.createDrop = function(control, newParameters, draggedControl, droppedControl, dropPosition)
{
...
oFF.UiDropEvent.prototype.getDropPosition = function()
{
...
oFF.UiMoveEvent.createMove = function(control, newParameters, newPosition)
{
	var newObject = new oFF.UiMoveEvent();
	newObject.setupEvent(control, newParameters);
	newObject.setNewPosition(newPosition);
	return newObject;
};
oFF.UiMoveEvent.prototype.m_newPosition = null;
oFF.UiMoveEvent.prototype.getNewPosition = function()
{
	return this.m_newPosition;
};
oFF.UiMoveEvent.prototype.setNewPosition = function(newPosition)
{
	if (oFF.isNull(newPosition))
	{
		this.m_newPosition = oFF.UiPositionValue.create(0, 0);
	}
	else
	{
...
oFF.UiResizeEvent.createResize = function(control, newParameters, newSize)
{
	var newObject = new oFF.UiResizeEvent();
	newObject.setupEvent(control, newParameters);
	newObject.setNewSize(newSize);
	return newObject;
};
oFF.UiResizeEvent.prototype.m_newSize = null;
oFF.UiResizeEvent.prototype.getNewSize = function()
{
	return this.m_newSize;
};
oFF.UiResizeEvent.prototype.setNewSize = function(newSize)
{
	if (oFF.isNull(newSize))
	{
		this.m_newSize = oFF.UiSizeValue.create(0, 0);
	}
	else
	{
...
oFF.UiManagerSubSystemFactory.prototype = new oFF.XObject();
...
{
	oFF.Kernel.registerSubSystemFactory(oFF.SubSystemType.GUI, new oFF.UiManagerSubSystemFactory());
};
oFF.UiManagerSubSystemFactory.prototype.newKernelSubSystem = function(kernel)
{
	var uiManager = oFF.UiManagerFactory.newInstance(kernel.getKernelProcess());
	return uiManager;
};
...
oFF.UiClientOperationListener.prototype.getEventDef = oFF.noSupport;
oFF.UiClientOperationListener.prototype.getName = function()
{
	var tmpEvent = this.getEventDef();
	if (oFF.notNull(tmpEvent))
	{
		return tmpEvent.getRegisterMethodName();
	}
	throw oFF.XException.createRuntimeException("Missing event defintion for listener registration. Check events registration!");
};
...
oFF.UiClientOpNewControlAt.prototype.executeOperation = function(client, uiContext, operation, offset)
{
	...
	var position = oFF.UiPosition.lookup(operation.getStringAt(offset + 5));
...
oFF.UiParamAxWidthInPixel.prototype.doDeserialize = function(context, parameter)
{
	...
	{
		var value = parameter;
		context.setWidthValue(value.getInteger());
	}
};
...
oFF.UiControlGenerator.prototype.makeControlInterface = function(outputDir, thePackage, uiType, listOfInterfaces)
{
	...
	else
	{
		...
		if (uiType.isItemContainerWithDefaultItem())
		{
			sourceCode.append(", IUiItemNewOperations");
		}
		else if (uiType.isLayout())
		{
...
oFF.UiClientOpRegisterOnAfterClose.prototype.getEventDef = function()
{
	return oFF.UiEventDef.ON_AFTER_CLOSE;
};
...
oFF.UiClientOpRegisterOnAfterOpen.prototype.getEventDef = function()
{
	return oFF.UiEventDef.ON_AFTER_OPEN;
};
...
oFF.UiClientOpRegisterOnBack.prototype.getEventDef = function()
{
	return oFF.UiEventDef.ON_BACK;
};
...
oFF.UiClientOpRegisterOnBeforeClose.prototype.getEventDef = function()
{
	return oFF.UiEventDef.ON_BEFORE_CLOSE;
};
...
oFF.UiClientOpRegisterOnBeforeOpen.prototype.getEventDef = function()
{
	return oFF.UiEventDef.ON_BEFORE_OPEN;
};
...
oFF.UiClientOpRegisterOnButtonPress.prototype.getEventDef = function()
{
	return oFF.UiEventDef.ON_BUTTON_PRESS;
};
...
oFF.UiClientOpRegisterOnChange.prototype.getEventDef = function()
{
	return oFF.UiEventDef.ON_CHANGE;
};
...
oFF.UiClientOpRegisterOnClick.prototype.getEventDef = function()
{
	return oFF.UiEventDef.ON_CLICK;
};
...
oFF.UiClientOpRegisterOnClose.prototype.getEventDef = function()
{
	return oFF.UiEventDef.ON_CLOSE;
};
...
oFF.UiClientOpRegisterOnCollapse.prototype.getEventDef = function()
{
	return oFF.UiEventDef.ON_COLLAPSE;
};
...
oFF.UiClientOpRegisterOnContextMenu.prototype.getEventDef = function()
{
	return oFF.UiEventDef.ON_CONTEXT_MENU;
};
...
oFF.UiClientOpRegisterOnDelete.prototype.getEventDef = function()
{
	return oFF.UiEventDef.ON_DELETE;
};
...
oFF.UiClientOpRegisterOnDetailPress.prototype.getEventDef = function()
{
	return oFF.UiEventDef.ON_DETAIL_PRESS;
};
...
oFF.UiClientOpRegisterOnDoubleClick.prototype.getEventDef = function()
{
	return oFF.UiEventDef.ON_DOUBLE_CLICK;
};
...
oFF.UiClientOpRegisterOnDrop.prototype.getEventDef = function()
{
	return oFF.UiEventDef.ON_DROP;
};
...
oFF.UiClientOpRegisterOnEditingBegin.prototype.getEventDef = function()
{
	return oFF.UiEventDef.ON_EDITING_BEGIN;
};
...
oFF.UiClientOpRegisterOnEditingEnd.prototype.getEventDef = function()
{
	return oFF.UiEventDef.ON_EDITING_END;
};
...
oFF.UiClientOpRegisterOnEnter.prototype.getEventDef = function()
{
	return oFF.UiEventDef.ON_ENTER;
};
...
oFF.UiClientOpRegisterOnError.prototype.getEventDef = function()
{
	return oFF.UiEventDef.ON_ERROR;
};
...
oFF.UiClientOpRegisterOnExecute.prototype.getEventDef = function()
{
	return oFF.UiEventDef.ON_EXECUTE;
};
...
oFF.UiClientOpRegisterOnExpand.prototype.getEventDef = function()
{
	return oFF.UiEventDef.ON_EXPAND;
};
...
oFF.UiClientOpRegisterOnFileDrop.prototype.getEventDef = function()
{
	return oFF.UiEventDef.ON_FILE_DROP;
};
...
oFF.UiClientOpRegisterOnHover.prototype.getEventDef = function()
{
	return oFF.UiEventDef.ON_HOVER;
};
...
oFF.UiClientOpRegisterOnHoverEnd.prototype.getEventDef = function()
{
	return oFF.UiEventDef.ON_HOVER_END;
};
...
oFF.UiClientOpRegisterOnLiveChange.prototype.getEventDef = function()
{
	return oFF.UiEventDef.ON_LIVE_CHANGE;
};
...
oFF.UiClientOpRegisterOnLoadFinished.prototype.getEventDef = function()
{
	return oFF.UiEventDef.ON_LOAD_FINISHED;
};
...
oFF.UiClientOpRegisterOnMove.prototype.getEventDef = function()
{
	return oFF.UiEventDef.ON_MOVE;
};
...
oFF.UiClientOpRegisterOnMoveEnd.prototype.getEventDef = function()
{
	return oFF.UiEventDef.ON_MOVE_END;
};
...
oFF.UiClientOpRegisterOnMoveStart.prototype.getEventDef = function()
{
	return oFF.UiEventDef.ON_MOVE_START;
};
...
oFF.UiClientOpRegisterOnOpen.prototype.getEventDef = function()
{
	return oFF.UiEventDef.ON_OPEN;
};
...
oFF.UiClientOpRegisterOnPaste.prototype.getEventDef = function()
{
	return oFF.UiEventDef.ON_PASTE;
};
...
oFF.UiClientOpRegisterOnPress.prototype.getEventDef = function()
{
	return oFF.UiEventDef.ON_PRESS;
};
...
oFF.UiClientOpRegisterOnReadLineFinished.prototype.getEventDef = function()
{
	return oFF.UiEventDef.ON_READ_LINE_FINISHED;
};
...
oFF.UiClientOpRegisterOnRefresh.prototype.getEventDef = function()
{
	return oFF.UiEventDef.ON_REFRESH;
};
...
oFF.UiClientOpRegisterOnResize.prototype.getEventDef = function()
{
	return oFF.UiEventDef.ON_RESIZE;
};
...
oFF.UiClientOpRegisterOnScroll.prototype.getEventDef = function()
{
	return oFF.UiEventDef.ON_SCROLL;
};
...
oFF.UiClientOpRegisterOnScrollLoad.prototype.getEventDef = function()
{
	return oFF.UiEventDef.ON_SCROLL_LOAD;
};
...
oFF.UiClientOpRegisterOnSearch.prototype.getEventDef = function()
{
	return oFF.UiEventDef.ON_SEARCH;
};
...
oFF.UiClientOpRegisterOnSelect.prototype.getEventDef = function()
{
	return oFF.UiEventDef.ON_SELECT;
};
...
oFF.UiClientOpRegisterOnSelectionChange.prototype.getEventDef = function()
{
	return oFF.UiEventDef.ON_SELECTION_CHANGE;
};
...
oFF.UiClientOpRegisterOnSelectionFinish.prototype.getEventDef = function()
{
	return oFF.UiEventDef.ON_SELECTION_FINISH;
};
...
oFF.UiClientOpRegisterOnSuggestionSelect.prototype.getEventDef = function()
{
	return oFF.UiEventDef.ON_SUGGESTION_SELECT;
};
...
oFF.UiClientOpRegisterOnTerminate.prototype.getEventDef = function()
{
	return oFF.UiEventDef.ON_TERMINATE;
};
...
{
	oFF.UiMessageUtils.showFullscreenMessageInternal(genesis, message, null, oFF.UiUnitValue.createByCss("15px"), oFF.UiColor.ERROR.newDarkerColor(0.2), oFF.UiColor.ERROR.newBrighterColor(0.7));
};
oFF.UiMessageUtils.showWarningWithMessage = function(genesis, message)
{
	oFF.UiMessageUtils.showFullscreenMessageInternal(genesis, message, null, oFF.UiUnitValue.createByCss("15px"), oFF.UiColor.WARNING.newDarkerColor(0.3), oFF.UiColor.WARNING.newBrighterColor(0.75));
};
oFF.UiMessageUtils.showInfoWithMessage = function(genesis, message)
{
	oFF.UiMessageUtils.showFullscreenMessageInternal(genesis, message, null, oFF.UiUnitValue.createByCss("15px"), oFF.UiColor.INFO.newDarkerColor(0.3), oFF.UiColor.INFO.newBrighterColor(0.65));
};
...
oFF.UiMessageUtils.showFullscreenMessageInternal = function(genesis, message, description, fontSize, textCol, bgColor)
{
	if (oFF.notNull(genesis))
	{
		...
		msgLabel.setPadding(fontSize);
		msgLabel.setBorderSizeCss("1px");
		msgLabel.setBorderColor(textCol);
		msgLabel.setWrapping(true);
		if (oFF.XStringUtils.isNotNullAndNotEmpty(description))
		{
			var descFontSize = oFF.UiUnitValue.create(fontSize.getValue() - 2, fontSize.getUnit());
			...
			descriptionLabel.setPadding(descFontSize);
			descriptionLabel.setMarginCss("5px");
			descriptionLabel.setBorderSizeCss("1px");
...
{
	if (this.m_position === oFF.UiPosition.CONTENT && oFF.notNull(this.m_parent) && this.m_parent.isReleased() === false)
	{
...
{
	target.setBackgroundColor(oFF.UiColor.createByString(value));
};
oFF.UiClientPropBackgroundColor.prototype.getString = function(source)
{
	if (source.getBackgroundColor() !== null)
	{
		return source.getBackgroundColor().getHexColorWithAlpha();
	}
	return null;
};
...
{
	target.setBorderColor(oFF.UiColor.createByString(value));
};
oFF.UiClientPropBorderColor.prototype.getString = function(source)
{
	if (source.getBorderColor() !== null)
	{
		return source.getBorderColor().getHexColorWithAlpha();
	}
	return null;
};

oFF.UiClientPropBorderSize = function() {};
oFF.UiClientPropBorderSize.prototype = new oFF.UiClientPropString();
oFF.UiClientPropBorderSize.prototype._ff_c = "UiClientPropBorderSize";

oFF.UiClientPropBorderSize.prototype.getString = function(source)
{
	return source.getBorderSizeCss();
};
oFF.UiClientPropBorderSize.prototype.setString = function(target, value)
{
	target.setBorderSizeCss(value);
};
...
{
	target.setColor(oFF.UiColor.createByString(value));
};
oFF.UiClientPropColor.prototype.getString = function(source)
{
	if (source.getColor() !== null)
	{
		return source.getColor().getHexColorWithAlpha();
	}
	return null;
};
...
{
	target.setFontColor(oFF.UiColor.createByString(value));
};
oFF.UiClientPropFontColor.prototype.getString = function(source)
{
	if (source.getFontColor() !== null)
	{
		return source.getFontColor().getHexColorWithAlpha();
	}
	return null;
};
...
{
	target.setHeaderHeightCss(value);
};
oFF.UiClientPropHeaderHeight.prototype.getString = function(source)
{
	return source.getHeaderHeightCss();
};

oFF.UiClientPropIsHidden = function() {};
oFF.UiClientPropIsHidden.prototype = new oFF.UiClientPropBool();
oFF.UiClientPropIsHidden.prototype._ff_c = "UiClientPropIsHidden";

oFF.UiClientPropIsHidden.prototype.setBoolValue = oFF.noSupport;
oFF.UiClientPropIsHidden.prototype.getBoolValue = function(source)
{
...
{
	target.setMarginCss(value);
};
oFF.UiClientPropMargin.prototype.getString = function(source)
{
	return source.getMarginCss();
};

oFF.UiClientPropIsMaximized = function() {};
oFF.UiClientPropIsMaximized.prototype = new oFF.UiClientPropBool();
oFF.UiClientPropIsMaximized.prototype._ff_c = "UiClientPropIsMaximized";

oFF.UiClientPropIsMaximized.prototype.setBoolValue = oFF.noSupport;
oFF.UiClientPropIsMaximized.prototype.getBoolValue = function(source)
{
...
oFF.UiClientPropIsRequired = function() {};
oFF.UiClientPropIsRequired.prototype = new oFF.UiClientPropBool();
oFF.UiClientPropIsRequired.prototype._ff_c = "UiClientPropIsRequired";

oFF.UiClientPropIsRequired.prototype.setBoolValue = function(target, value)
{
	target.setRequired(value);
};
oFF.UiClientPropIsRequired.prototype.getBoolValue = function(source)
{
...
oFF.DfUiManagerGeneric.prototype.getGenesis = function()
{
	...
	{
		genesis = oFF.UiGenesis.create(anchor, oFF.UiPosition.CONTENT, oFF.UiOperation.SET, 0, 0);
	}
	return genesis;
};
...
{
	var alignContent = oFF.UiFlexAlignContent.lookup(value);
	if (oFF.notNull(alignContent))
	{
...
{
	var alignItems = oFF.UiFlexAlignItems.lookup(value);
	if (oFF.notNull(alignItems))
	{
...
{
	var alignSelf = oFF.UiFlexAlignSelf.lookup(value);
	if (oFF.notNull(alignSelf))
	{
...
{
	var buttonType = oFF.UiButtonType.lookup(value);
	if (oFF.notNull(buttonType))
	{
...
{
	var direction = oFF.UiFlexDirection.lookup(value);
...
{
	var theConstant = oFF.UiFontStyle.lookup(value);
	if (oFF.notNull(theConstant))
	{
...
{
	var theConstant = oFF.UiFontWeight.lookup(value);
	if (oFF.notNull(theConstant))
	{
...
{
	var frameType = oFF.UiFrameType.lookup(value);
	if (oFF.notNull(frameType))
	{
...
{
	var messageType = oFF.UiMessageType.lookup(value);
...
{
	var inputType = oFF.UiInputType.lookup(value);
	if (oFF.notNull(inputType))
	{
...
{
	var justifyContent = oFF.UiFlexJustifyContent.lookup(value);
	if (oFF.notNull(justifyContent))
	{
...
{
	var listType = oFF.UiListType.lookup(value);
	if (oFF.notNull(listType))
	{
...
{
	var loadState = oFF.UiLoadState.lookup(value);
	if (oFF.notNull(loadState))
	{
...
{
	var overflow = oFF.UiOverflow.lookup(value);
	if (oFF.notNull(overflow))
	{
...
{
	var placementType = oFF.UiPlacementType.lookup(value);
	if (oFF.notNull(placementType))
	{
...
{
	var selectionBehaviorValue = oFF.UiSelectionBehavior.lookup(value);
	if (oFF.notNull(selectionBehaviorValue))
	{
...
{
	var selectionModeValue = oFF.UiSelectionMode.lookup(value);
	if (oFF.notNull(selectionModeValue))
	{
...
oFF.UiClientPropTextDecoration.prototype = new oFF.UiClientOperationConst();
...
{
	var theConstant = oFF.UiTextDecoration.lookup(value);
	if (oFF.notNull(theConstant))
	{
		target.setTextDecoration(theConstant);
	}
};
oFF.UiClientPropTextDecoration.prototype.getConstantValue = function(source)
{
	return source.getTextDecoration();
};
oFF.UiClientPropTextDecoration.prototype.resolveConstant = function(value)
{
	return oFF.UiTextDecoration.lookup(value);
};
...
{
	var tileMode = oFF.UiTileMode.lookup(value);
	if (oFF.notNull(tileMode))
	{
...
{
	var valueState = oFF.UiValueState.lookup(value);
...
{
	var wrap = oFF.UiFlexWrap.lookup(value);
	if (oFF.notNull(wrap))
	{
		target.setWrap(wrap);
	}
...
oFF.SubSysPrgGui = function() {};
oFF.SubSysPrgGui.prototype = new oFF.DfProgramSubSys();
oFF.SubSysPrgGui.prototype._ff_c = "SubSysPrgGui";

oFF.SubSysPrgGui.DEFAULT_PROGRAM_NAME = "@SubSys.Gui";
oFF.SubSysPrgGui.prototype.m_uiManager = null;
oFF.SubSysPrgGui.prototype.newProgram = function()
{
	var newObj = new oFF.SubSysPrgGui();
	newObj.setup();
	return newObj;
};
oFF.SubSysPrgGui.prototype.getSubSystemType = function()
{
	return oFF.SubSystemType.GUI;
};
oFF.SubSysPrgGui.prototype.runProcess = function()
{
	var process = this.getProcess();
	this.m_uiManager = oFF.UiManagerFactory.newInstance(process);
	this.activateSubSystem(null);
	return false;
};
oFF.SubSysPrgGui.prototype.getMainApi = function()
{
	return this.m_uiManager;
};
...
oFF.UiEventDef = function() {};
oFF.UiEventDef.prototype = new oFF.UiBaseConstant();
oFF.UiEventDef.prototype._ff_c = "UiEventDef";

oFF.UiEventDef.ON_SELECT = null;
oFF.UiEventDef.ON_SELECTION_CHANGE = null;
oFF.UiEventDef.ON_CLICK = null;
oFF.UiEventDef.ON_DOUBLE_CLICK = null;
oFF.UiEventDef.ON_CONTEXT_MENU = null;
oFF.UiEventDef.ON_OPEN = null;
oFF.UiEventDef.ON_CLOSE = null;
oFF.UiEventDef.ON_COLLAPSE = null;
oFF.UiEventDef.ON_EXPAND = null;
oFF.UiEventDef.ON_CHANGE = null;
oFF.UiEventDef.ON_LIVE_CHANGE = null;
oFF.UiEventDef.ON_DELETE = null;
oFF.UiEventDef.ON_DETAIL_PRESS = null;
oFF.UiEventDef.ON_ENTER = null;
oFF.UiEventDef.ON_PRESS = null;
oFF.UiEventDef.ON_LOAD_FINISHED = null;
oFF.UiEventDef.ON_EDITING_BEGIN = null;
oFF.UiEventDef.ON_EDITING_END = null;
oFF.UiEventDef.ON_BACK = null;
oFF.UiEventDef.ON_REFRESH = null;
oFF.UiEventDef.ON_BEFORE_OPEN = null;
oFF.UiEventDef.ON_BEFORE_CLOSE = null;
oFF.UiEventDef.ON_AFTER_OPEN = null;
oFF.UiEventDef.ON_AFTER_CLOSE = null;
oFF.UiEventDef.ON_MOVE = null;
oFF.UiEventDef.ON_MOVE_START = null;
oFF.UiEventDef.ON_MOVE_END = null;
oFF.UiEventDef.ON_RESIZE = null;
oFF.UiEventDef.ON_SUGGESTION_SELECT = null;
oFF.UiEventDef.ON_SCROLL = null;
oFF.UiEventDef.ON_SCROLL_LOAD = null;
oFF.UiEventDef.ON_HOVER = null;
oFF.UiEventDef.ON_HOVER_END = null;
oFF.UiEventDef.ON_PASTE = null;
oFF.UiEventDef.ON_SELECTION_FINISH = null;
oFF.UiEventDef.ON_SEARCH = null;
oFF.UiEventDef.ON_BUTTON_PRESS = null;
oFF.UiEventDef.ON_ERROR = null;
oFF.UiEventDef.ON_READ_LINE_FINISHED = null;
oFF.UiEventDef.ON_EXECUTE = null;
oFF.UiEventDef.ON_TERMINATE = null;
oFF.UiEventDef.ON_FILE_DROP = null;
oFF.UiEventDef.ON_DROP = null;
oFF.UiEventDef.s_lookup = null;
oFF.UiEventDef.staticSetup = function()
{
	oFF.UiEventDef.s_lookup = oFF.XHashMapByString.create();
	oFF.UiEventDef.ON_SELECT = oFF.UiEventDef.create("OnSelect");
	oFF.UiEventDef.ON_SELECTION_CHANGE = oFF.UiEventDef.create("OnSelectionChange");
	oFF.UiEventDef.ON_CLICK = oFF.UiEventDef.create("OnClick");
	oFF.UiEventDef.ON_DOUBLE_CLICK = oFF.UiEventDef.create("OnDoubleClick");
	oFF.UiEventDef.ON_CONTEXT_MENU = oFF.UiEventDef.create("OnContextMenu");
	oFF.UiEventDef.ON_OPEN = oFF.UiEventDef.create("OnOpen");
	oFF.UiEventDef.ON_CLOSE = oFF.UiEventDef.create("OnClose");
	oFF.UiEventDef.ON_COLLAPSE = oFF.UiEventDef.create("OnCollapse");
	oFF.UiEventDef.ON_EXPAND = oFF.UiEventDef.create("OnExpand");
	oFF.UiEventDef.ON_CHANGE = oFF.UiEventDef.create("OnChange");
	oFF.UiEventDef.ON_LIVE_CHANGE = oFF.UiEventDef.create("OnLiveChange");
	oFF.UiEventDef.ON_DELETE = oFF.UiEventDef.create("OnDelete");
	oFF.UiEventDef.ON_DETAIL_PRESS = oFF.UiEventDef.create("OnDetailPress");
	oFF.UiEventDef.ON_ENTER = oFF.UiEventDef.create("OnEnter");
	oFF.UiEventDef.ON_PRESS = oFF.UiEventDef.create("OnPress");
	oFF.UiEventDef.ON_LOAD_FINISHED = oFF.UiEventDef.create("OnLoadFinished");
	oFF.UiEventDef.ON_EDITING_BEGIN = oFF.UiEventDef.create("OnEditingBegin");
	oFF.UiEventDef.ON_EDITING_END = oFF.UiEventDef.create("OnEditingEnd");
	oFF.UiEventDef.ON_BACK = oFF.UiEventDef.create("OnBack");
	oFF.UiEventDef.ON_REFRESH = oFF.UiEventDef.create("OnRefresh");
	oFF.UiEventDef.ON_BEFORE_OPEN = oFF.UiEventDef.create("OnBeforeOpen");
	oFF.UiEventDef.ON_BEFORE_CLOSE = oFF.UiEventDef.create("OnBeforeClose");
	oFF.UiEventDef.ON_AFTER_OPEN = oFF.UiEventDef.create("OnAfterOpen");
	oFF.UiEventDef.ON_AFTER_CLOSE = oFF.UiEventDef.create("OnAfterClose");
	oFF.UiEventDef.ON_MOVE = oFF.UiEventDef.create("OnMove");
	oFF.UiEventDef.ON_MOVE_START = oFF.UiEventDef.create("OnMoveStart");
	oFF.UiEventDef.ON_MOVE_END = oFF.UiEventDef.create("OnMoveEnd");
	oFF.UiEventDef.ON_RESIZE = oFF.UiEventDef.create("OnResize");
	oFF.UiEventDef.ON_SUGGESTION_SELECT = oFF.UiEventDef.create("OnSuggestionSelect");
	oFF.UiEventDef.ON_SCROLL = oFF.UiEventDef.create("OnScroll");
	oFF.UiEventDef.ON_SCROLL_LOAD = oFF.UiEventDef.create("OnScrollLoad");
	oFF.UiEventDef.ON_HOVER = oFF.UiEventDef.create("OnHover");
	oFF.UiEventDef.ON_HOVER_END = oFF.UiEventDef.create("OnHoverEnd");
	oFF.UiEventDef.ON_PASTE = oFF.UiEventDef.create("OnPaste");
	oFF.UiEventDef.ON_SELECTION_FINISH = oFF.UiEventDef.create("OnSelectionFinish");
	oFF.UiEventDef.ON_SEARCH = oFF.UiEventDef.create("OnSearch");
	oFF.UiEventDef.ON_BUTTON_PRESS = oFF.UiEventDef.create("OnButtonPress");
	oFF.UiEventDef.ON_ERROR = oFF.UiEventDef.create("OnError");
	oFF.UiEventDef.ON_READ_LINE_FINISHED = oFF.UiEventDef.create("OnReadLineFinished");
	oFF.UiEventDef.ON_EXECUTE = oFF.UiEventDef.create("OnExecute");
	oFF.UiEventDef.ON_TERMINATE = oFF.UiEventDef.create("OnTerminate");
	oFF.UiEventDef.ON_FILE_DROP = oFF.UiEventDef.create("OnFileDrop");
	oFF.UiEventDef.ON_DROP = oFF.UiEventDef.create("OnDrop");
};
oFF.UiEventDef.create = function(name)
{
	var newConstant = oFF.UiBaseConstant.createUiBaseConstant(new oFF.UiEventDef(), name, oFF.UiEventDef.s_lookup);
	return newConstant;
};
oFF.UiEventDef.lookup = function(name)
{
	return oFF.UiBaseConstant.lookupConstant(name, oFF.UiEventDef.s_lookup);
};
oFF.UiEventDef.prototype.m_registerMethodName = null;
oFF.UiEventDef.prototype.m_eventMethodName = null;
oFF.UiEventDef.prototype.getRegisterMethodName = function()
{
...
oFF.UiEventDef.prototype.getRemoteName = function()
{
...
oFF.UiProperty.BORDER_SIZE = null;
...
oFF.UiProperty.staticSetup = function()
{
	...
	oFF.UiProperty.BORDER_SIZE = oFF.UiProperty.createExt("BorderSize", oFF.XValueType.UI_UNIT_VALUE);
	...
	oFF.UiProperty.CORNER_RADIUS = oFF.UiProperty.createExt("CornerRadius", oFF.XValueType.UI_UNIT_VALUE);
	...
	oFF.UiProperty.FOOTER_HEIGHT = oFF.UiProperty.createExt("FooterHeight", oFF.XValueType.UI_UNIT_VALUE);
	oFF.UiProperty.FONT_SIZE = oFF.UiProperty.createExt("FontSize", oFF.XValueType.UI_UNIT_VALUE);
	...
	oFF.UiProperty.HEIGHT = oFF.UiProperty.createExt("Height", oFF.XValueType.UI_UNIT_VALUE);
	...
	oFF.UiProperty.HEADER_HEIGHT = oFF.UiProperty.createExt("HeaderHeight", oFF.XValueType.UI_UNIT_VALUE);
	...
	oFF.UiProperty.MARGIN = oFF.UiProperty.createExt("Margin", oFF.XValueType.UI_UNIT_VALUE);
	...
	oFF.UiProperty.PADDING = oFF.UiProperty.createExt("Padding", oFF.XValueType.UI_UNIT_VALUE);
	...
	oFF.UiProperty.TEXT_DECORATION = oFF.UiProperty.createExt("TextDecoration", oFF.XValueType.UI_CONSTANT);
	...
	oFF.UiProperty.X_POS = oFF.UiProperty.createExt("X", oFF.XValueType.UI_UNIT_VALUE);
	oFF.UiProperty.Y_POS = oFF.UiProperty.createExt("Y", oFF.XValueType.UI_UNIT_VALUE);
	oFF.UiProperty.WIDTH = oFF.UiProperty.createExt("Width", oFF.XValueType.UI_UNIT_VALUE);
...
oFF.UiProperty.prototype.generateSetterMethodName = function()
{
	...
	{
		if (this.getValueType().isEqualTo(oFF.XValueType.UI_UNIT_VALUE))
		{
			setterName = oFF.XStringUtils.concatenate2(setterName, "Css");
		}
	}
	return setterName;
};
oFF.UiProperty.prototype.generateGetterMethodName = function()
{
	...
	if (this.getValueType() !== null)
	{
		...
		else if (this.getValueType().isEqualTo(oFF.XValueType.UI_UNIT_VALUE))
		{
			getterName = oFF.XStringUtils.concatenate2(getterName, "Css");
		}
	}
	return getterName;
};
...
oFF.UBorderStyle = function() {};
oFF.UBorderStyle.prototype = new oFF.UiAbstractConstant();
oFF.UBorderStyle.prototype._ff_c = "UBorderStyle";

oFF.UBorderStyle.SOLID = null;
oFF.UBorderStyle.DOTTED = null;
oFF.UBorderStyle.DASHED = null;
oFF.UBorderStyle.DOUBLE = null;
oFF.UBorderStyle.NONE = null;
oFF.UBorderStyle.s_lookup = null;
oFF.UBorderStyle.staticSetup = function()
{
	oFF.UBorderStyle.s_lookup = oFF.XHashMapByString.create();
	oFF.UBorderStyle.SOLID = oFF.UBorderStyle.create("Solid");
	oFF.UBorderStyle.DOTTED = oFF.UBorderStyle.create("Dotted");
	oFF.UBorderStyle.DASHED = oFF.UBorderStyle.create("Dashed");
	oFF.UBorderStyle.DOUBLE = oFF.UBorderStyle.create("Double");
	oFF.UBorderStyle.NONE = oFF.UBorderStyle.create("None");
};
oFF.UBorderStyle.create = function(name)
{
	var newConstant = oFF.UiAbstractConstant.createUiConstant(new oFF.UBorderStyle(), name, oFF.UBorderStyle.s_lookup);
	return newConstant;
};
oFF.UBorderStyle.lookup = function(value)
{
	var valueUpper = oFF.XString.toUpperCase(value);
	return oFF.UBorderStyle.s_lookup.getByKey(valueUpper);
};
...
{
	var newConstant = oFF.UiAbstractConstant.createUiConstantExt(new oFF.UiFlexAlignSelf(), name, null, cssValue, oFF.UiFlexAlignSelf.s_lookup, null);
	return newConstant;
};
...
{
	var newConstant = oFF.UiAbstractConstant.createUiConstantExt(new oFF.UiOverflow(), name, null, cssValue, oFF.UiOverflow.s_lookup, null);
	return newConstant;
};
...
oFF.UiPosition.prototype = new oFF.UiAbstractConstant();
oFF.UiPosition.prototype._ff_c = "UiPosition";

oFF.UiPosition.CENTER = null;
oFF.UiPosition.TOP = null;
oFF.UiPosition.BOTTOM = null;
oFF.UiPosition.LEFT = null;
oFF.UiPosition.RIGHT = null;
oFF.UiPosition.MIDDLE = null;
oFF.UiPosition.TOP_LEFT = null;
oFF.UiPosition.TOP_RIGHT = null;
oFF.UiPosition.BOTTOM_LEFT = null;
oFF.UiPosition.BOTTOM_RIGHT = null;
oFF.UiPosition.CONTENT = null;
oFF.UiPosition.COLUMN_ROW = null;
oFF.UiPosition.s_lookup = null;
oFF.UiPosition.staticSetup = function()
{
	oFF.UiPosition.s_lookup = oFF.XHashMapByString.create();
	oFF.UiPosition.TOP = oFF.UiPosition.create("Top");
	oFF.UiPosition.BOTTOM = oFF.UiPosition.create("Bottom");
	oFF.UiPosition.LEFT = oFF.UiPosition.create("Left");
	oFF.UiPosition.RIGHT = oFF.UiPosition.create("Right");
	oFF.UiPosition.MIDDLE = oFF.UiPosition.create("Middle");
	oFF.UiPosition.TOP_LEFT = oFF.UiPosition.create("TopLeft");
	oFF.UiPosition.TOP_RIGHT = oFF.UiPosition.create("TopRight");
	oFF.UiPosition.BOTTOM_LEFT = oFF.UiPosition.create("BottomLeft");
	oFF.UiPosition.BOTTOM_RIGHT = oFF.UiPosition.create("BottomRight");
	oFF.UiPosition.CENTER = oFF.UiPosition.create("Center");
	oFF.UiPosition.CONTENT = oFF.UiPosition.create("Content");
	oFF.UiPosition.COLUMN_ROW = oFF.UiPosition.create("ColumnRow");
};
oFF.UiPosition.create = function(name)
{
	return oFF.UiAbstractConstant.createUiConstant(new oFF.UiPosition(), name, oFF.UiPosition.s_lookup);
};
oFF.UiPosition.lookup = function(name)
{
	return oFF.UiPosition.s_lookup.getByKey(name);
};
...
oFF.UiStateChangeCause = function() {};
oFF.UiStateChangeCause.prototype = new oFF.UiAbstractConstant();
oFF.UiStateChangeCause.prototype._ff_c = "UiStateChangeCause";

oFF.UiStateChangeCause.DEFAULT_VALUE = null;
oFF.UiStateChangeCause.PASSIVE = null;
oFF.UiStateChangeCause.SELECTION_BUTTON = null;
oFF.UiStateChangeCause.CLICK = null;
oFF.UiStateChangeCause.DOUBLE_CLICK = null;
oFF.UiStateChangeCause.ENTER = null;
oFF.UiStateChangeCause.CANCEL = null;
oFF.UiStateChangeCause.FINISH = null;
oFF.UiStateChangeCause.SEQUENCE_CHANGED = null;
oFF.UiStateChangeCause.NAVIGATE = null;
oFF.UiStateChangeCause.create = function(name)
{
	return oFF.UiAbstractConstant.createUiConstant(new oFF.UiStateChangeCause(), name, null);
};
oFF.UiStateChangeCause.staticSetup = function()
{
	oFF.UiStateChangeCause.DEFAULT_VALUE = oFF.UiStateChangeCause.create("Default");
	oFF.UiStateChangeCause.PASSIVE = oFF.UiStateChangeCause.create("Passive");
	oFF.UiStateChangeCause.SELECTION_BUTTON = oFF.UiStateChangeCause.create("SelectionButton");
	oFF.UiStateChangeCause.CLICK = oFF.UiStateChangeCause.create("Click");
	oFF.UiStateChangeCause.DOUBLE_CLICK = oFF.UiStateChangeCause.create("DoubleClick");
	oFF.UiStateChangeCause.ENTER = oFF.UiStateChangeCause.create("Enter");
	oFF.UiStateChangeCause.CANCEL = oFF.UiStateChangeCause.create("Cancel");
	oFF.UiStateChangeCause.FINISH = oFF.UiStateChangeCause.create("Finish");
	oFF.UiStateChangeCause.SEQUENCE_CHANGED = oFF.UiStateChangeCause.create("SequenceChanged");
	oFF.UiStateChangeCause.NAVIGATE = oFF.UiStateChangeCause.create("Navigate");
};
...
oFF.UiTextDecoration = function() {};
oFF.UiTextDecoration.prototype = new oFF.UiAbstractConstant();
oFF.UiTextDecoration.prototype._ff_c = "UiTextDecoration";

oFF.UiTextDecoration.PREDEFINED = null;
oFF.UiTextDecoration.NORMAL = null;
oFF.UiTextDecoration.UNDERLINE = null;
oFF.UiTextDecoration.OVERLINE = null;
oFF.UiTextDecoration.LINETHROUGH = null;
oFF.UiTextDecoration.s_lookup = null;
oFF.UiTextDecoration.staticSetup = function()
{
	oFF.UiTextDecoration.s_lookup = oFF.XHashMapByString.create();
	oFF.UiTextDecoration.PREDEFINED = oFF.UiTextDecoration.create("Predefined");
	oFF.UiTextDecoration.NORMAL = oFF.UiTextDecoration.create("Normal");
	oFF.UiTextDecoration.UNDERLINE = oFF.UiTextDecoration.create("Underline");
	oFF.UiTextDecoration.OVERLINE = oFF.UiTextDecoration.create("Overline");
	oFF.UiTextDecoration.LINETHROUGH = oFF.UiTextDecoration.create("Linethrough");
};
oFF.UiTextDecoration.create = function(name)
{
	return oFF.UiAbstractConstant.createUiConstant(new oFF.UiTextDecoration(), name, oFF.UiTextDecoration.s_lookup);
};
oFF.UiTextDecoration.lookup = function(name)
{
	return oFF.UiTextDecoration.s_lookup.getByKey(name);
};
...
oFF.MxGridCell.prototype.reset = function()
{
	...
	{
		this.m_backgroundColor = oFF.UiColor.create(0, 0, 0, 0.0);
	}
...
oFF.UiInterface.staticSetup = function()
{
	...
	oFF.UiInterface.BORDER = oFF.UiInterface.create("Border").prop(oFF.UiProperty.BORDER_COLOR).prop(oFF.UiProperty.BORDER_SIZE).prop(oFF.UiProperty.CORNER_RADIUS);
	...
	oFF.UiInterface.ROW = oFF.UiInterface.create("Row").prop(oFF.UiProperty.SELECTED).event(oFF.UiEventDef.ON_CLICK);
	oFF.UiInterface.FRAME = oFF.UiInterface.create("Frame").prop(oFF.UiProperty.WIDTH).prop(oFF.UiProperty.HEIGHT).prop(oFF.UiProperty.X_POS).prop(oFF.UiProperty.Y_POS).method(oFF.UiMethod.SIZE).method(oFF.UiMethod.POSITION).method(oFF.UiMethod.FRAME);
	oFF.UiInterface.WINDOW = oFF.UiInterface.create("Window").interf(oFF.UiInterface.FRAME).prop(oFF.UiProperty.TITLE).prop(oFF.UiProperty.OPEN).prop(oFF.UiProperty.MAXIMIZED).prop(oFF.UiProperty.HIDDEN).method(oFF.UiMethod.OPEN).method(oFF.UiMethod.CLOSE).method(oFF.UiMethod.MAXIMIZE).method(oFF.UiMethod.RESTORE).method(oFF.UiMethod.HIDE).method(oFF.UiMethod.SHOW).method(oFF.UiMethod.BRING_TO_FRONT).event(oFF.UiEventDef.ON_OPEN).event(oFF.UiEventDef.ON_CLOSE).event(oFF.UiEventDef.ON_MOVE).event(oFF.UiEventDef.ON_MOVE_START).event(oFF.UiEventDef.ON_MOVE_END).event(oFF.UiEventDef.ON_RESIZE).event(oFF.UiEventDef.ON_BUTTON_PRESS).event(oFF.UiEventDef.ON_FILE_DROP);
};
...
oFF.UiType.TAB_STRIP = null;
oFF.UiType.TAB_STRIP_ITEM = null;
...
oFF.UiType.staticSetup = function()
{
	...
	oFF.UiType.staticSetupAbstractBaseControls();
...
oFF.UiType.staticSetupAbstractBaseControls = function()
{
	oFF.UiType.ELEMENT = oFF.UiType.createBase("Element", "Interface for UI Elements.", null).prop(oFF.UiProperty.ID).prop(oFF.UiProperty.NAME).prop(oFF.UiProperty.PARENT).prop(oFF.UiProperty.TAG).prop(oFF.UiProperty.TOOLTIP).prop(oFF.UiProperty.CUSTOM_OBJECT);
	oFF.UiType.BASE_CONTROL = oFF.UiType.createBase("BaseControl", "Base interface for Controls.", oFF.UiType.ELEMENT).interf(oFF.UiInterface.FRAME).interf(oFF.UiInterface.BORDER).prop(oFF.UiProperty.ENABLED).prop(oFF.UiProperty.VISIBLE).prop(oFF.UiProperty.BACKGROUND_COLOR).prop(oFF.UiProperty.PADDING).prop(oFF.UiProperty.OPACITY);
	oFF.UiType.ITEM = oFF.UiType.createBase("Item", "Interface for Items.", oFF.UiType.ELEMENT).prop(oFF.UiProperty.ENABLED).prop(oFF.UiProperty.DRAGGABLE);
	oFF.UiType.LIST_ITEM_BASE = oFF.UiType.createBase("ListItemBase", "Interface for list items.", oFF.UiType.ITEM).interf(oFF.UiInterface.BORDER).prop(oFF.UiProperty.COUNTER).prop(oFF.UiProperty.HIGHLIGHT).prop(oFF.UiProperty.SELECTED).prop(oFF.UiProperty.LIST_ITEM_TYPE).prop(oFF.UiProperty.BUSY).prop(oFF.UiProperty.MARGIN).event(oFF.UiEventDef.ON_CLICK).event(oFF.UiEventDef.ON_DOUBLE_CLICK).event(oFF.UiEventDef.ON_PRESS).event(oFF.UiEventDef.ON_DETAIL_PRESS).event(oFF.UiEventDef.ON_CONTEXT_MENU);
	oFF.UiType.CONTROL = oFF.UiType.createBase("Control", "Interface for Controls.", oFF.UiType.BASE_CONTROL).interf(oFF.UiInterface.FLEX_ITEM).prop(oFF.UiProperty.MARGIN).prop(oFF.UiProperty.DRAGGABLE).event(oFF.UiEventDef.ON_DROP);
	oFF.UiType.FLOATING_CONTROL = oFF.UiType.createBase("FloatingControl", "Interface for Floating Controls.", oFF.UiType.BASE_CONTROL).method(oFF.UiMethod.CLOSE);
	oFF.UiType.COMPOSITE = oFF.UiType.createBase("Composite", "Interface for Composites.", oFF.UiType.CONTROL);
};
oFF.UiType.staticSetupItems = function()
{
	...
	oFF.UiType.MENU_ITEM = oFF.UiType.createItem("MenuItem", "The MenuItem control is used for creating items for the Menu control.").prop(oFF.UiProperty.TEXT).prop(oFF.UiProperty.ICON).prop(oFF.UiProperty.SECTION_START).aggregation(oFF.UiAggregation.ITEMS).event(oFF.UiEventDef.ON_CLICK).event(oFF.UiEventDef.ON_PRESS);
	oFF.UiType.MENU_ITEM.setDefaultItemType(oFF.UiType.MENU_ITEM);
	oFF.UiType.SEGMENTED_BUTTON_ITEM = oFF.UiType.createItem("SegmentedButtonItem", "Used for creating buttons for the SegmentedButton control.").prop(oFF.UiProperty.TEXT).prop(oFF.UiProperty.ICON).prop(oFF.UiProperty.SELECTED).event(oFF.UiEventDef.ON_PRESS);
	oFF.UiType.TILE_ITEM = oFF.UiType.createItem("TileItem", "The TileItem control is used for creating items for the TileContainer control.").prop(oFF.UiProperty.TEXT).prop(oFF.UiProperty.SRC).event(oFF.UiEventDef.ON_CLICK).event(oFF.UiEventDef.ON_DOUBLE_CLICK).event(oFF.UiEventDef.ON_PRESS).event(oFF.UiEventDef.ON_CONTEXT_MENU);
...
{
	oFF.UiType.BUTTON = oFF.UiType.createBasicControl("Button", "Enables users to trigger actions.").addReceiverBinding(oFF.SemanticBindingType.STRING, oFF.ProtocolBindingType.STRING).prop(oFF.UiProperty.TEXT).prop(oFF.UiProperty.ICON).prop(oFF.UiProperty.BUTTON_TYPE).method(oFF.UiMethod.FOCUS).event(oFF.UiEventDef.ON_PRESS);
	...
	oFF.UiType.LABEL = oFF.UiType.createBasicControl("Label", "Provides a textual label for displaying text.").interf(oFF.UiInterface.FONT).prop(oFF.UiProperty.TEXT).prop(oFF.UiProperty.TEXT_ALIGN).prop(oFF.UiProperty.WRAPPING).prop(oFF.UiProperty.REQUIRED);
	oFF.UiType.LINK = oFF.UiType.createBasicControl("Link", "A hyperlink control used to navigate to other apps and web pages or to trigger actions.").interf(oFF.UiInterface.FONT).prop(oFF.UiProperty.TEXT).prop(oFF.UiProperty.TEXT_ALIGN).prop(oFF.UiProperty.WRAPPING).prop(oFF.UiProperty.SRC).event(oFF.UiEventDef.ON_PRESS);
	oFF.UiType.CHECKBOX = oFF.UiType.createBasicControl("Checkbox", "Allows the user to set a binary value, such as true/false.").addCapabilityFlag(oFF.UiType._SUPPORTS_CHECKED_CHANGE).prop(oFF.UiProperty.TEXT).prop(oFF.UiProperty.CHECKED).prop(oFF.UiProperty.WRAPPING).event(oFF.UiEventDef.ON_CHANGE);
	oFF.UiType.SWITCH = oFF.UiType.createBasicControl("Switch", "A variation of a Checkbox which enabled switching between binary states.").addCapabilityFlag(oFF.UiType._SUPPORTS_ON_CHANGE).prop(oFF.UiProperty.ON).prop(oFF.UiProperty.ON_TEXT).prop(oFF.UiProperty.OFF_TEXT).event(oFF.UiEventDef.ON_CHANGE);
	...
	oFF.UiType.HTML = oFF.UiType.createBasicControl("Html", "Embeds standard HTML in an UI control tree.").prop(oFF.UiProperty.VALUE).event(oFF.UiEventDef.ON_LOAD_FINISHED);
	oFF.UiType.WEB_ASSEMBLY = oFF.UiType.createBasicControl("WebAssembly", "Allows to embed WebAsembly programs in an Ui control tree.").prop(oFF.UiProperty.SRC).method(oFF.UiMethod.FULLSCREEN).event(oFF.UiEventDef.ON_LOAD_FINISHED).event(oFF.UiEventDef.ON_ERROR);
	oFF.UiType.RADIO_BUTTON = oFF.UiType.createBasicControl("RadioButton", "RadioButton is a control similar to a Checkbox, but it allows you to choose only one of the predefined set of options.").addCapabilityFlag(oFF.UiType._SUPPORTS_SELECTED_CHANGE).prop(oFF.UiProperty.TEXT).prop(oFF.UiProperty.SELECTED).event(oFF.UiEventDef.ON_CHANGE);
	oFF.UiType.CODE_EDITOR = oFF.UiType.createBasicControl("CodeEditor", "Allows to visualize source code of various types with syntax highlighting, line numbers in editable and read only mode.").addCapabilityFlag(oFF.UiType._SUPPORTS_TEXT_CHANGE).prop(oFF.UiProperty.TEXT).prop(oFF.UiProperty.CODE_TYPE).prop(oFF.UiProperty.EDITABLE).prop(oFF.UiProperty.BUSY).prop(oFF.UiProperty.DEBOUNCE_TIME).method(oFF.UiMethod.FOCUS).event(oFF.UiEventDef.ON_LIVE_CHANGE).event(oFF.UiEventDef.ON_EDITING_BEGIN).event(oFF.UiEventDef.ON_EDITING_END).event(oFF.UiEventDef.ON_ENTER).event(oFF.UiEventDef.ON_PASTE).event(oFF.UiEventDef.ON_FILE_DROP);
	oFF.UiType.CLOCK = oFF.UiType.createBasicControl("Clock", "Display a clock which shows the current time.").interf(oFF.UiInterface.FONT).event(oFF.UiEventDef.ON_PRESS);
	oFF.UiType.APP_ICON = oFF.UiType.createBasicControl("AppIcon", "A control which displays a configurable app-like icon.").prop(oFF.UiProperty.TEXT).prop(oFF.UiProperty.SRC).event(oFF.UiEventDef.ON_CLICK).event(oFF.UiEventDef.ON_DOUBLE_CLICK).event(oFF.UiEventDef.ON_MOVE).event(oFF.UiEventDef.ON_MOVE_START).event(oFF.UiEventDef.ON_MOVE_END).event(oFF.UiEventDef.ON_CONTEXT_MENU);
	oFF.UiType.TASK_BAR_BUTTON = oFF.UiType.createBasicControl("TaskBarButton", "An variation of a Button that is used in the task bar.").prop(oFF.UiProperty.TEXT).prop(oFF.UiProperty.SRC).event(oFF.UiEventDef.ON_PRESS).event(oFF.UiEventDef.ON_CONTEXT_MENU);
...
{
	oFF.UiType.DROPDOWN = oFF.UiType.createItemContainer("Dropdown", "The Dropdown control provides a list of predefined items that allows users to choose options and additionally trigger some actions.", oFF.UiType.DROPDOWN_ITEM, oFF.UiType.DROPDOWN_ITEM).addSingleSelection(oFF.UiAggregation.ITEMS).addSenderBinding(oFF.SemanticBindingType.STRING, oFF.ProtocolBindingType.STRING).prop(oFF.UiProperty.REQUIRED).prop(oFF.UiProperty.VALUE_STATE).prop(oFF.UiProperty.VALUE_STATE_TEXT).aggregation(oFF.UiAggregation.BUTTONS).event(oFF.UiEventDef.ON_SELECT);
	oFF.UiType.COMBO_BOX = oFF.UiType.createItemContainer("ComboBox", "A Dropdown list variation which enables selecting and filtering values.", oFF.UiType.DROPDOWN_ITEM, oFF.UiType.DROPDOWN_ITEM).addCapabilityFlag(oFF.UiType._SUPPORTS_TEXT_CHANGE).addSingleSelection(oFF.UiAggregation.ITEMS).prop(oFF.UiProperty.TEXT).prop(oFF.UiProperty.PLACEHOLDER).prop(oFF.UiProperty.REQUIRED).prop(oFF.UiProperty.OPEN).prop(oFF.UiProperty.VALUE_STATE).prop(oFF.UiProperty.VALUE_STATE_TEXT).event(oFF.UiEventDef.ON_SELECT).event(oFF.UiEventDef.ON_ENTER).event(oFF.UiEventDef.ON_EDITING_BEGIN).event(oFF.UiEventDef.ON_EDITING_END);
	oFF.UiType.MULTI_COMBO_BOX = oFF.UiType.createItemContainer("MultiComboBox", "A ComboBox variation which allows the user to either type a value directly into the control or choose multiply items from the list of existing items.", oFF.UiType.DROPDOWN_ITEM, oFF.UiType.DROPDOWN_ITEM).addCapabilityFlag(oFF.UiType._SUPPORTS_TEXT_CHANGE).addMultiSelection(oFF.UiAggregation.ITEMS).prop(oFF.UiProperty.TEXT).prop(oFF.UiProperty.PLACEHOLDER).prop(oFF.UiProperty.REQUIRED).prop(oFF.UiProperty.OPEN).prop(oFF.UiProperty.VALUE_STATE).prop(oFF.UiProperty.VALUE_STATE_TEXT).event(oFF.UiEventDef.ON_SELECTION_CHANGE).event(oFF.UiEventDef.ON_SELECT).event(oFF.UiEventDef.ON_SELECTION_FINISH).event(oFF.UiEventDef.ON_ENTER).event(oFF.UiEventDef.ON_EDITING_BEGIN).event(oFF.UiEventDef.ON_EDITING_END);
	oFF.UiType.LIST = oFF.UiType.createItemContainer("List", "The List control provides a container for list items. ", oFF.UiType.LIST_ITEM_BASE, oFF.UiType.LIST_ITEM).addMultiSelection(oFF.UiAggregation.ITEMS).prop(oFF.UiProperty.SELECTION_MODE).prop(oFF.UiProperty.BUSY).prop(oFF.UiProperty.HEADER).event(oFF.UiEventDef.ON_SELECT).event(oFF.UiEventDef.ON_SELECTION_CHANGE).event(oFF.UiEventDef.ON_DELETE).event(oFF.UiEventDef.ON_SCROLL_LOAD);
	oFF.UiType.RADIO_BUTTON_GROUP = oFF.UiType.createBasicControl("RadioButtonGroup", "This control is used as a wrapper for a group of RadioButton controls, which can be used as a single UI element.").addSingleSelection(oFF.UiAggregation.RADIO_BUTTONS).prop(oFF.UiProperty.COLUMN_COUNT).aggregation(oFF.UiAggregation.RADIO_BUTTONS).event(oFF.UiEventDef.ON_SELECT);
	oFF.UiType.TILE_CONTAINER = oFF.UiType.createItemContainer("TileContainer", "The TileContainer control provides a container for tile items. ", oFF.UiType.TILE_ITEM, oFF.UiType.TILE_ITEM).event(oFF.UiEventDef.ON_CONTEXT_MENU);
	...
	oFF.UiType.SEGMENTED_BUTTON = oFF.UiType.createItemContainer("SegmentedButton", "A horizontal control made of multiple buttons, which can display a title or an image.", oFF.UiType.SEGMENTED_BUTTON_ITEM, oFF.UiType.SEGMENTED_BUTTON_ITEM).addSingleSelection(oFF.UiAggregation.ITEMS).method(oFF.UiMethod.FOCUS).event(oFF.UiEventDef.ON_SELECTION_CHANGE);
	oFF.UiType.LAUNCHPAD = oFF.UiType.createItemContainer("Launchpad", "A desktop-like like control which can be used to show app icons in a clean and ordere way.", oFF.UiType.APP_ICON, oFF.UiType.APP_ICON).prop(oFF.UiProperty.BACKGROUND_IMAGE_SRC).prop(oFF.UiProperty.HEADER).prop(oFF.UiProperty.FOOTER).prop(oFF.UiProperty.HEADER_HEIGHT).prop(oFF.UiProperty.FOOTER_HEIGHT).event(oFF.UiEventDef.ON_CONTEXT_MENU);
	oFF.UiType.TASK_BAR = oFF.UiType.createItemContainer("TaskBar", "A Horizontal container which displays TaskBarButton controls.", oFF.UiType.TASK_BAR_BUTTON, oFF.UiType.TASK_BAR_BUTTON).event(oFF.UiEventDef.ON_CONTEXT_MENU);
};
oFF.UiType.staticSetupGrids = function()
{
	oFF.UiType.TABLE_COLUMN = oFF.UiType.createBasicControl("TableColumn", "The column allows you to define column specific properties that will be applied when rendering the table.").prop(oFF.UiProperty.TITLE).prop(oFF.UiProperty.SHOW_SORTING);
	oFF.UiType.TABLE_CELL = oFF.UiType.createBasicControl("TableCell", "The TableCell control acts as an abstract constrol which allows to define the content of a Table cell.").prop(oFF.UiProperty.TEXT).event(oFF.UiEventDef.ON_CLICK);
	oFF.UiType.TABLE_ROW = oFF.UiType.createBasicControl("TableRow", "The TableRow control is used to define a row of cells in a table.").prop(oFF.UiProperty.SELECTED).aggregation(oFF.UiAggregation.CELLS).event(oFF.UiEventDef.ON_CLICK);
	oFF.UiType.TABLE = oFF.UiType.createBasicControl("Table", "Provides a comprehensive set of features for displaying and dealing with vast amounts of data. The Table control supports desktop PCs and tablet devices. ").addCapabilityFlag(oFF.UiType._SUPPORTS_VISIBLE_ROW_COUNT_CHANGE).addCapabilityFlag(oFF.UiType._SUPPORTS_FIRST_VISIBLE_ROW_CHANGE).addMultiSelection(oFF.UiAggregation.ROWS).prop(oFF.UiProperty.SELECTION_MODE).prop(oFF.UiProperty.SELECTION_BEHAVIOR).prop(oFF.UiProperty.TITLE).prop(oFF.UiProperty.BUSY).prop(oFF.UiProperty.ENABLE_SELECT_ALL).prop(oFF.UiProperty.FOOTER).prop(oFF.UiProperty.VISIBLE_ROW_COUNT).prop(oFF.UiProperty.VISIBLE_ROW_COUNT_MODE).prop(oFF.UiProperty.MIN_ROW_COUNT).prop(oFF.UiProperty.FIRST_VISIBLE_ROW).aggregation(oFF.UiAggregation.COLUMNS).aggregation(oFF.UiAggregation.ROWS).event(oFF.UiEventDef.ON_SELECT).event(oFF.UiEventDef.ON_SELECTION_CHANGE).event(oFF.UiEventDef.ON_SCROLL);
	oFF.UiType.RESPONSIVE_TABLE_COLUMN = oFF.UiType.createBasicControl("ResponsiveTableColumn", "The ResponsiveTableColumn allows to define column specific properties that will be applied when rendering the ResponsiveTable.").setSuperType(oFF.UiType.TABLE_COLUMN);
	oFF.UiType.RESPONSIVE_TABLE_CELL = oFF.UiType.createBasicControl("ResponsiveTableCell", "The ResponsiveTableCell control acts as an abstract constrol which allows to define the content of a ResponsiveTable cell.").setSuperType(oFF.UiType.TABLE_CELL);
	oFF.UiType.RESPONSIVE_TABLE_ROW = oFF.UiType.createBasicControl("ResponsiveTableRow", "The ResponsiveTableRow control is used to define a row of cells in a ResponsiveTable.").prop(oFF.UiProperty.HIGHLIGHT).prop(oFF.UiProperty.SELECTED).prop(oFF.UiProperty.LIST_ITEM_TYPE).aggregation(oFF.UiAggregation.RESPONSIVE_TABLE_CELLS).event(oFF.UiEventDef.ON_CLICK).event(oFF.UiEventDef.ON_DOUBLE_CLICK).event(oFF.UiEventDef.ON_PRESS).event(oFF.UiEventDef.ON_DETAIL_PRESS);
	oFF.UiType.RESPONSIVE_TABLE = oFF.UiType.createBasicControl("ResponsiveTable", "The ResponsiveTable control provides a set of sophisticated and convenience functions for responsive table design. For mobile devices, the recommended limit of table rows is 100 (based on 4 columns) to assure proper performance.").addMultiSelection(oFF.UiAggregation.RESPONSIVE_TABLE_ROWS).prop(oFF.UiProperty.SELECTION_MODE).prop(oFF.UiProperty.BUSY).aggregation(oFF.UiAggregation.RESPONSIVE_TABLE_COLUMNS).aggregation(oFF.UiAggregation.RESPONSIVE_TABLE_ROWS).event(oFF.UiEventDef.ON_SELECT).event(oFF.UiEventDef.ON_SELECTION_CHANGE).event(oFF.UiEventDef.ON_DELETE).event(oFF.UiEventDef.ON_SCROLL_LOAD);
};
oFF.UiType.staticSetupTrees = function()
{
	oFF.UiType.TREE_ITEM = oFF.UiType.createItemContainer("TreeItem", "The TreeItem control is used as an item for the Tree control and provides a title, image, etc.", null, null).addCapabilityFlag(oFF.UiType._SUPPORTS_EXPANDED_CHANGE).prop(oFF.UiProperty.TEXT).prop(oFF.UiProperty.NODE).prop(oFF.UiProperty.SELECTED).prop(oFF.UiProperty.EXPANDED).prop(oFF.UiProperty.BUSY).prop(oFF.UiProperty.ICON).prop(oFF.UiProperty.COUNTER).prop(oFF.UiProperty.HIGHLIGHT).prop(oFF.UiProperty.LIST_ITEM_TYPE).event(oFF.UiEventDef.ON_CLICK).event(oFF.UiEventDef.ON_DOUBLE_CLICK).event(oFF.UiEventDef.ON_EXPAND).event(oFF.UiEventDef.ON_COLLAPSE).event(oFF.UiEventDef.ON_DETAIL_PRESS).event(oFF.UiEventDef.ON_CONTEXT_MENU);
	oFF.UiType.TREE_ITEM.setDefaultItemType(oFF.UiType.TREE_ITEM);
	oFF.UiType.TREE = oFF.UiType.createItemContainer("Tree", "The Tree control provides a tree structure for displaying data in a hierarchy.", oFF.UiType.TREE_ITEM, oFF.UiType.TREE_ITEM).addMultiSelection(oFF.UiAggregation.ITEMS).prop(oFF.UiProperty.SELECTION_MODE).prop(oFF.UiProperty.EXPANDED).prop(oFF.UiProperty.TITLE).prop(oFF.UiProperty.BUSY).method(oFF.UiMethod.EXPAND_TO_LEVEL).method(oFF.UiMethod.COLLAPSE_ALL).event(oFF.UiEventDef.ON_SELECT).event(oFF.UiEventDef.ON_SELECTION_CHANGE).event(oFF.UiEventDef.ON_EXPAND).event(oFF.UiEventDef.ON_COLLAPSE).event(oFF.UiEventDef.ON_DELETE);
	oFF.UiType.TREE_TABLE_ROW = oFF.UiType.createBasicControl("TreeTableRow", "The TreeTableRow control is used to define a row of cells in a TreeTable.").setSuperType(oFF.UiType.TABLE_ROW).addCapabilityFlag(oFF.UiType._SUPPORTS_EXPANDED_CHANGE).prop(oFF.UiProperty.EXPANDED).aggregation(oFF.UiAggregation.TREE_TABLE_ROWS).event(oFF.UiEventDef.ON_EXPAND).event(oFF.UiEventDef.ON_COLLAPSE);
	oFF.UiType.TREE_TABLE = oFF.UiType.createBasicControl("TreeTable", "The TreeTable control provides a comprehensive set of features to display hierarchical data.").addCapabilityFlag(oFF.UiType._SUPPORTS_VISIBLE_ROW_COUNT_CHANGE).addCapabilityFlag(oFF.UiType._SUPPORTS_FIRST_VISIBLE_ROW_CHANGE).addMultiSelection(oFF.UiAggregation.TREE_TABLE_ROWS).prop(oFF.UiProperty.SELECTION_MODE).prop(oFF.UiProperty.SELECTION_BEHAVIOR).prop(oFF.UiProperty.EXPANDED).prop(oFF.UiProperty.TITLE).prop(oFF.UiProperty.BUSY).prop(oFF.UiProperty.ENABLE_SELECT_ALL).prop(oFF.UiProperty.FOOTER).prop(oFF.UiProperty.VISIBLE_ROW_COUNT).prop(oFF.UiProperty.VISIBLE_ROW_COUNT_MODE).prop(oFF.UiProperty.MIN_ROW_COUNT).prop(oFF.UiProperty.FIRST_VISIBLE_ROW).aggregation(oFF.UiAggregation.COLUMNS).aggregation(oFF.UiAggregation.TREE_TABLE_ROWS).method(oFF.UiMethod.EXPAND_TO_LEVEL).method(oFF.UiMethod.COLLAPSE_ALL).event(oFF.UiEventDef.ON_SELECT).event(oFF.UiEventDef.ON_SELECTION_CHANGE).event(oFF.UiEventDef.ON_EXPAND).event(oFF.UiEventDef.ON_COLLAPSE).event(oFF.UiEventDef.ON_SCROLL);
};
oFF.UiType.staticSetupFloatingControls = function()
{
	oFF.UiType.DIALOG = oFF.UiType.createContentContainer("Dialog", "A popup that interrupts the current processing and prompts the user for an action or an input in a modal mode.").setIsFloating().prop(oFF.UiProperty.TITLE).prop(oFF.UiProperty.OPEN).prop(oFF.UiProperty.BUSY).aggregation(oFF.UiAggregation.DIALOG_BUTTONS).method(oFF.UiMethod.OPEN).method(oFF.UiMethod.SHAKE).event(oFF.UiEventDef.ON_BEFORE_OPEN).event(oFF.UiEventDef.ON_BEFORE_CLOSE).event(oFF.UiEventDef.ON_AFTER_OPEN).event(oFF.UiEventDef.ON_AFTER_CLOSE).event(oFF.UiEventDef.ON_OPEN).event(oFF.UiEventDef.ON_CLOSE);
	oFF.UiType.ALERT = oFF.UiType.createBasicControl("Alert", "A popup that interrupts the current processing and displays a message to the user.").setIsFloating().prop(oFF.UiProperty.TITLE).prop(oFF.UiProperty.TEXT).prop(oFF.UiProperty.OPEN).method(oFF.UiMethod.OPEN).event(oFF.UiEventDef.ON_CLOSE);
	...
	oFF.UiType.POPOVER = oFF.UiType.createContentContainer("Popover", "Displays additional information for an object in a compact way.").setIsFloating().prop(oFF.UiProperty.TITLE).prop(oFF.UiProperty.OPEN).prop(oFF.UiProperty.BUSY).prop(oFF.UiProperty.PLACEMENT).prop(oFF.UiProperty.MARGIN).method(oFF.UiMethod.OPEN_AT).event(oFF.UiEventDef.ON_BEFORE_OPEN).event(oFF.UiEventDef.ON_BEFORE_CLOSE).event(oFF.UiEventDef.ON_AFTER_OPEN).event(oFF.UiEventDef.ON_AFTER_CLOSE);
	oFF.UiType.MENU = oFF.UiType.createItemContainer("Menu", "The Menu control represents a hierarchical menu. When opened on mobile devices it occupies the whole screen.", oFF.UiType.MENU_ITEM, oFF.UiType.MENU_ITEM).setIsFloating().method(oFF.UiMethod.OPEN_AT).method(oFF.UiMethod.OPEN_AT_POSITION);
	...
	oFF.UiType.TERMINAL = oFF.UiType.createBasicControl("Terminal", "A console-based ui control which emulates a text-based user interface.").setIsFloating().addCapabilityFlag(oFF.UiType._SUPPORTS_MAXIMIZED_CHANGE).addCapabilityFlag(oFF.UiType._SUPPORTS_HIDDEN_CHANGE).addCapabilityFlag(oFF.UiType._SUPPORTS_COMMAND_HISTORY_CHANGE).interf(oFF.UiInterface.WINDOW).prop(oFF.UiProperty.FONT_COLOR).prop(oFF.UiProperty.PATH).prop(oFF.UiProperty.PROMPT).prop(oFF.UiProperty.COMMAND_HISTORY).method(oFF.UiMethod.PRINT).method(oFF.UiMethod.PRINTLN).method(oFF.UiMethod.START_READ_LINE).event(oFF.UiEventDef.ON_EXECUTE).event(oFF.UiEventDef.ON_TERMINATE).event(oFF.UiEventDef.ON_READ_LINE_FINISHED);
};
oFF.UiType.staticSetupIndexedLayout = function()
{
	oFF.UiType.FLEX_LAYOUT = oFF.UiType.createLayout("FlexLayout", "The Flex layout control builds the container for a flexible box layout.").interf(oFF.UiInterface.FLEX_CONTAINER).prop(oFF.UiProperty.BUSY).prop(oFF.UiProperty.OVERFLOW).event(oFF.UiEventDef.ON_FILE_DROP);
...
oFF.UiType.staticSetupContentContainers = function()
{
	...
	oFF.UiType.PANEL = oFF.UiType.createContentContainer("Panel", "A container control which has a header and a expandable content.").addCapabilityFlag(oFF.UiType._SUPPORTS_EXPANDED_CHANGE).prop(oFF.UiProperty.TEXT).prop(oFF.UiProperty.EXPANDABLE).prop(oFF.UiProperty.EXPANDED).prop(oFF.UiProperty.BUSY).prop(oFF.UiProperty.HEADER).event(oFF.UiEventDef.ON_EXPAND).event(oFF.UiEventDef.ON_COLLAPSE);
	...
	oFF.UiType.TILE = oFF.UiType.createContentContainer("Tile", "Displays header, subheader, and a customizable main area in a tile format.").prop(oFF.UiProperty.TITLE).prop(oFF.UiProperty.SUBTITLE).prop(oFF.UiProperty.LOAD_STATE).prop(oFF.UiProperty.FRAME_TYPE).prop(oFF.UiProperty.TILE_MODE).prop(oFF.UiProperty.BUSY).event(oFF.UiEventDef.ON_PRESS);
};
oFF.UiType.staticSetupItemContainers = function()
{
	oFF.UiType.TAB_STRIP_ITEM = oFF.UiType.createContentContainer("TabStripItem", "An item to be used in a TabContainer.").prop(oFF.UiProperty.TEXT).prop(oFF.UiProperty.ICON);
	oFF.UiType.TAB_STRIP = oFF.UiType.createItemContainer("TabStrip", "A container control for managing multiple tabs, allowing the user to open and edit different items simultaneously.", oFF.UiType.TAB_STRIP_ITEM, oFF.UiType.TAB_STRIP_ITEM).addSingleSelection(oFF.UiAggregation.ITEMS).prop(oFF.UiProperty.BUSY).event(oFF.UiEventDef.ON_SELECT);
	oFF.UiType.NAVIGATION_CONTAINER = oFF.UiType.createBasicControl("NavigationContainer", "Handles hierarchical navigation between views or other controls.").addCapabilityFlag(oFF.UiType._SUPPORTS_NAVIGATION_PAGES_CHANGE).prop(oFF.UiProperty.BUSY).aggregation(oFF.UiAggregation.PAGES).method(oFF.UiMethod.POP_TO_PAGE).event(oFF.UiEventDef.ON_BACK);
...
oFF.UiType.staticSetupDataViz = function()
{
	...
	oFF.UiType.SAC_TABLE_GRID = oFF.UiType.createBasicControl("SacTableGrid", "A SacGrid grid control to render analytical grids.").addReceiverBinding(oFF.SemanticBindingType.TABLE, oFF.ProtocolBindingType.SAC_TABLE_GRID).prop(oFF.UiProperty.TEXT).prop(oFF.UiProperty.MODEL_JSON).prop(oFF.UiProperty.DATA_MANIFEST).prop(oFF.UiProperty.BUSY).event(oFF.UiEventDef.ON_CLICK).event(oFF.UiEventDef.ON_CONTEXT_MENU).event(oFF.UiEventDef.ON_SELECTION_CHANGE).event(oFF.UiEventDef.ON_BUTTON_PRESS);
...
{
	oFF.UiType.FANCY_BUTTON = oFF.UiType.createCompositeControl("FancyButton", "A fancy button composite control.").prop(oFF.UiProperty.TEXT).event(oFF.UiEventDef.ON_PRESS);
...
oFF.UiType.staticSetupTypeFallbacks = function()
{
	...
	oFF.UiType.PAGE.setFallbackType(oFF.UiType.TAB_STRIP_ITEM);
	oFF.UiType.NAVIGATION_CONTAINER.setFallbackType(oFF.UiType.TAB_STRIP);
};
...
oFF.UiType.createBase = function(name, description, parentType)
{
...
oFF.UiType.prototype.isItemContainerWithDefaultItem = function()
{
	return this.hasAggregation(oFF.UiAggregation.ITEMS) && this.getDefaultItemType() !== null;
};
oFF.UiType.prototype.isLayout = function()
{
	return this.hasAggregation(oFF.UiAggregation.ITEMS) && this.getDefaultItemType() === null;
};
...
oFF.UiContextDummy.prototype.getHeightUnit = function()
{
	return null;
};
oFF.UiContextDummy.prototype.setHeightUnit = function(unit)
{
	return this;
};
oFF.UiContextDummy.prototype.getHeightValue = function()
{
	return 0;
};
...
oFF.UiContextDummy.prototype.setHeightCss = function(height)
{
	return this;
};
oFF.UiContextDummy.prototype.getHeightCss = function()
{
	return null;
};
oFF.UiContextDummy.prototype.setHeightValue = function(value)
{
	return this;
};
oFF.UiContextDummy.prototype.setHeightExt = function(height, unit)
{
	return this;
};
oFF.UiContextDummy.prototype.getPaddingUnit = function()
{
	return null;
};
oFF.UiContextDummy.prototype.setPaddingUnit = function(unit)
{
	return this;
};
oFF.UiContextDummy.prototype.getPaddingValue = function()
{
	return 0;
};
oFF.UiContextDummy.prototype.setPaddingValue = function(padding)
{
	return this;
};
oFF.UiContextDummy.prototype.setPaddingExt = function(padding, unit)
{
	return this;
};
oFF.UiContextDummy.prototype.getPaddingCss = function()
{
	return null;
};
oFF.UiContextDummy.prototype.getMarginValue = function()
{
	return 0;
};
oFF.UiContextDummy.prototype.getMarginUnit = function()
{
	return null;
};
oFF.UiContextDummy.prototype.getMarginCss = function()
{
	return null;
};
...
oFF.UiContextDummy.prototype.setMarginValue = function(margin)
{
	return this;
};
oFF.UiContextDummy.prototype.setMarginUnit = function(unit)
{
	return this;
};
oFF.UiContextDummy.prototype.setMarginCss = function(margin)
{
	return this;
};
oFF.UiContextDummy.prototype.setMarginExt = function(margin, unit)
{
	return this;
};
...
oFF.UiContextDummy.prototype.getCornerRadiusValue = function()
{
	return 0;
};
...
oFF.UiContextDummy.prototype.setCornerRadiusValue = function(cornerRadius)
{
	return this;
};
oFF.UiContextDummy.prototype.getCornerRadiusUnit = function()
{
	return null;
};
oFF.UiContextDummy.prototype.getCornerRadiusCss = function()
{
	return null;
};
oFF.UiContextDummy.prototype.setCornerRadiusUnit = function(unit)
{
	return this;
};
oFF.UiContextDummy.prototype.setCornerRadiusCss = function(cornerRadius)
{
	return this;
};
oFF.UiContextDummy.prototype.setCornerRadiusExt = function(cornerRadius, unit)
{
	return this;
};
...
oFF.UiContextDummy.prototype.getBorderSizeValue = function()
{
	return 0;
};
oFF.UiContextDummy.prototype.setBorderSizeValue = function(borderSize)
{
	return this;
};
oFF.UiContextDummy.prototype.getBorderSizeUnit = function()
{
	return null;
};
oFF.UiContextDummy.prototype.getBorderSizeCss = function()
{
	return null;
};
oFF.UiContextDummy.prototype.setBorderSizeUnit = function(unit)
{
	return this;
};
oFF.UiContextDummy.prototype.setBorderSizeCss = function(borderSize)
{
	return this;
};
oFF.UiContextDummy.prototype.setBorderSizeExt = function(borderSize, unit)
{
	return this;
};
...
oFF.UiContextDummy.prototype.getMinWidthUnit = function()
{
	return null;
};
oFF.UiContextDummy.prototype.getMinWidthCss = function()
{
	return null;
};
oFF.UiContextDummy.prototype.getMinWidthObj = function()
{
	return null;
};
...
oFF.UiContextDummy.prototype.setMinWidthUnit = function(unit)
{
	return this;
};
oFF.UiContextDummy.prototype.setMinWidthExt = function(minWidth, unit)
{
	return this;
};
oFF.UiContextDummy.prototype.setMinWidthCss = function(minWidth)
{
	return this;
};
oFF.UiContextDummy.prototype.setMinWidthObj = function(minWidth)
{
	return this;
};
...
oFF.UiContextDummy.prototype.getMinHeightUnit = function()
{
	return null;
};
oFF.UiContextDummy.prototype.getMinHeightCss = function()
{
	return null;
};
oFF.UiContextDummy.prototype.getMinHeightObj = function()
{
	return null;
};
...
oFF.UiContextDummy.prototype.setMinHeightUnit = function(unit)
{
	return this;
};
oFF.UiContextDummy.prototype.setMinHeightExt = function(minHeight, unit)
{
	return this;
};
oFF.UiContextDummy.prototype.setMinHeightCss = function(minHeight)
{
	return this;
};
oFF.UiContextDummy.prototype.setMinHeightObj = function(minHeight)
{
	return this;
};
oFF.UiContextDummy.prototype.getXValue = function()
{
	return 0;
};
...
oFF.UiContextDummy.prototype.getYValue = function()
{
	return 0;
};
...
oFF.UiContextDummy.prototype.setXValue = function(value)
{
	return this;
};
...
oFF.UiContextDummy.prototype.setYValue = function(value)
{
	return this;
};
...
oFF.UiContextDummy.prototype.getXUnit = function()
{
	return null;
};
oFF.UiContextDummy.prototype.getXCss = function()
{
	return null;
};
oFF.UiContextDummy.prototype.setXUnit = function(unit)
{
	return this;
};
oFF.UiContextDummy.prototype.setXCss = function(xCss)
{
	return this;
};
oFF.UiContextDummy.prototype.setXExt = function(x, unit)
{
	return this;
};
oFF.UiContextDummy.prototype.getYUnit = function()
{
	return null;
};
oFF.UiContextDummy.prototype.getYCss = function()
{
	return null;
};
oFF.UiContextDummy.prototype.setYUnit = function(unit)
{
	return this;
};
oFF.UiContextDummy.prototype.setYCss = function(yCss)
{
	return this;
};
oFF.UiContextDummy.prototype.setYExt = function(y, unit)
{
	return this;
};
...
oFF.UiContextDummy.prototype.setPositionValue = function(xValue, yValue)
{
	return this;
};
oFF.UiContextDummy.prototype.setPositionCss = function(xCss, yCss)
{
	return this;
};
oFF.UiContextDummy.prototype.getHeaderHeightValue = function()
{
	return 0;
};
oFF.UiContextDummy.prototype.setHeaderHeightValue = function(headerHeight)
{
	return this;
};
oFF.UiContextDummy.prototype.getHeaderHeightUnit = function()
{
	return null;
};
oFF.UiContextDummy.prototype.setHeaderHeightUnit = function(unit)
{
	return this;
};
oFF.UiContextDummy.prototype.setHeaderHeightExt = function(headerHeight, unit)
{
	return this;
};
oFF.UiContextDummy.prototype.getHeaderHeightCss = function()
{
	return null;
};
oFF.UiContextDummy.prototype.setHeaderHeightCss = function(headerHeight)
{
	return this;
};
...
oFF.UiContextDummy.prototype.getFooterHeightValue = function()
{
	return 0;
};
oFF.UiContextDummy.prototype.setFooterHeightValue = function(footerHeight)
{
	return this;
};
oFF.UiContextDummy.prototype.getFooterHeightUnit = function()
{
	return null;
};
oFF.UiContextDummy.prototype.setFooterHeightUnit = function(unit)
{
	return this;
};
oFF.UiContextDummy.prototype.setFooterHeightExt = function(footerHeight, unit)
{
	return this;
};
oFF.UiContextDummy.prototype.getFooterHeightCss = function()
{
	return null;
};
oFF.UiContextDummy.prototype.setFooterHeightCss = function(footerHeight)
{
	return this;
};
...
oFF.UiContextDummy.prototype.getMatrixModel = function()
{
	return null;
};
oFF.UiContextDummy.prototype.setMatrixModel = function(matrix)
{
	return this;
};
oFF.UiContextDummy.prototype.getTableModel = function()
{
	return null;
};
oFF.UiContextDummy.prototype.setTableModel = function(model)
{
	return this;
};
oFF.UiContextDummy.prototype.getModelElement = function()
{
	return this;
};
oFF.UiContextDummy.prototype.setModelElement = function(modelElement)
{
	return this;
};
...
oFF.UiContextDummy.prototype.getFontSizeValue = function()
{
	return 0;
};
oFF.UiContextDummy.prototype.setFontSizeValue = function(fontSize)
{
	return this;
};
oFF.UiContextDummy.prototype.getFontSizeUnit = function()
{
	return null;
};
oFF.UiContextDummy.prototype.setFontSizeUnit = function(unit)
{
	return this;
};
oFF.UiContextDummy.prototype.setFontSizeExt = function(fontSize, unit)
{
	return this;
};
...
oFF.UiContextDummy.prototype.setSizeValue = function(widthValue, heightValue)
{
	return this;
};
oFF.UiContextDummy.prototype.setSizeCss = function(widthCss, heightCss)
{
	return this;
};
...
oFF.UiContextDummy.prototype.unlinkFromParentAggregation = function() {};
oFF.UiContextDummy.prototype.linkToParentAggregation = function(parent, parentAggregation) {};
...
oFF.UiContextDummy.prototype.getWidthUnit = function()
{
	return null;
};
oFF.UiContextDummy.prototype.setWidthUnit = function(unit)
{
	return this;
};
oFF.UiContextDummy.prototype.getWidthValue = function()
{
	return 0;
};
oFF.UiContextDummy.prototype.setWidthValue = function(value)
{
	return this;
};
oFF.UiContextDummy.prototype.setWidthExt = function(width, unit)
{
	return this;
};
oFF.UiContextDummy.prototype.setWidthCss = function(width)
{
	return this;
};
oFF.UiContextDummy.prototype.getWidthCss = function()
{
	return null;
};
...
oFF.UiContextDummy.prototype.setPaddingCss = function(padding)
{
	return this;
};
...
oFF.UiContextDummy.prototype.getFontSizeCss = function()
{
	return null;
};
oFF.UiContextDummy.prototype.setFontSizeCss = function(fontSize)
{
	return this;
};
...
oFF.UiContextDummy.prototype.getBorderSize = function()
{
	return null;
};
oFF.UiContextDummy.prototype.setBorderSize = function(borderSize)
{
	return this;
};
...
oFF.UiContextSpace.prototype.setMatrixModel = function(matrix)
{
	for (var i = 0; i < this.m_elements.size(); i++)
	{
		this.m_elements.get(i).setMatrixModel(matrix);
	}
	return this;
};
oFF.UiContextSpace.prototype.getMatrixModel = function()
{
	if (this.m_elements.size() > 0)
	{
		return this.m_elements.get(0).getMatrixModel();
	}
	return null;
};
oFF.UiContextSpace.prototype.setTableModel = function(model)
{
	for (var i = 0; i < this.m_elements.size(); i++)
	{
		this.m_elements.get(i).setTableModel(model);
	}
	return this;
};
oFF.UiContextSpace.prototype.getTableModel = function()
{
	if (this.m_elements.size() > 0)
	{
		return this.m_elements.get(0).getTableModel();
	}
	return null;
};
oFF.UiContextSpace.prototype.setModelElement = function(modelElement)
{
	for (var i = 0; i < this.m_elements.size(); i++)
	{
		this.m_elements.get(i).setModelElement(modelElement);
	}
	return this;
};
oFF.UiContextSpace.prototype.getModelElement = function()
{
	if (this.m_elements.size() > 0)
	{
		return this.m_elements.get(0).getModelElement();
	}
	return null;
};
...
oFF.UiContextSpace.prototype.setWidthValue = function(value)
{
	for (var i = 0; i < this.m_elements.size(); i++)
	{
		this.m_elements.get(i).setWidthValue(value);
	}
	return this;
};
oFF.UiContextSpace.prototype.getWidthValue = function()
{
	if (this.m_elements.size() > 0)
	{
		return this.m_elements.get(0).getWidthValue();
	}
	return 0;
};
...
oFF.UiContextSpace.prototype.setHeightValue = function(value)
{
	for (var i = 0; i < this.m_elements.size(); i++)
	{
		this.m_elements.get(i).setHeightValue(value);
	}
	return this;
};
oFF.UiContextSpace.prototype.getHeightValue = function()
{
	if (this.m_elements.size() > 0)
	{
		return this.m_elements.get(0).getHeightValue();
	}
	return 0;
};
...
oFF.UiContextSpace.prototype.setWidthCss = function(width)
{
	for (var i = 0; i < this.m_elements.size(); i++)
	{
		this.m_elements.get(i).setWidthCss(width);
	}
	return this;
};
oFF.UiContextSpace.prototype.getWidthCss = function()
{
	if (this.m_elements.size() > 0)
	{
		return this.m_elements.get(0).getWidthCss();
	}
	return null;
};
oFF.UiContextSpace.prototype.setHeightCss = function(height)
{
	for (var i = 0; i < this.m_elements.size(); i++)
	{
		this.m_elements.get(i).setHeightCss(height);
	}
	return this;
};
oFF.UiContextSpace.prototype.getHeightCss = function()
{
	if (this.m_elements.size() > 0)
	{
		return this.m_elements.get(0).getHeightCss();
	}
	return null;
};
...
oFF.UiContextSpace.prototype.getMinWidthUnit = function()
{
	if (this.m_elements.size() > 0)
	{
		return this.m_elements.get(0).getMinWidthUnit();
	}
	return null;
};
oFF.UiContextSpace.prototype.getMinWidthCss = function()
{
	if (this.m_elements.size() > 0)
	{
		return this.m_elements.get(0).getMinWidthCss();
	}
	return null;
};
oFF.UiContextSpace.prototype.getMinWidthObj = function()
{
	if (this.m_elements.size() > 0)
	{
		return this.m_elements.get(0).getMinWidthObj();
	}
	return null;
};
...
oFF.UiContextSpace.prototype.setMinWidthUnit = function(unit)
{
	for (var i = 0; i < this.m_elements.size(); i++)
	{
		this.m_elements.get(i).setMinWidthUnit(unit);
	}
	return this;
};
oFF.UiContextSpace.prototype.setMinWidthExt = function(minWidth, unit)
{
	for (var i = 0; i < this.m_elements.size(); i++)
	{
		this.m_elements.get(i).setMinWidthExt(minWidth, unit);
	}
	return this;
};
oFF.UiContextSpace.prototype.setMinWidthCss = function(minWidth)
{
	for (var i = 0; i < this.m_elements.size(); i++)
	{
		this.m_elements.get(i).setMinWidthCss(minWidth);
	}
	return this;
};
oFF.UiContextSpace.prototype.setMinWidthObj = function(minWidth)
{
	for (var i = 0; i < this.m_elements.size(); i++)
	{
		this.m_elements.get(i).setMinWidthObj(minWidth);
	}
	return this;
};
...
oFF.UiContextSpace.prototype.getMinHeightUnit = function()
{
	if (this.m_elements.size() > 0)
	{
		return this.m_elements.get(0).getMinHeightUnit();
	}
	return null;
};
oFF.UiContextSpace.prototype.getMinHeightCss = function()
{
	if (this.m_elements.size() > 0)
	{
		return this.m_elements.get(0).getMinHeightCss();
	}
	return null;
};
oFF.UiContextSpace.prototype.getMinHeightObj = function()
{
	if (this.m_elements.size() > 0)
	{
		return this.m_elements.get(0).getMinHeightObj();
	}
	return null;
};
...
oFF.UiContextSpace.prototype.setMinHeightUnit = function(unit)
{
	for (var i = 0; i < this.m_elements.size(); i++)
	{
		this.m_elements.get(i).setMinHeightUnit(unit);
	}
	return this;
};
oFF.UiContextSpace.prototype.setMinHeightExt = function(minHeight, unit)
{
	for (var i = 0; i < this.m_elements.size(); i++)
	{
		this.m_elements.get(i).setMinHeightExt(minHeight, unit);
	}
	return this;
};
oFF.UiContextSpace.prototype.setMinHeightCss = function(minHeight)
{
	for (var i = 0; i < this.m_elements.size(); i++)
	{
		this.m_elements.get(i).setMinHeightCss(minHeight);
	}
	return this;
};
oFF.UiContextSpace.prototype.setMinHeightObj = function(minHeight)
{
	for (var i = 0; i < this.m_elements.size(); i++)
	{
		this.m_elements.get(i).setMinHeightObj(minHeight);
	}
	return this;
};
oFF.UiContextSpace.prototype.setWidthUnit = function(unit)
{
	for (var i = 0; i < this.m_elements.size(); i++)
	{
		this.m_elements.get(i).setWidthUnit(unit);
	}
	return this;
};
oFF.UiContextSpace.prototype.setWidthExt = function(width, unit)
{
	for (var i = 0; i < this.m_elements.size(); i++)
	{
		this.m_elements.get(i).setWidthExt(width, unit);
	}
	return this;
};
oFF.UiContextSpace.prototype.getWidthUnit = function()
{
	if (this.m_elements.size() > 0)
	{
		return this.m_elements.get(0).getWidthUnit();
	}
	return null;
};
oFF.UiContextSpace.prototype.setHeightUnit = function(unit)
{
	for (var i = 0; i < this.m_elements.size(); i++)
	{
		this.m_elements.get(i).setHeightUnit(unit);
	}
	return this;
};
oFF.UiContextSpace.prototype.setHeightExt = function(height, unit)
{
	for (var i = 0; i < this.m_elements.size(); i++)
	{
		this.m_elements.get(i).setHeightExt(height, unit);
	}
	return this;
};
oFF.UiContextSpace.prototype.getHeightUnit = function()
{
	if (this.m_elements.size() > 0)
	{
		return this.m_elements.get(0).getHeightUnit();
	}
	return null;
};
oFF.UiContextSpace.prototype.setXValue = function(value)
{
	for (var i = 0; i < this.m_elements.size(); i++)
	{
		this.m_elements.get(i).setXValue(value);
	}
	return this;
};
...
oFF.UiContextSpace.prototype.getXValue = function()
{
	if (this.m_elements.size() > 0)
	{
		return this.m_elements.get(0).getXValue();
	}
	return 0;
};
...
oFF.UiContextSpace.prototype.setYValue = function(value)
{
	for (var i = 0; i < this.m_elements.size(); i++)
	{
		this.m_elements.get(i).setYValue(value);
	}
	return this;
};
oFF.UiContextSpace.prototype.getYValue = function()
{
	if (this.m_elements.size() > 0)
	{
		return this.m_elements.get(0).getYValue();
	}
	return 0;
};
...
oFF.UiContextSpace.prototype.getXUnit = function()
{
	if (this.m_elements.size() > 0)
	{
		return this.m_elements.get(0).getXUnit();
	}
	return null;
};
oFF.UiContextSpace.prototype.getXCss = function()
{
	if (this.m_elements.size() > 0)
	{
		return this.m_elements.get(0).getXCss();
	}
	return null;
};
oFF.UiContextSpace.prototype.setXUnit = function(unit)
{
	for (var i = 0; i < this.m_elements.size(); i++)
	{
		this.m_elements.get(i).setXUnit(unit);
	}
	return this;
};
oFF.UiContextSpace.prototype.setXCss = function(xCss)
{
	for (var i = 0; i < this.m_elements.size(); i++)
	{
		this.m_elements.get(i).setXCss(xCss);
	}
	return this;
};
oFF.UiContextSpace.prototype.setXExt = function(x, unit)
{
	for (var i = 0; i < this.m_elements.size(); i++)
	{
		this.m_elements.get(i).setXExt(x, unit);
	}
	return this;
};
oFF.UiContextSpace.prototype.getYUnit = function()
{
	if (this.m_elements.size() > 0)
	{
		return this.m_elements.get(0).getYUnit();
	}
	return null;
};
oFF.UiContextSpace.prototype.getYCss = function()
{
	if (this.m_elements.size() > 0)
	{
		return this.m_elements.get(0).getYCss();
	}
	return null;
};
oFF.UiContextSpace.prototype.setYUnit = function(unit)
{
	for (var i = 0; i < this.m_elements.size(); i++)
	{
		this.m_elements.get(i).setYUnit(unit);
	}
	return this;
};
oFF.UiContextSpace.prototype.setYCss = function(yCss)
{
	for (var i = 0; i < this.m_elements.size(); i++)
	{
		this.m_elements.get(i).setYCss(yCss);
	}
	return this;
};
oFF.UiContextSpace.prototype.setYExt = function(y, unit)
{
	for (var i = 0; i < this.m_elements.size(); i++)
	{
		this.m_elements.get(i).setYExt(y, unit);
	}
	return this;
};
oFF.UiContextSpace.prototype.setPositionValue = function(xValue, yValue)
{
	for (var i = 0; i < this.m_elements.size(); i++)
	{
		this.m_elements.get(i).setPositionValue(xValue, yValue);
	}
	return this;
};
oFF.UiContextSpace.prototype.setPositionCss = function(xCss, yCss)
{
	for (var i = 0; i < this.m_elements.size(); i++)
	{
		this.m_elements.get(i).setPositionCss(xCss, yCss);
	}
	return this;
};
...
oFF.UiContextSpace.prototype.getPosition = function()
{
	...
	return oFF.UiPositionValue.createEmpty();
};
oFF.UiContextSpace.prototype.setSizeValue = function(widthValue, heightValue)
{
	for (var i = 0; i < this.m_elements.size(); i++)
	{
		this.m_elements.get(i).setSizeValue(widthValue, heightValue);
	}
	return this;
};
oFF.UiContextSpace.prototype.setSizeCss = function(widthCss, heightCss)
{
	for (var i = 0; i < this.m_elements.size(); i++)
	{
		this.m_elements.get(i).setSizeCss(widthCss, heightCss);
	}
	return this;
};
...
oFF.UiContextSpace.prototype.getSize = function()
{
	...
	return oFF.UiSizeValue.createEmpty();
};
...
oFF.UiContextSpace.prototype.setPaddingUnit = function(unit)
{
	for (var i = 0; i < this.m_elements.size(); i++)
	{
		this.m_elements.get(i).setPaddingUnit(unit);
	}
	return this;
};
...
oFF.UiContextSpace.prototype.setPaddingCss = function(padding)
{
	for (var i = 0; i < this.m_elements.size(); i++)
	{
		this.m_elements.get(i).setPaddingCss(padding);
	}
	return this;
};
...
oFF.UiContextSpace.prototype.getPaddingUnit = function()
{
	if (this.m_elements.size() > 0)
	{
		return this.m_elements.get(0).getPaddingUnit();
	}
	return null;
};
oFF.UiContextSpace.prototype.setPaddingValue = function(padding)
{
	for (var i = 0; i < this.m_elements.size(); i++)
	{
		this.m_elements.get(i).setPaddingValue(padding);
	}
	return this;
};
oFF.UiContextSpace.prototype.getPaddingValue = function()
{
	if (this.m_elements.size() > 0)
	{
		return this.m_elements.get(0).getPaddingValue();
	}
	return 0;
};
oFF.UiContextSpace.prototype.setPaddingExt = function(padding, unit)
{
	for (var i = 0; i < this.m_elements.size(); i++)
	{
		this.m_elements.get(i).setPaddingExt(padding, unit);
	}
	return this;
};
oFF.UiContextSpace.prototype.getPaddingCss = function()
{
	if (this.m_elements.size() > 0)
	{
		return this.m_elements.get(0).getPaddingCss();
	}
	return null;
};
oFF.UiContextSpace.prototype.getMarginValue = function()
{
	if (this.m_elements.size() > 0)
	{
		return this.m_elements.get(0).getMarginValue();
	}
	return 0;
};
oFF.UiContextSpace.prototype.getMarginUnit = function()
{
	if (this.m_elements.size() > 0)
	{
		return this.m_elements.get(0).getMarginUnit();
	}
	return null;
};
oFF.UiContextSpace.prototype.getMarginCss = function()
{
	if (this.m_elements.size() > 0)
	{
		return this.m_elements.get(0).getMarginCss();
	}
	return null;
};
...
oFF.UiContextSpace.prototype.setMarginValue = function(margin)
{
	for (var i = 0; i < this.m_elements.size(); i++)
	{
		this.m_elements.get(i).setMarginValue(margin);
	}
	return this;
};
oFF.UiContextSpace.prototype.setMarginUnit = function(unit)
{
	for (var i = 0; i < this.m_elements.size(); i++)
	{
		this.m_elements.get(i).setMarginUnit(unit);
	}
	return this;
};
oFF.UiContextSpace.prototype.setMarginCss = function(margin)
{
	for (var i = 0; i < this.m_elements.size(); i++)
	{
		this.m_elements.get(i).setMarginCss(margin);
	}
	return this;
};
oFF.UiContextSpace.prototype.setMarginExt = function(margin, unit)
{
	for (var i = 0; i < this.m_elements.size(); i++)
	{
		this.m_elements.get(i).setMarginExt(margin, unit);
	}
	return this;
};
...
oFF.UiContextSpace.prototype.unlinkFromParentAggregation = oFF.noSupport;
oFF.UiContextSpace.prototype.linkToParentAggregation = oFF.noSupport;
...
oFF.UiContextSpace.prototype.getFontSizeValue = function()
{
	if (this.m_elements.size() > 0)
	{
		return this.m_elements.get(0).getFontSizeValue();
	}
	return 0;
};
oFF.UiContextSpace.prototype.getFontSizeCss = function()
{
	if (this.m_elements.size() > 0)
	{
		return this.m_elements.get(0).getFontSizeCss();
	}
	return null;
};
...
oFF.UiContextSpace.prototype.setFontSizeCss = function(fontSize)
{
	for (var i = 0; i < this.m_elements.size(); i++)
	{
		this.m_elements.get(i).setFontSizeCss(fontSize);
	}
	return this;
};
oFF.UiContextSpace.prototype.setFontSizeExt = function(fontSize, unit)
{
	for (var i = 0; i < this.m_elements.size(); i++)
	{
		this.m_elements.get(i).setFontSizeExt(fontSize, unit);
	}
	return this;
};
...
oFF.UiContextSpace.prototype.setFontSizeValue = function(fontSize)
{
	for (var i = 0; i < this.m_elements.size(); i++)
	{
		this.m_elements.get(i).setFontSizeValue(fontSize);
	}
	return this;
};
oFF.UiContextSpace.prototype.getFontSizeUnit = function()
{
	if (this.m_elements.size() > 0)
	{
		return this.m_elements.get(0).getFontSizeUnit();
	}
	return null;
};
oFF.UiContextSpace.prototype.setFontSizeUnit = function(unit)
{
	for (var i = 0; i < this.m_elements.size(); i++)
	{
		this.m_elements.get(i).setFontSizeUnit(unit);
	}
	return this;
};
...
oFF.UiContextSpace.prototype.getCornerRadiusValue = function()
{
	if (this.m_elements.size() > 0)
	{
		return this.m_elements.get(0).getCornerRadiusValue();
	}
	return 0;
};
...
oFF.UiContextSpace.prototype.setCornerRadiusValue = function(cornerRadius)
{
	for (var i = 0; i < this.m_elements.size(); i++)
	{
		this.m_elements.get(i).setCornerRadiusValue(cornerRadius);
	}
	return this;
};
oFF.UiContextSpace.prototype.setCornerRadiusExt = function(cornerRadius, unit)
{
	for (var i = 0; i < this.m_elements.size(); i++)
	{
		this.m_elements.get(i).setCornerRadiusExt(cornerRadius, unit);
	}
	return this;
};
oFF.UiContextSpace.prototype.getCornerRadiusUnit = function()
{
	if (this.m_elements.size() > 0)
	{
		return this.m_elements.get(0).getCornerRadiusUnit();
	}
	return null;
};
oFF.UiContextSpace.prototype.setCornerRadiusUnit = function(unit)
{
	for (var i = 0; i < this.m_elements.size(); i++)
	{
		this.m_elements.get(i).setCornerRadiusUnit(unit);
	}
	return this;
};
...
oFF.UiContextSpace.prototype.getCornerRadiusCss = function()
{
	if (this.m_elements.size() > 0)
	{
		return this.m_elements.get(0).getCornerRadiusCss();
	}
	return null;
};
oFF.UiContextSpace.prototype.setCornerRadiusCss = function(cornerRadius)
{
	for (var i = 0; i < this.m_elements.size(); i++)
	{
		this.m_elements.get(i).setCornerRadiusCss(cornerRadius);
	}
	return this;
};
...
oFF.UiContextSpace.prototype.getBorderSizeValue = function()
{
	if (this.m_elements.size() > 0)
	{
		return this.m_elements.get(0).getBorderSizeValue();
	}
	return 0;
};
oFF.UiContextSpace.prototype.setBorderSizeValue = function(borderSize)
{
	for (var i = 0; i < this.m_elements.size(); i++)
	{
		this.m_elements.get(i).setBorderSizeValue(borderSize);
	}
	return this;
};
oFF.UiContextSpace.prototype.getBorderSizeUnit = function()
{
	if (this.m_elements.size() > 0)
	{
		return this.m_elements.get(0).getBorderSizeUnit();
	}
	return null;
};
oFF.UiContextSpace.prototype.setBorderSizeUnit = function(unit)
{
	for (var i = 0; i < this.m_elements.size(); i++)
	{
		this.m_elements.get(i).setBorderSizeUnit(unit);
	}
	return this;
};
oFF.UiContextSpace.prototype.getBorderSizeCss = function()
{
	if (this.m_elements.size() > 0)
	{
		return this.m_elements.get(0).getBorderSizeCss();
	}
	return null;
};
oFF.UiContextSpace.prototype.setBorderSizeCss = function(borderSize)
{
	for (var i = 0; i < this.m_elements.size(); i++)
	{
		this.m_elements.get(i).setBorderSizeCss(borderSize);
	}
	return this;
};
oFF.UiContextSpace.prototype.setBorderSizeExt = function(borderSize, unit)
{
	for (var i = 0; i < this.m_elements.size(); i++)
	{
		this.m_elements.get(i).setBorderSizeExt(borderSize, unit);
	}
	return this;
};
oFF.UiContextSpace.prototype.setBorderSize = function(borderSize)
{
	for (var i = 0; i < this.m_elements.size(); i++)
	{
		this.m_elements.get(i).setBorderSize(borderSize);
	}
	return this;
};
oFF.UiContextSpace.prototype.getBorderSize = function()
{
	if (this.m_elements.size() > 0)
	{
		return this.m_elements.get(0).getBorderSize();
	}
	return null;
};
...
oFF.UiContextSpace.prototype.getHeaderHeightValue = function()
{
	if (this.m_elements.size() > 0)
	{
		return this.m_elements.get(0).getHeaderHeightValue();
	}
	return 0;
};
oFF.UiContextSpace.prototype.setHeaderHeightValue = function(headerHeight)
{
	for (var i = 0; i < this.m_elements.size(); i++)
	{
		this.m_elements.get(i).setHeaderHeightValue(headerHeight);
	}
	return this;
};
oFF.UiContextSpace.prototype.getHeaderHeightUnit = function()
{
	if (this.m_elements.size() > 0)
	{
		return this.m_elements.get(0).getHeaderHeightUnit();
	}
	return null;
};
oFF.UiContextSpace.prototype.setHeaderHeightUnit = function(unit)
{
	for (var i = 0; i < this.m_elements.size(); i++)
	{
		this.m_elements.get(i).setHeaderHeightUnit(unit);
	}
	return this;
};
oFF.UiContextSpace.prototype.setHeaderHeightExt = function(headerHeight, unit)
{
	for (var i = 0; i < this.m_elements.size(); i++)
	{
		this.m_elements.get(i).setHeaderHeightExt(headerHeight, unit);
	}
	return this;
};
oFF.UiContextSpace.prototype.getHeaderHeightCss = function()
{
	if (this.m_elements.size() > 0)
	{
		return this.m_elements.get(0).getHeaderHeightCss();
	}
	return null;
};
oFF.UiContextSpace.prototype.setHeaderHeightCss = function(headerHeight)
{
	for (var i = 0; i < this.m_elements.size(); i++)
	{
		this.m_elements.get(i).setHeaderHeightCss(headerHeight);
	}
	return this;
};
...
oFF.UiContextSpace.prototype.getFooterHeightValue = function()
{
	if (this.m_elements.size() > 0)
	{
		return this.m_elements.get(0).getFooterHeightValue();
	}
	return 0;
};
oFF.UiContextSpace.prototype.setFooterHeightValue = function(footerHeight)
{
	for (var i = 0; i < this.m_elements.size(); i++)
	{
		this.m_elements.get(i).setFooterHeightValue(footerHeight);
	}
	return this;
};
oFF.UiContextSpace.prototype.getFooterHeightUnit = function()
{
	if (this.m_elements.size() > 0)
	{
		return this.m_elements.get(0).getFooterHeightUnit();
	}
	return null;
};
oFF.UiContextSpace.prototype.setFooterHeightUnit = function(unit)
{
	for (var i = 0; i < this.m_elements.size(); i++)
	{
		this.m_elements.get(i).setFooterHeightUnit(unit);
	}
	return this;
};
oFF.UiContextSpace.prototype.setFooterHeightExt = function(footerHeight, unit)
{
	for (var i = 0; i < this.m_elements.size(); i++)
	{
		this.m_elements.get(i).setFooterHeightExt(footerHeight, unit);
	}
	return this;
};
oFF.UiContextSpace.prototype.getFooterHeightCss = function()
{
	if (this.m_elements.size() > 0)
	{
		return this.m_elements.get(0).getFooterHeightCss();
	}
	return null;
};
oFF.UiContextSpace.prototype.setFooterHeightCss = function(footerHeight)
{
	for (var i = 0; i < this.m_elements.size(); i++)
	{
		this.m_elements.get(i).setFooterHeightCss(footerHeight);
	}
	return this;
};
...
{
	return this.m_uiManager.newControlExt(null, this.getUiStyleClass(), null, null, this, oFF.UiOperation.ADD, oFF.UiPosition.CONTENT, -1, -1);
};
oFF.DfUiContext.prototype.addNewItemAt = function(firstIndex, secondIndex)
{
	return this.m_uiManager.newControlExt(null, this.getUiStyleClass(), null, null, this, oFF.UiOperation.SET, oFF.UiPosition.COLUMN_ROW, firstIndex, secondIndex);
};
oFF.DfUiContext.prototype.addNew = function(uiType)
{
	return this.m_uiManager.newControlExt(uiType, null, null, null, this, oFF.UiOperation.ADD, oFF.UiPosition.CONTENT, -1, -1);
};
...
{
	return this.m_uiManager.newControlExt(null, null, null, null, this, oFF.UiOperation.INSERT, oFF.UiPosition.CONTENT, index, 0);
};
oFF.DfUiContext.prototype.insertNew = function(uiType, index)
{
	return this.m_uiManager.newControlExt(uiType, null, null, null, this, oFF.UiOperation.INSERT, oFF.UiPosition.CONTENT, index, 0);
};
oFF.DfUiContext.prototype.setNewItemAt = function(firstIndex, secondIndex)
{
	return this.m_uiManager.newControlExt(null, null, null, null, this, oFF.UiOperation.SET, oFF.UiPosition.COLUMN_ROW, firstIndex, secondIndex);
};
...
{
	return this.getObjectByNameWithDefault(oFF.UiProperty.FONT_STYLE.getName(), oFF.UiFontStyle.NORMAL);
};
...
{
	return this.getObjectByNameWithDefault(oFF.UiProperty.FONT_WEIGHT.getName(), oFF.UiFontWeight.NORMAL);
};
...
{
	return this.getObjectByNameWithDefault(oFF.UiProperty.ALIGN_SELF.getName(), oFF.UiFlexAlignSelf.AUTO);
};
...
{
	return this.getObjectByNameWithDefault(oFF.UiProperty.OVERFLOW.getName(), oFF.UiOverflow.AUTO);
};
...
oFF.DfUiContext.prototype.getMinWidth = oFF.noSupport;
oFF.DfUiContext.prototype.setMinWidth = oFF.noSupport;
oFF.DfUiContext.prototype.getMinWidthUnit = oFF.noSupport;
oFF.DfUiContext.prototype.setMinWidthUnit = oFF.noSupport;
oFF.DfUiContext.prototype.setMinWidthExt = oFF.noSupport;
oFF.DfUiContext.prototype.getMinWidthCss = oFF.noSupport;
oFF.DfUiContext.prototype.setMinWidthCss = oFF.noSupport;
oFF.DfUiContext.prototype.getMinWidthObj = oFF.noSupport;
oFF.DfUiContext.prototype.setMinWidthObj = oFF.noSupport;
oFF.DfUiContext.prototype.getMinHeight = oFF.noSupport;
oFF.DfUiContext.prototype.setMinHeight = oFF.noSupport;
oFF.DfUiContext.prototype.getMinHeightUnit = oFF.noSupport;
oFF.DfUiContext.prototype.setMinHeightUnit = oFF.noSupport;
oFF.DfUiContext.prototype.setMinHeightExt = oFF.noSupport;
oFF.DfUiContext.prototype.getMinHeightCss = oFF.noSupport;
oFF.DfUiContext.prototype.setMinHeightCss = oFF.noSupport;
oFF.DfUiContext.prototype.getMinHeightObj = oFF.noSupport;
oFF.DfUiContext.prototype.setMinHeightObj = oFF.noSupport;
oFF.DfUiContext.prototype.getXValue = function()
{
	var unitValue = this.getX();
	if (oFF.notNull(unitValue))
	{
		return unitValue.getValue();
	}
	return 0;
};
oFF.DfUiContext.prototype.setXValue = function(value)
{
	this.setXExt(value, this.getXUnit());
	return this;
};
oFF.DfUiContext.prototype.getXUnit = function()
{
	var valueObject = this.getX();
	if (oFF.notNull(valueObject))
	{
		return valueObject.getUnit();
	}
	return null;
};
oFF.DfUiContext.prototype.setXUnit = function(unit)
{
	this.setXExt(this.getXValue(), unit);
	return this;
};
oFF.DfUiContext.prototype.getXCss = function()
{
	var valueObject = this.getX();
	if (oFF.notNull(valueObject))
	{
		return valueObject.getCssValue();
	}
	return null;
};
oFF.DfUiContext.prototype.setXCss = function(xCss)
{
	this.setX(oFF.UiUnitValue.createByCss(xCss));
	return this;
};
oFF.DfUiContext.prototype.setXExt = function(x, unit)
{
	this.setX(oFF.UiUnitValue.create(x, unit));
	return this;
};
...
oFF.DfUiContext.prototype.getYValue = function()
{
	var unitValue = this.getY();
	if (oFF.notNull(unitValue))
	{
		return unitValue.getValue();
	}
...
oFF.DfUiContext.prototype.setYValue = function(value)
{
	this.setYExt(value, this.getYUnit());
	return this;
};
oFF.DfUiContext.prototype.getYUnit = function()
{
	var valueObject = this.getY();
	if (oFF.notNull(valueObject))
	{
		return valueObject.getUnit();
	}
...
oFF.DfUiContext.prototype.setYUnit = function(unit)
{
	this.setYExt(this.getYValue(), unit);
	return this;
};
oFF.DfUiContext.prototype.getYCss = function()
{
	var valueObject = this.getY();
	if (oFF.notNull(valueObject))
	{
...
oFF.DfUiContext.prototype.setYCss = function(yCss)
{
	this.setY(oFF.UiUnitValue.createByCss(yCss));
	return this;
};
oFF.DfUiContext.prototype.setYExt = function(y, unit)
{
	this.setY(oFF.UiUnitValue.create(y, unit));
	return this;
};
...
oFF.DfUiContext.prototype.getHeightValue = function()
{
	var valueObject = this.getHeight();
	if (oFF.notNull(valueObject))
	{
...
oFF.DfUiContext.prototype.setHeightValue = function(value)
{
	return this.setHeightExt(value, this.getHeightUnit());
};
oFF.DfUiContext.prototype.getHeightUnit = function()
{
	var valueObject = this.getHeight();
	if (oFF.notNull(valueObject))
	{
...
oFF.DfUiContext.prototype.setHeightUnit = function(unit)
{
	return this.setHeightExt(this.getHeightValue(), unit);
};
oFF.DfUiContext.prototype.getHeightCss = function()
{
	var valueObject = this.getHeight();
	if (oFF.notNull(valueObject))
	{
...
oFF.DfUiContext.prototype.setHeightCss = function(height)
{
	this.setHeight(oFF.UiUnitValue.createByCss(height));
	return this;
};
oFF.DfUiContext.prototype.setHeightExt = function(height, unit)
{
	return this.setHeight(oFF.UiUnitValue.create(height, unit));
};
...
oFF.DfUiContext.prototype.getWidthValue = function()
{
	var valueObject = this.getWidth();
	if (oFF.notNull(valueObject))
	{
		return valueObject.getValue();
	}
...
oFF.DfUiContext.prototype.setWidthValue = function(value)
{
	return this.setWidthExt(value, this.getWidthUnit());
};
oFF.DfUiContext.prototype.getWidthUnit = function()
{
	var valueObject = this.getWidth();
	if (oFF.notNull(valueObject))
	{
...
oFF.DfUiContext.prototype.setWidthUnit = function(unit)
{
	return this.setWidthExt(this.getWidthValue(), unit);
};
oFF.DfUiContext.prototype.getWidthCss = function()
{
	var valueObject = this.getWidth();
	if (oFF.notNull(valueObject))
	{
...
oFF.DfUiContext.prototype.setWidthCss = function(width)
{
	return this.setWidth(oFF.UiUnitValue.createByCss(width));
};
oFF.DfUiContext.prototype.setWidthExt = function(width, unit)
{
	return this.setWidth(oFF.UiUnitValue.create(width, unit));
};
...
oFF.DfUiContext.prototype.setPositionValue = function(xValue, yValue)
{
	this.setPosition(oFF.UiPositionValue.create(xValue, yValue));
	return this;
};
oFF.DfUiContext.prototype.setPositionCss = function(xCss, yCss)
{
	this.setPosition(oFF.UiPositionValue.createByCss(xCss, yCss));
	return this;
};
oFF.DfUiContext.prototype.getPosition = function()
{
	return oFF.UiPositionValue.createExt(this.getX(), this.getY());
};
...
oFF.DfUiContext.prototype.setSizeValue = function(widthValue, heightValue)
{
	this.setSize(oFF.UiSizeValue.create(widthValue, heightValue));
	return this;
};
oFF.DfUiContext.prototype.setSizeCss = function(widthCss, heightCss)
{
	this.setSize(oFF.UiSizeValue.createByCss(widthCss, heightCss));
	return this;
};
oFF.DfUiContext.prototype.getSize = function()
{
	return oFF.UiSizeValue.createExt(this.getWidth(), this.getHeight());
};
...
{
	return this.setWidthExt(100, oFF.UiSizeUnit.PERCENT);
};
oFF.DfUiContext.prototype.useMaxHeight = function()
{
	return this.setHeightExt(100, oFF.UiSizeUnit.PERCENT);
};
...
oFF.DfUiContext.prototype.getPaddingValue = function()
{
	var valueObject = this.getPadding();
	if (oFF.isNull(valueObject))
	{
		return 0;
	}
	return valueObject.getValue();
};
oFF.DfUiContext.prototype.setPaddingValue = function(padding)
{
	return this.setPaddingExt(padding, this.getPaddingUnit());
};
oFF.DfUiContext.prototype.getPaddingUnit = function()
{
	var valueObject = this.getPadding();
	if (oFF.isNull(valueObject))
	{
		return oFF.UiSizeUnit.PIXEL;
	}
	return valueObject.getUnit();
};
oFF.DfUiContext.prototype.setPaddingUnit = function(unit)
{
	return this.setPaddingExt(this.getPaddingValue(), unit);
};
oFF.DfUiContext.prototype.setPaddingExt = function(padding, unit)
{
	return this.setPadding(oFF.UiUnitValue.create(padding, unit));
};
oFF.DfUiContext.prototype.getPaddingCss = function()
{
	var valueObject = this.getPadding();
	if (oFF.isNull(valueObject))
	{
...
oFF.DfUiContext.prototype.setPaddingCss = function(padding)
{
	return this.setPadding(oFF.UiUnitValue.createByCss(padding));
};
...
oFF.DfUiContext.prototype.getMarginValue = function()
{
	var valueObject = this.getMargin();
	if (oFF.isNull(valueObject))
	{
		return 0;
	}
...
oFF.DfUiContext.prototype.setMarginValue = function(margin)
{
	return this.setMarginExt(margin, this.getMarginUnit());
};
oFF.DfUiContext.prototype.getMarginUnit = function()
{
	var valueObject = this.getMargin();
	if (oFF.isNull(valueObject))
	{
...
oFF.DfUiContext.prototype.setMarginUnit = function(unit)
{
	return this.setMarginExt(this.getMarginValue(), unit);
};
oFF.DfUiContext.prototype.setMarginExt = function(margin, unit)
{
	return this.setMargin(oFF.UiUnitValue.create(margin, unit));
};
oFF.DfUiContext.prototype.getMarginCss = function()
{
	var valueObject = this.getMargin();
	if (oFF.isNull(valueObject))
	{
...
oFF.DfUiContext.prototype.setMarginCss = function(margin)
{
	return this.setMargin(oFF.UiUnitValue.createByCss(margin));
};
...
oFF.DfUiContext.prototype.getFontSizeValue = function()
{
	var valueObject = this.getFontSize();
	if (oFF.isNull(valueObject))
	{
		return 0;
	}
...
oFF.DfUiContext.prototype.setFontSizeValue = function(fontSize)
{
	return this.setFontSizeExt(fontSize, this.getFontSizeUnit());
};
oFF.DfUiContext.prototype.getFontSizeUnit = function()
{
	var valueObject = this.getFontSize();
	if (oFF.isNull(valueObject))
	{
...
oFF.DfUiContext.prototype.setFontSizeUnit = function(unit)
{
	return this.setFontSizeExt(this.getFontSizeValue(), unit);
};
oFF.DfUiContext.prototype.setFontSizeExt = function(fontSize, unit)
{
	return this.setFontSize(oFF.UiUnitValue.create(fontSize, unit));
};
oFF.DfUiContext.prototype.getFontSizeCss = function()
{
	var valueObject = this.getFontSize();
	if (oFF.isNull(valueObject))
	{
...
oFF.DfUiContext.prototype.setFontSizeCss = function(fontSize)
{
	return this.setFontSize(oFF.UiUnitValue.createByCss(fontSize));
};
...
oFF.DfUiContext.prototype.getCornerRadiusValue = function()
{
	var valueObject = this.getCornerRadius();
	if (oFF.isNull(valueObject))
	{
		return 0;
	}
...
oFF.DfUiContext.prototype.setCornerRadiusValue = function(cornerRadius)
{
	return this.setCornerRadiusExt(cornerRadius, this.getCornerRadiusUnit());
};
oFF.DfUiContext.prototype.getCornerRadiusUnit = function()
{
	var valueObject = this.getCornerRadius();
	if (oFF.isNull(valueObject))
	{
...
oFF.DfUiContext.prototype.setCornerRadiusUnit = function(unit)
{
	return this.setCornerRadiusExt(this.getCornerRadiusValue(), unit);
};
oFF.DfUiContext.prototype.setCornerRadiusExt = function(cornerRadius, unit)
{
	return this.setCornerRadius(oFF.UiUnitValue.create(cornerRadius, unit));
};
oFF.DfUiContext.prototype.getCornerRadiusCss = function()
{
	var valueObject = this.getCornerRadius();
	if (oFF.isNull(valueObject))
	{
...
oFF.DfUiContext.prototype.setCornerRadiusCss = function(cornerRadius)
{
	return this.setCornerRadius(oFF.UiUnitValue.createByCss(cornerRadius));
};
...
oFF.DfUiContext.prototype.getBorderSizeValue = function()
{
	var valueObject = this.getBorderSize();
	if (oFF.isNull(valueObject))
	{
		return 0;
	}
...
oFF.DfUiContext.prototype.setBorderSizeValue = function(borderSize)
{
	return this.setBorderSize(oFF.UiUnitValue.create(borderSize, this.getBorderSizeUnit()));
};
oFF.DfUiContext.prototype.getBorderSizeUnit = function()
{
	var valueObject = this.getBorderSize();
	if (oFF.isNull(valueObject))
	{
...
oFF.DfUiContext.prototype.setBorderSizeUnit = function(unit)
{
	return this.setBorderSizeExt(this.getBorderSizeValue(), unit);
};
oFF.DfUiContext.prototype.setBorderSizeExt = function(borderSize, unit)
{
	return this.setBorderSize(oFF.UiUnitValue.create(borderSize, unit));
};
oFF.DfUiContext.prototype.getBorderSizeCss = function()
{
	var valueObject = this.getBorderSize();
	if (oFF.isNull(valueObject))
	{
...
oFF.DfUiContext.prototype.setBorderSizeCss = function(borderSize)
{
	return this.setBorderSize(oFF.UiUnitValue.createByCss(borderSize));
};
oFF.DfUiContext.prototype.getBorderSize = function()
{
	return this.getObjectByNameWithDefault(oFF.UiProperty.BORDER_SIZE.getName(), null);
};
oFF.DfUiContext.prototype.setBorderSize = function(borderSize)
{
	return this.setObjectByName(oFF.UiProperty.BORDER_SIZE.getName(), borderSize);
};
oFF.DfUiContext.prototype.getHeaderHeightValue = function()
{
	var valueObject = this.getHeaderHeight();
	if (oFF.isNull(valueObject))
	{
		return 0;
	}
...
oFF.DfUiContext.prototype.setHeaderHeightValue = function(headerHeight)
{
	return this.setHeaderHeight(oFF.UiUnitValue.create(headerHeight, this.getHeaderHeightUnit()));
};
oFF.DfUiContext.prototype.getHeaderHeightUnit = function()
{
	var valueObject = this.getHeaderHeight();
	if (oFF.isNull(valueObject))
	{
...
oFF.DfUiContext.prototype.setHeaderHeightUnit = function(unit)
{
	return this.setHeaderHeightExt(this.getHeaderHeightValue(), unit);
};
oFF.DfUiContext.prototype.setHeaderHeightExt = function(headerHeight, unit)
{
	return this.setHeaderHeight(oFF.UiUnitValue.create(headerHeight, unit));
};
oFF.DfUiContext.prototype.getHeaderHeightCss = function()
{
	var valueObject = this.getHeaderHeight();
	if (oFF.isNull(valueObject))
	{
...
oFF.DfUiContext.prototype.setHeaderHeightCss = function(headerHeight)
{
	return this.setHeaderHeight(oFF.UiUnitValue.createByCss(headerHeight));
};
...
oFF.DfUiContext.prototype.getFooterHeightValue = function()
{
	var valueObject = this.getFooterHeight();
	if (oFF.isNull(valueObject))
	{
		return 0;
	}
...
oFF.DfUiContext.prototype.setFooterHeightValue = function(footerHeight)
{
	return this.setFooterHeight(oFF.UiUnitValue.create(footerHeight, this.getFooterHeightUnit()));
};
oFF.DfUiContext.prototype.getFooterHeightUnit = function()
{
	var valueObject = this.getFooterHeight();
	if (oFF.isNull(valueObject))
	{
...
oFF.DfUiContext.prototype.setFooterHeightUnit = function(unit)
{
	return this.setFooterHeightExt(this.getFooterHeightValue(), unit);
};
oFF.DfUiContext.prototype.setFooterHeightExt = function(footerHeight, unit)
{
	return this.setFooterHeight(oFF.UiUnitValue.create(footerHeight, unit));
};
oFF.DfUiContext.prototype.getFooterHeightCss = function()
{
	var valueObject = this.getFooterHeight();
	if (oFF.isNull(valueObject))
	{
...
oFF.DfUiContext.prototype.setFooterHeightCss = function(footerHeight)
{
	return this.setFooterHeight(oFF.UiUnitValue.createByCss(footerHeight));
};
...
oFF.DfUiContext.prototype.getMatrixModel = oFF.noSupport;
oFF.DfUiContext.prototype.setMatrixModel = oFF.noSupport;
oFF.DfUiContext.prototype.getChartType = oFF.noSupport;
oFF.DfUiContext.prototype.setChartType = oFF.noSupport;
oFF.DfUiContext.prototype.getTableModel = function()
{
	return null;
};
oFF.DfUiContext.prototype.setTableModel = oFF.noSupport;
oFF.DfUiContext.prototype.getModelElement = function()
{
	return null;
};
oFF.DfUiContext.prototype.setModelElement = oFF.noSupport;
...
oFF.UiAnalyticalCard.prototype.initializeComposite = function()
{
	...
	this.m_cardWrapper.setWidthCss("368px");
	this.m_cardWrapper.setHeightCss("462px");
	...
	this.m_noKpiData.setHeightCss("152px");
	...
	this.m_noChartData.setHeightCss("310px");
...
oFF.UiAnalyticalCard.prototype.setDataManifest = function(dataManifest)
{
	...
	if (hasError)
	{
		...
		this.m_cardWrapper.setHeightValue(this.m_cardWrapper.getHeightValue() + 100);
		this.m_errorWrapper.addNewItemOfType(oFF.UiType.TEXT).setText(errorText).setFontColor(oFF.UiColor.RED).setHeightCss("100px");
	}
};
...
oFF.UiFancyButton.prototype.initializeComposite = function()
{
	...
	this.m_button.setBackgroundColor(oFF.UiColor.createByString("#67d6ee"));
...
oFF.UiModule.getInstance = function()
{
	if (oFF.isNull(oFF.UiModule.s_module))
	{
		...
		oFF.IMxGridSelectionType.staticSetup();
		oFF.MxGridState.staticSetup();
		oFF.MxGridSpanState.staticSetup();
		oFF.MxGridCellType.staticSetup();
		oFF.MxGridMatrix.staticSetup();
		oFF.UiStateChangeCause.staticSetup();
		...
		oFF.ProgramRegistration.setProgramFactory(oFF.SubSysPrgGui.DEFAULT_PROGRAM_NAME, new oFF.SubSysPrgGui());
