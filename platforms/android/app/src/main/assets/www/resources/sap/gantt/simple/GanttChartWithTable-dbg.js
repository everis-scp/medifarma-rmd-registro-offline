...
sap.ui.define([
	...
	GanttChartWithTable.prototype.setTable = function (oTable) {
		...
		if (oTable.getRowActionTemplate() && oTable.getRowActionTemplate().isA("sap.gantt.simple.GanttRowAction") &&
			oTable.getRowActionTemplate().getControlTemplate()) {
	...
	GanttChartWithTable.prototype._addChangesToControlPersonalizationWriteAPI = function(oEvent, aChanges) {
		var isGanttChartContainer = this.getParent().isA("sap.gantt.simple.GanttChartContainer");
		var isVariantEnabled = (isGanttChartContainer && this.getParent().getToolbar().getEnableVariantManagement()) || this.getProperty("_enableRTA");
