...
sap.ui.define([
    ...
    "jquery.sap.storage",
], function (MessageBox, NumberFormat, FileSizeFormat) {
    "use strict";
    var module = {};
    // =======================================================================
    // Regex Tester
    ...
    module.hasher = {
        ...
        showUrlUpdateError: function () {
            ...
            this.urlError = true;
            // show message box
            var message = sap.esh.search.ui.resources.i18n.getText("searchUrlErrorMessage");
            MessageBox.alert(message, {
                title: sap.esh.search.ui.resources.i18n.getText("searchUrlErrorTitle"),
    ...
    module.loadResultViewType = function () {
        if (jQuery.sap.storage && jQuery.sap.storage.isSupported()) {
            var resultViewType = jQuery.sap.storage.get("resultViewType"); // ToDo: ID ?
