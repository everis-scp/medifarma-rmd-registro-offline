...
], function (SearchModel, Toolbar, ToolbarDesign, Button, Link, ToolbarLayoutData, ToolbarSpacer, ActionSheet, PlacementType, InvisibleText, IconPool, ItemNavigation) {
    "use strict";
    var module = sap.ui.core.Control.extend("sap.esh.search.ui.controls.SearchRelatedObjectsToolbar", {
        ...
        init: function () {
            ...
            that.setAggregation("_ariaDescriptionForLinks", new InvisibleText({
                text: sap.esh.search.ui.resources.i18n.getText("result_list_item_aria_has_more_links"),
            }));
        },
        exit: function () {
            var that = this;
