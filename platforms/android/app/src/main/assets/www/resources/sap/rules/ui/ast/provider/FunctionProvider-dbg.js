sap.ui.define(["sap/rules/ui/ast/model/Function",
	...
	FunctionProvider.prototype.getAllFunctionsExceptOperationsCategory = function () {
		//IE does not support Object.values()
		var that = this;
		var values = Object.keys(that._oFunctionsNameMap).filter(function (functionName) {
			return that._oFunctionsNameMap[functionName].getContext() !== "result";		
		}).map(function (e) {
			return that._oFunctionsNameMap[e];
		});;
		return values;
	...
	FunctionProvider.prototype.getResultContextFunctions = function () {
		var that = this;
		var values = Object.keys(that._oFunctionsNameMap).filter(function (functionName) {
			return that._oFunctionsNameMap[functionName].getContext() === "result";		
		}).map(function (e) {
