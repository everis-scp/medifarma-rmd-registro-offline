 ...
 */
/* global $ */
sap.ui.define(["sap/esh/search/ui/SearchHelper", "sap/esh/search/ui/SearchUrlParserInav2", "sap/m/MessageBox"], function (SearchHelper, SearchUrlParserInav2, MessageBox) {
    "use strict";
        ...
        parseUrlParameters: function (oParametersLowerCased) {
            ...
            if (oParametersLowerCased.filter) {
                ...
                try {
                    ...
                    MessageBox.show(sap.esh.search.ui.resources.i18n.getText("searchUrlParsingErrorLong") +
                        "\n(" +
                        e.toString() +
                        ")", {
                        icon: MessageBox.Icon.ERROR,
                        title: sap.esh.search.ui.resources.i18n.getText("searchUrlParsingError"),
