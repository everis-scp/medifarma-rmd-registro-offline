			...
			if (oFF.notNull(source) && oFF.notNull(target))
		{
			if (source.getProtocolType() !== oFF.ProtocolType.FILE)
			{
				...
				if (oFF.XStringUtils.isNotNullAndNotEmpty(sysWebDispatcherTemplate))
				{
					...
					var usePrefix = oFF.XString.containsString(sysWebDispatcherTemplate, oFF.XEnvironmentConstants.DISPATCHER_PREFIX);
					...
					if (isSameServer === false || useAlias || usePrefix)
					{
						...
						newUrlString = oFF.XConnectHelper.safeReplace(newUrlString, oFF.XEnvironmentConstants.DISPATCHER_PREFIX, prefix);
				...
				else if (oFF.XStringUtils.isNotNullAndNotEmpty(prefix))
				{
					var newPath = oFF.XStringUtils.concatenate2(prefix, path);
...
oFF.XVersion = {
	...
	MAX:300,
	DEFAULT_VALUE:300,
	V121_BW_UNIFIED_DATACELLS:121,
	V122_CUSTOM_DIMENSION_2:122,
	V123_NOT_USE_QM_CAPA:123,
	V124_INIT_ACTION_FOR_FUSION:124,
	V125_SET_OPERAND_CURRENT_MEMBER_SINGLE_NAVIGATION:125,
	V126_MULTIPLE_EX_AGG_DIMS_IN_CALC_PLAN:126,
	V127_IS_USED_CONDITION:127,
	V130_HIERARCHY_INFO_IN_FILTER:130,
	V137_SORT_NEW_VALUES:137,
	V139_NO_MEASURE_READMODE:139,
	V141_NO_EMPTY_OPTIONS:141,
	V143_NO_EMPTY_SORT:143,
	V145_NO_NON_EMPTY:145,
	V147_NO_DUPLICATED_READMODE:147,
	...
	V164_ASSERT_RESULTSET_BOUNDARIES:164,
	V166_CUBE_CACHE:166,
	...
	V180_REPOSITORY_PERSIST_PAGING:180,
	...
	V196_ROOT_ORPHANS_AFTER_VISIBILITY_FILTER:196,
	...
	V206_MDS_CONDITIONS:206,
	V208_IS_VIRTUAL_DESCRIPTION:208,
	...
	V234_MEASURE_MEMBER_DEFINITION:234,
	V236_NAMED_CUSTOM_DIMENSION_MEMBER:236,
	V238_MEASURE_MEMBER_DETAILS:238,
	V240_MEASURE_MEMBER_TYPE:240,
	...
	V260_CURRENCY_TRANSLATION:260,
	V262_MEASURE_MEMBER_CURRENCY_TRANSLATIONS:262,
	...
	V280_UNDEFINED_TUPLE_COUNT_TOTALS:280,
	V282_SFX_MINIMUM_DRILL_STATE:282,
	V284_SFX_HIDDEN_DIMENSIONS:284,
	V286_AUTO_VARIABLE_SUBMIT_FOR_FULL_QM:286,
	V288_MULTIPLE_ACCOUNT_HIERARCHIES:288,
	V290_SFX_DIMENSION_CUSTOMIZED_DESC:290,
	V292_MEMBER_OVERRIDE_TEXTS:292,
	V300_INA_REPOSITORY_DELTA:300,
	V500_HIERARCHY_CATALOG:500,
	V502_DONT_ALWAYS_REQUEST_TEXT:502,
	V504_UNIVERSAL_MODEL:504,
	V505_DIMENSION_KEY_ATTRIBUTES:505,
	V506_AUTO_VARIABLE_SUBMIT:506,
...
oFF.SyncActionExtRes.prototype.processGeneric = oFF.noSupport;
...
oFF.DfXCacheProvider.prototype.readElementFromCache = function(namespace, name, validityTime)
{
	...
	if (oFF.notNull(element))
	{
		...
		this.logMulti("#").appendInt(this.s_readCounter++).append(": readElement HIT ").append(key).flush();
	}
	else
	{
		this.logMulti("#").appendInt(this.s_readCounter++).append(": readElement NO_HIT ").append(key).flush();
	}
	return element;
};
oFF.DfXCacheProvider.prototype.getElement = function(name)
{
	var element = null;
...
oFF.DfXCacheProvider.prototype.putElement = function(name, element)
{
	var value = oFF.PrUtils.serialize(element, false, false, 0);
	this.logMulti("#").appendInt(this.s_writeCounter++).append(": putElement ").append(name).flush();
...
oFF.DfXCacheProvider.prototype.clearCache = function(namespace)
{
	...
	{
		var key = this.generateKey(namespace, namespace);
		this.clearCacheInternal(key);
	}
};
...
oFF.IoSession.prototype.setupIoSession = function(parent, environmentConfig)
{
	...
	this.m_xVersion = this.getValidVersion(-1);
};
...
oFF.IoSession.prototype.getValidVersion = function(version)
{
...
oFF.SyncAction.prototype.processGeneric = function()
{
	if (this.m_syncState === oFF.SyncState.OUT_OF_SYNC)
	{
...
oFF.SyncAction.prototype.callListeners = function(allowNewListeners)
{
	...
	if (oFF.notNull(this.m_listeners))
	{
		...
		while (sizeOfListeners > offset)
		{
			...
			if (!oFF.XClass.isXObjectReleased(listener) && !oFF.XClass.callFunction(listener, this, data, customIdentifier))
			{
				this.callTypedListener(this, pair.getListenerType(), listener, data, customIdentifier);
			}
...
oFF.XCacheProviderInMemory.prototype.putElement = function(name, element)
{
	this.m_elementMap.put(name, element);
};
oFF.XCacheProviderInMemory.prototype.getElement = function(name)
{
	var obj = this.m_elementMap.getByKey(name);
	var prObj = obj;
	return prObj;
...
{
	oFF.ProxyType.DEFAULT = oFF.XConstant.setupName(new oFF.ProxyType(), "Default");
...
oFF.FeatureToggleOlap.CUSTOM_MEMBER_KEY_SORT_ORDER = null;
oFF.FeatureToggleOlap.COMPLEX_TUPLE_FILTER = null;
oFF.FeatureToggleOlap.DYN_RESTRICTION_ON_FORMULA = null;
oFF.FeatureToggleOlap.AV_CAPABILITY_VARIABLE_MASKING = null;
oFF.FeatureToggleOlap.RESULTSET_UNIT_INDEX = null;
oFF.FeatureToggleOlap.DIMENSION_VISIBILITY = null;
oFF.FeatureToggleOlap.METADATA_SEMANTIC_TYPE = null;
oFF.FeatureToggleOlap.CUSTOM_HIERARCHY = null;
oFF.FeatureToggleOlap.METADATA_EXTENDED_DIMENSION_VISIBILITY = null;
oFF.FeatureToggleOlap.BW_UNIFIED_DATACELLS = null;
oFF.FeatureToggleOlap.DETAILED_RESPONSE_EXPANSION = null;
oFF.FeatureToggleOlap.QDATA_CELL_MODEL_DEFAULTS = null;
oFF.FeatureToggleOlap.UDH_ALIGNMENT = null;
oFF.FeatureToggleOlap.CUSTOM_DIMENSION_2 = null;
...
oFF.FeatureToggleOlap.NOT_USE_QM_CAPA = null;
...
oFF.FeatureToggleOlap.ASSERT_RESULTSET_BOUNDARIES = null;
...
oFF.FeatureToggleOlap.REMOTE_BLENDING_METADATA = null;
...
oFF.FeatureToggleOlap.AUTO_VARIABLE_SUBMIT = null;
...
oFF.FeatureToggleOlap.staticSetup = function()
{
	...
	oFF.FeatureToggleOlap.DIMENSION_VISIBILITY = oFF.FeatureToggleOlap.create("MetadataDimensionVisibility", -2);
	oFF.FeatureToggleOlap.METADATA_SEMANTIC_TYPE = oFF.FeatureToggleOlap.create("MetadataSemanticType", -2);
	oFF.FeatureToggleOlap.RESULTSET_UNIT_INDEX = oFF.FeatureToggleOlap.create("ResultSetUnitIndex", -2);
	oFF.FeatureToggleOlap.COMPLEX_TUPLE_FILTER = oFF.FeatureToggleOlap.create("ComplexTupleFilter", -2);
	oFF.FeatureToggleOlap.AV_CAPABILITY_VARIABLE_MASKING = oFF.FeatureToggleOlap.create("VariableMasking", -2);
	oFF.FeatureToggleOlap.CUSTOM_HIERARCHY = oFF.FeatureToggleOlap.create("TransientHierarchy1", -2);
	oFF.FeatureToggleOlap.CUSTOM_MEMBER_KEY_SORT_ORDER = oFF.FeatureToggleOlap.create("CustomMemberKeySortOrder", -2);
	oFF.FeatureToggleOlap.DYN_RESTRICTION_ON_FORMULA = oFF.FeatureToggleOlap.create("DynamicRestrictionOnFormula", -2);
	oFF.FeatureToggleOlap.METADATA_EXTENDED_DIMENSION_VISIBILITY = oFF.FeatureToggleOlap.create("MetadataExtendedDimensionVisibility", -2);
	oFF.FeatureToggleOlap.DETAILED_RESPONSE_EXPANSION = oFF.FeatureToggleOlap.create("DetailedResponseExpansion", -2);
	oFF.FeatureToggleOlap.REMOTE_BLENDING_METADATA = oFF.FeatureToggleOlap.create("RemoteBlendingMetadata", -2);
	oFF.FeatureToggleOlap.BW_UNIFIED_DATACELLS = oFF.FeatureToggleOlap.create("BW.Olap.UnifiedDataCells", oFF.XVersion.V121_BW_UNIFIED_DATACELLS);
	oFF.FeatureToggleOlap.CUSTOM_DIMENSION_2 = oFF.FeatureToggleOlap.create("CustomDimension2", oFF.XVersion.V122_CUSTOM_DIMENSION_2);
	oFF.FeatureToggleOlap.NOT_USE_QM_CAPA = oFF.FeatureToggleOlap.create("Olap.NotUseQueryModelCapabilities", oFF.XVersion.V123_NOT_USE_QM_CAPA);
	oFF.FeatureToggleOlap.INIT_ACTION_FOR_FUSION = oFF.FeatureToggleOlap.create("Olap.InitActionForFusion", oFF.XVersion.V124_INIT_ACTION_FOR_FUSION);
	oFF.FeatureToggleOlap.SET_OPERAND_CURRENT_MEMBER_SINGLE_NAVIGATION = oFF.FeatureToggleOlap.create("SetOperandCurrentMemberSingleNavigation", oFF.XVersion.V125_SET_OPERAND_CURRENT_MEMBER_SINGLE_NAVIGATION);
	...
	oFF.FeatureToggleOlap.HIERARCHY_INFO_IN_FILTER = oFF.FeatureToggleOlap.create("Olap.HierarchyInfoInFilter", oFF.XVersion.V130_HIERARCHY_INFO_IN_FILTER);
	oFF.FeatureToggleOlap.SORT_NEW_VALUES = oFF.FeatureToggleOlap.create("SortNewValues", oFF.XVersion.V137_SORT_NEW_VALUES);
	oFF.FeatureToggleOlap.NO_MEASURE_READMODE = oFF.FeatureToggleOlap.create("Olap.NoMeasureReadmode", oFF.XVersion.V139_NO_MEASURE_READMODE);
	oFF.FeatureToggleOlap.NO_EMPTY_OPTIONS = oFF.FeatureToggleOlap.create("Olap.NoEmptyOptions", oFF.XVersion.V141_NO_EMPTY_OPTIONS);
	oFF.FeatureToggleOlap.NO_EMPTY_SORT = oFF.FeatureToggleOlap.create("Olap.NoEmptySort", oFF.XVersion.V143_NO_EMPTY_SORT);
	oFF.FeatureToggleOlap.NO_NON_EMPTY = oFF.FeatureToggleOlap.create("Olap.NoNonEmpty", oFF.XVersion.V145_NO_NON_EMPTY);
	oFF.FeatureToggleOlap.NO_DUPLICATED_READMODE = oFF.FeatureToggleOlap.create("Olap.NoDuplicateReadmode", oFF.XVersion.V147_NO_DUPLICATED_READMODE);
	...
	oFF.FeatureToggleOlap.ASSERT_RESULTSET_BOUNDARIES = oFF.FeatureToggleOlap.create("Olap.AssertResultSetBoundaries", oFF.XVersion.V164_ASSERT_RESULTSET_BOUNDARIES);
	...
	oFF.FeatureToggleOlap.PERSIST_PAGING_IN_REPO = oFF.FeatureToggleOlap.create("Olap.PersistPagingInRepo", oFF.XVersion.V180_REPOSITORY_PERSIST_PAGING);
	...
	oFF.FeatureToggleOlap.ROOT_ORPHANS_AFTER_VISIBILITY_FILTER = oFF.FeatureToggleOlap.create("Olap.RootOrphanNodesAfterVisibilityFilter", oFF.XVersion.V196_ROOT_ORPHANS_AFTER_VISIBILITY_FILTER);
	...
	oFF.FeatureToggleOlap.MDS_CONDITIONS = oFF.FeatureToggleOlap.create("Conditions", oFF.XVersion.V206_MDS_CONDITIONS);
	oFF.FeatureToggleOlap.IS_VIRTUAL_DESCRIPTION = oFF.FeatureToggleOlap.create("IsVirtualDescription", oFF.XVersion.V208_IS_VIRTUAL_DESCRIPTION);
	...
	oFF.FeatureToggleOlap.METADATA_DIMENSION_OTHERS = oFF.FeatureToggleOlap.create("MetadataDimensionOthers", oFF.XVersion.V224_METADATA_DIMENSION_OTHERS);
	...
	oFF.FeatureToggleOlap.MEASURE_MEMBER_DEFINITION = oFF.FeatureToggleOlap.create("Olap.MeasureMemberMetadata", oFF.XVersion.V234_MEASURE_MEMBER_DEFINITION);
	...
	oFF.FeatureToggleOlap.MEASURE_MEMBER_DETAILS = oFF.FeatureToggleOlap.create("Olap.MeasureMemberDetails", oFF.XVersion.V238_MEASURE_MEMBER_DETAILS);
	oFF.FeatureToggleOlap.MEASURE_MEMBER_TYPE = oFF.FeatureToggleOlap.create("Olap.CustomDimension1MemberType", oFF.XVersion.V240_MEASURE_MEMBER_TYPE);
	...
	oFF.FeatureToggleOlap.CURRENCY_TRANSLATION = oFF.FeatureToggleOlap.create("Olap.CurrencyTranslation", oFF.XVersion.V260_CURRENCY_TRANSLATION);
	oFF.FeatureToggleOlap.MEASURE_MEMBER_CURRENCY_TRANSLATIONS = oFF.FeatureToggleOlap.create("Olap.MeasureMemberCurrencyTranslations", oFF.XVersion.V262_MEASURE_MEMBER_CURRENCY_TRANSLATIONS);
	...
	oFF.FeatureToggleOlap.UNDEFINED_TUPLE_COUNT_TOTALS = oFF.FeatureToggleOlap.create("Olap.UndefinedTupleCountTotals", oFF.XVersion.V280_UNDEFINED_TUPLE_COUNT_TOTALS);
	...
	oFF.FeatureToggleOlap.AUTO_VARIABLE_SUBMIT_FOR_FULL_QM = oFF.FeatureToggleOlap.create("Olap.AutoVarSubmitFullQM", oFF.XVersion.V286_AUTO_VARIABLE_SUBMIT_FOR_FULL_QM);
	...
	oFF.FeatureToggleOlap.SFX_DIMENSION_CUSTOMIZED_DESC = oFF.FeatureToggleOlap.create("Olap.SfxDimensionCustomizedDesc", oFF.XVersion.V290_SFX_DIMENSION_CUSTOMIZED_DESC);
	...
	oFF.FeatureToggleOlap.HIERARCHY_CATALOG = oFF.FeatureToggleOlap.create("HierarchyCatalog", oFF.XVersion.V500_HIERARCHY_CATALOG);
	oFF.FeatureToggleOlap.DONT_ALWAYS_REQUEST_TEXTFIELD = oFF.FeatureToggleOlap.create("Olap.DontAlwaysRequestTextField", oFF.XVersion.V502_DONT_ALWAYS_REQUEST_TEXT);
	oFF.FeatureToggleOlap.UNIVERSAL_MODEL = oFF.FeatureToggleOlap.create("UniversalModel", oFF.XVersion.V504_UNIVERSAL_MODEL);
	oFF.FeatureToggleOlap.DIMENSION_KEY_ATTRIBUTES = oFF.FeatureToggleOlap.create("Olap.DimensionKeyAttributes", oFF.XVersion.V505_DIMENSION_KEY_ATTRIBUTES);
	oFF.FeatureToggleOlap.AUTO_VARIABLE_SUBMIT = oFF.FeatureToggleOlap.create("Olap.AutoVarSubmit", oFF.XVersion.V506_AUTO_VARIABLE_SUBMIT);
	oFF.FeatureToggleOlap.METADATA_CACHING = oFF.FeatureToggleOlap.create("Olap.MetadataCaching", oFF.XVersion.MAX + 1);
	oFF.FeatureToggleOlap.HAS_CHECK_TABLE_DEFAULT_FALSE = oFF.FeatureToggleOlap.create("Olap.HasCheckTableDefaultFalse", oFF.XVersion.MAX + 1);
	...
	oFF.FeatureToggleOlap.UNDO_USE_ALLOW_LIST = oFF.FeatureToggleOlap.create("Olap.UseAllowList", oFF.XVersion.MAX + 1);
	oFF.FeatureToggleOlap.UNDO_RELEASE_QUERY_MANAGERS = oFF.FeatureToggleOlap.create("Olap.UndoReleaseQueryManagers", oFF.XVersion.MAX + 1);
	oFF.FeatureToggleOlap.BW_SESSION_ID_VIA_GET_RESPONSE = oFF.FeatureToggleOlap.create("Rpc.BwSessionIdViaGetResponse", oFF.XVersion.MAX + 1);
	...
	oFF.FeatureToggleOlap.TIME_MEASURE_WITH_FLAT_AND_HIERARCHICAL_FILTER = oFF.FeatureToggleOlap.create("Olap.TimeMeasureWithFlatAndHierarchicalFilter", oFF.XVersion.MAX + 1);
...
oFF.FeatureToggleOlap.getCapabilityByName = function(capabilityName)
{
	return oFF.FeatureToggleOlap.lookup(capabilityName);
};
...
oFF.ContentType.staticSetup = function()
{
	...
	oFF.ContentType.putFileExtMapping("qdf", oFF.ContentType.APPLICATION_JSON);
};
...
oFF.XUri.replaceEnvVar = function(env, source, logger, varResolveMode, smartPathConcatenate)
{
	...
	while (oFF.notNull(target))
	{
		...
		if (endIndex >= 0)
		{
			...
			{
				target = oFF.XUri.smartPathConcatenate(before, replaceValue);
				target = oFF.XUri.smartPathConcatenate(target, after);
			}
			else
			{
...
oFF.XUri.smartPathConcatenate = function(first, second)
{
...
oFF.SystemType.staticSetup = function()
{
	...
	oFF.SystemType.ABAP_MDS = oFF.SystemType.create("ABAP_MDS", oFF.SystemType.HANA, true, false, false, false, "/sap/bw/mds/GetServerInfo", "/sap/bw/mds/GetResponse", "/sap/bw/mds/logout", null);
	...
	oFF.SystemType.ORCA = oFF.SystemType.create("ORCA", oFF.SystemType.HANA, true, true, false, false, null, null, null, "/sap/fpa/services/rest/epm/session?action=logon");
...
oFF.DfRpcFunction.prototype.setupFunction = function(context, connectionInfo, relativeUri)
{
...
oFF.HttpCacheClient.createDynamicCacheClient = function(session, cache, request)
{
	var httpClient = null;
	if (oFF.notNull(cache) && cache.isEnabled())
	{
		httpClient = oFF.HttpCacheClient.create(session, cache, request);
	}
	else
	{
...
oFF.HttpCacheClient.create = function(session, cache, request)
{
...
oFF.HttpCacheClient.prototype.processSynchronization = function(syncType)
{
	...
	var cacheHit = null;
	if (this.m_cache.isReadEnabled())
	{
		cacheHit = this.m_cache.getByKey(this.m_fingerprint);
	}
	if (oFF.notNull(cacheHit))
	{
		var response = oFF.HttpResponse.createResponse(request);
		response.setJsonObject(cacheHit);
	...
	{
		this.m_innerHttpClient = this.getRequest().newHttpClient(this.getSession());
...
oFF.HttpCacheClient.prototype.onHttpResponse = function(extResult, response, customIdentifier)
{
	...
	if (extResult.isValid() && this.m_cache.isWriteEnabled())
	{
		...
		this.m_cache.put(this.m_fingerprint, jsonContent, null);
	}
	this.endSync();
};
