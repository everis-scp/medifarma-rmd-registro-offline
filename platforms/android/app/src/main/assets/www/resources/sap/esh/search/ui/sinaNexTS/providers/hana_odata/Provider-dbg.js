...
sap.ui.define(["require", "exports", "../../core/ajax", "../../core/core", "./MetadataParserXML", "./MetadataParserJson", "./ItemParser", "./FacetParser", "./suggestionParser", "./eshObjects/src/index", "./conditionSerializerEshObj", "../../core/Log", "../../sina/SearchQuery", "../../sina/SortOrder", "../AbstractProvider", "../../sina/SuggestionType", "../../sina/ComplexCondition", "../../core/errors", "./HierarchyParser"], function (require, exports, ajax, core, MetadataParserXML_1, MetadataParserJson_1, ItemParser_1, FacetParser_1, suggestionParser_1, index_1, conditionSerializer, Log_1, SearchQuery_1, SortOrder_1, AbstractProvider_1, SuggestionType_1, ComplexCondition_1, errors_1, HierarchyParser_1) {
    "use strict";
    ...
    var Provider = /** @class */ (function (_super) {
        ...
        Provider.prototype._fireSearchQuery = function (oInputData) {
            return __awaiter(this, void 0, void 0, function () {
                var response, items, facets, statistics, constructedDataSourceFacet;
                return __generator(this, function (_a) {
                    switch (_a.label) {
        ...
        Provider.prototype._prepareChartQueryRequest = function (query, rootCondition, resultDeletion) {
            ...
            if (isValueHelpMode === true) {
                ...
                if (!resultDeletion.value ||
                    ...
                    resultDeletion.value.match(/^[*\s]+$/g) !== null) {
                    resultDeletion.value = "*";
                    // searchExpression +=
                    //     "(" +
