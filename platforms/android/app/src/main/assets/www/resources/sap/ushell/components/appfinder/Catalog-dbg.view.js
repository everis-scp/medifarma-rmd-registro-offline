...
sap.ui.define([
    ...
    sap.ui.jsview("sap.ushell.components.appfinder.Catalog", {
        ...
        createContent: function (oController) {
            ...
            var bPinButtonEnabled = this.oVisualizationOrganizerHelper.isPinButtonEnabled();
            oAppBoxPinButton.setVisible(bPinButtonEnabled);
            ...
            oTilePinButton.setVisible(bPinButtonEnabled);
