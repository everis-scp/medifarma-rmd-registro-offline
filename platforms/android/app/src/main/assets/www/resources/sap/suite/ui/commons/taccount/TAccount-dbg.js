sap.ui.define([
...
], function (library, Device, Control, ItemNavigation, TAccountGroup, IconPool, Icon, InvisibleText, encodeXML, TAccountUtils, Utils, BigNumber) {
	"use strict";
	...
	TAccount.prototype._getSumText = function () {
		...
		var sValue = TAccountUtils.formatCurrency(value, sCurrency);
