...
sap.ui.define([
    ...
    "sap/esh/search/ui/container/ComponentService",
    ...
    "sap/esh/search/ui/controls/SearchResultMap",
    ...
    "sap/esh/search/ui/controls/SearchTilesContainer",
    "sap/m/TablePersoController",
 ...
 * @returns
 */
function (errors, ErrorHandler, i18n, SearchFieldGroup, SearchShellHelperAndModuleLoader, SearchModel, ComponentService, SearchLayout, SearchLayoutResponsive, SearchResultListContainer, SearchResultList, SearchResultTable, SearchResultGrid, SearchSpreadsheet, SearchNoResultScreen, SearchHelper, SearchText, SearchLink, SearchCountBreadCrumbs, SearchMap, SearchResultListItem, CustomSearchResultListItem, SearchTileHighlighter, SearchFilterBar, SearchFacetFilter, DivContainer, Control, // sap.ui.core
    ...
    return Control.extend("sap.esh.search.ui.SearchCompositeControl", {
        ...
        constructor: function (sId, mSettings) {
            ...
            try {
                ...
                var isUshell = that.options.model && that.options.model.config.isUshell;
                if (!isUshell) {
                ...
                try {
                    ...
                    // @ts-ignore
                    that.setModel(sap.esh.search.ui.resources.i18nModel, "i18n");
                    that.createContent();
                }
                catch (error) {
                    var err = new errors.ESHUIConstructionError(error);
        ...
        createContent: function () {
            ...
            if (that.getModel().config.layoutWithoutPage) {
                ...
                tooltip: {
                    ...
                    formatter: function (facetVisibility) {
                        return facetVisibility
                            ? sap.esh.search.ui.resources.i18n.getText("hideFacetBtn_tooltip")
                            : sap.esh.search.ui.resources.i18n.getText("showFacetBtn_tooltip");
                    },
                },
                // @ts-ignore
            ...
            var totalCountHiddenElement = new InvisibleText("", {
                ...
                text: {
                    ...
                    formatter: function (count, nlqSuccess, nlqDescription) {
                        ...
                        return sap.esh.search.ui.resources.i18n.getText("results_count_for_screenreaders", [count.toString()]);
                    },
                },
            });
                ...
                onAfterRendering: function (oEvent) {
                    ...
                    if (oDisplaySwitchButtons.getItems().length === itemLength &&
                        ...
                        oDisplaySwitchButtons.addItem(new SegmentedButtonItem("", {
                            icon: "sap-icon://map",
                            // @ts-ignore
                            tooltip: sap.esh.search.ui.resources.i18n.getText("displayMap"),
                            key: "map",
                        }));
                    }
        ...
        assembleShareButton: function () {
            ...
            oEmailButton.setText(sap.esh.search.ui.resources.i18n.getText("eMailFld"));
            ...
            var oShareButton = new Button("", {
                ...
                // @ts-ignore
                tooltip: sap.esh.search.ui.resources.i18n.getText("shareBtn"),
                press: function () {
            ...
            tabBar.bindAggregation("content", {
                ...
                factory: function (sId, oContext) {
                    ...
                    var buttonAriaLabel = new InvisibleText("", {
                        text: oContext.getProperty("labelPlural") +
                            ", " +
                            sap.esh.search.ui.resources.i18n.getText("dataSource"),
                    }).toStatic();
        ...
        assembleDisplaySwitchTapStrips: function () {
            ...
            var items = [
                new SegmentedButtonItem("", {
                    icon: "sap-icon://list",
                    // @ts-ignore
                    tooltip: sap.esh.search.ui.resources.i18n.getText("displayList"),
                    key: "list",
                ...
                new SegmentedButtonItem("", {
                    ...
                    // @ts-ignore
                    tooltip: sap.esh.search.ui.resources.i18n.getText("displayTable"),
                    key: "table",
                }),
                new SegmentedButtonItem("", {
                    icon: "sap-icon://grid",
                    // @ts-ignore
                    tooltip: sap.esh.search.ui.resources.i18n.getText("displayGrid"),
                    key: "grid",
                    // @ts-ignore
            ...
            if (that.determineIfMaps(that)) {
                items.push(new SegmentedButtonItem("", {
                    icon: "sap-icon://map",
                    // @ts-ignore
                    tooltip: sap.esh.search.ui.resources.i18n.getText("displayMap"),
                    key: "map",
            ...
            if (that.getModel().config.defaultResultViewType === "searchResultTable") {
        ...
        assembleSearchResultGrid: function () {
            var resultGrid;
            if (this.getModel().config.customGridView) {
                    ...
                    if (bData.getObject().isTitle) {
                        ...
                        if (titleInfoIconUrl) {
                            var titleInfoIcon = new Icon("", {
                                ...
                                // @ts-ignore
                                tooltip: sap.esh.search.ui.resources.i18n.getText("collectionShared"),
        ...
        assembleAppSearch: function () {
            ...
            var visualizationInstantiationService = sap.ushell.Container.getService("VisualizationInstantiation");
                ...
                items: {
                    ...
                    factory: function (id, context) {
                        if (that.getModel().getResultToDisplay() === "appSearchResult") {
                            ...
                            var visualizationControl = visualizationInstantiationService.instantiateVisualization(visualization_1);
        ...
        assembleAppContainerResultListItem: function () {
            var that = this;
            // const container = new SearchTilesContainer(
            //     "AppSearchContainerResultListItem",
            //     {
            ...
            //     }
            // );
            // container.bindAggregation(
            //     "tiles",
            //     "tiles",
            //     function (sId, oContext) {
            //         if (
            //             that.getModel().getResultToDisplay() !==
            //             "appSearchResult"
            //         ) {
            //             // bind tile view
                ...
                items: {
                    ...
                    factory: function (id, context) {
                        if (that.getModel().getResultToDisplay() !== "appSearchResult") {
                            ...
                            var visualizationControl = visualizationInstantiationService.instantiateVisualization(visualization_2);
                            visualizationControl.attachPress(function () {
                                that.getModel().eventLogger.logEvent({
                                    type: that.getModel().eventLogger.TILE_NAVIGATE,
            ...
            container.addEventDelegate({
                ...
                onAfterRendering: function () {
                    var that = this;
                    // calculate the suitable items for container, TODO
                    // @ts-ignore
        ...
        createSearchContainer: function (idPrefix) {
            ...
            var resultListContainer = new SearchResultListContainer({
                ...
                noResultScreen: new SearchNoResultScreen({
                    ...
                    toolbar: [
                        new Button({
                            text: sap.esh.search.ui.resources.i18n.getText("noResultsPageBackButton"),
                        ...
                        new Button({
                            text: sap.esh.search.ui.resources.i18n.getText("noResultsPageSearchAllButton"),
            ...
            if (that.getModel().config.layoutUseResponsiveSplitter) {
                ...
                var oSearchLayout = new SearchLayout(this.getId() + "-searchLayout", {
                    resultListContainer: resultListContainer,
                    busyIndicator: new BusyDialog(),
                    isBusy: "{/isBusy}",
                    busyDelay: "{/busyDelay}",
                    ...
                    vertical: false,
                    facets: new SearchFacetFilter({
                        // ToDo: ID --- 'id' shall be first parameter instead of using 'settings.id'
                        id: that.getId() + "-SearchFacetFilter",
                    }),
                });
        ...
        createFooter: function (idPrefix) {
            ...
            var oErrorButton = new Button(this.getId() + "-searchErrorButton", {
                ...
                // @ts-ignore
                tooltip: sap.esh.search.ui.resources.i18n.getText("errorBtn"),
                press: function () {
        ...
        // *******************************************************************
        //   not used by SearchCompositeControl
        // *******************************************************************
        /**
         * @this sap.esh.search.ui.SearchCompositeControl
         */
