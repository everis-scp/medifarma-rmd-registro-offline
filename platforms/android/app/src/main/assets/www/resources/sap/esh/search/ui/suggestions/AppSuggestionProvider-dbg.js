...
sap.ui.define([
    ...
    module.prototype = jQuery.extend(new SuggestionProvider(), {
                ...
                if (firstAppSuggestion) {
                    if (!firstAppSuggestion.combinedSuggestionExists) {
                        var combinedSuggestion = {
                            ...
                            label: sap.esh.search.ui.resources.i18n.getText("suggestion_in_apps", suggestion.label),
                            icon: "",
                        };
                        var inApps = sap.esh.search.ui.resources.i18n.getText("suggestion_in_apps", [""]);
        ...
        createShowMoreSuggestion: function (totalResults) {
            var title = sap.esh.search.ui.resources.i18n.getText("showAllNApps", totalResults);
