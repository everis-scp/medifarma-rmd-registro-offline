...
oFF.UiServerEvent.prototype.createResizeEvent = function(uiContext, uiAppContainer, operation)
{
	if (oFF.notNull(uiAppContainer) && oFF.notNull(uiContext))
	{
		...
		if (oFF.notNull(operation) && operation.size() > oFF.SphereServer.CUSTOM_PARAM_OFFSET)
		{
			var newSizeStr = operation.getStringAt(oFF.SphereServer.CUSTOM_PARAM_OFFSET);
			if (oFF.notNull(newSizeStr))
			{
				newSize = oFF.UiSizeValue.createBySizeString(newSizeStr);
			}
		}
		return oFF.UiResizeEvent.createResize(uiContext, newParameters, newSize);
	}
	throw oFF.XException.createRuntimeException("Event handling failed! Missing uiContext or uiAppContainer. Check remote server events!");
};
oFF.UiServerEvent.prototype.createMoveEvent = function(uiContext, uiAppContainer, operation)
{
	if (oFF.notNull(uiAppContainer) && oFF.notNull(uiContext))
	{
		...
		if (oFF.notNull(operation) && operation.size() > oFF.SphereServer.CUSTOM_PARAM_OFFSET)
		{
			var newPositionStr = operation.getStringAt(oFF.SphereServer.CUSTOM_PARAM_OFFSET);
			if (oFF.notNull(newPositionStr))
			{
				newPos = oFF.UiPositionValue.createByPositionString(newPositionStr);
			}
		}
		return oFF.UiMoveEvent.createMove(uiContext, newParameters, newPos);
	}
	throw oFF.XException.createRuntimeException("Event handling failed! Missing uiContext or uiAppContainer. Check remote server events!");
};
	...
	if (oFF.notNull(uiAppContainer) && oFF.notNull(uiContext))
	{
		...
		if (oFF.notNull(uiManager))
		{
			...
			if (oFF.notNull(operation) && operation.size() > oFF.SphereServer.CUSTOM_PARAM_OFFSET)
			{
				...
				dropPosition = operation.getStringAt(oFF.SphereServer.CUSTOM_PARAM_OFFSET + 4);
			}
			return oFF.UiDropEvent.createDrop(uiContext, newParameters, draggedControl, droppedControl, dropPosition);
		}
	}
	throw oFF.XException.createRuntimeException("Event handling failed! Missing uiContext or uiAppContainer. Check remote server events!");
};
...
oFF.UiServerPrgContainer.prototype.initContainer = function(masterProcess, environment, serverBase, clientBase, parameters, fragment, uiTypeDefs)
{
	...
	if (oFF.notNull(this.m_uiProgram))
	{
		...
		var genesis = oFF.UiGenesis.create(uiServerManager.getAnchor(), oFF.UiPosition.CONTENT, oFF.UiOperation.SET, 0, 0);
...
oFF.UiServerPrgContainer.prototype.newProgram = function(process)
{
	...
	if (oFF.notNull(factory))
	{
		...
		var startCfg = oFF.ProgramStartCfg.create(null, this.m_prgCfgApplicationName, null, args);
...
oFF.SubSysPrgGuiServer = function() {};
oFF.SubSysPrgGuiServer.prototype = new oFF.DfProgramSubSys();
oFF.SubSysPrgGuiServer.prototype._ff_c = "SubSysPrgGuiServer";

oFF.SubSysPrgGuiServer.DEFAULT_PROGRAM_NAME = "@SubSys.Gui.Server";
oFF.SubSysPrgGuiServer.prototype.m_uiServerManager = null;
oFF.SubSysPrgGuiServer.prototype.newProgram = function()
{
	var newObj = new oFF.SubSysPrgGuiServer();
	newObj.setup();
	return newObj;
};
oFF.SubSysPrgGuiServer.prototype.getSubSystemType = function()
{
	return oFF.SubSystemType.GUI;
};
oFF.SubSysPrgGuiServer.prototype.runProcess = function()
{
...
oFF.SubSysPrgGuiServer.prototype.getMainApi = function()
{
...
oFF.SphereClient.prototype.getDefaultProgramName = function()
{
...
oFF.SphereClient.prototype.showInitialScreen = function()
{
	if (this.getGenesis() !== null)
	{
		...
		mainLayout.setPadding(oFF.UiUnitValue.createByCss("20px"));
		mainLayout.setBackgroundColor(oFF.UiColor.createByString("rgba(52,68,114, 0.08)"));
		var titleLbl = mainLayout.addNewItemOfType(oFF.UiType.LABEL);
		titleLbl.setText("Remote Ui connection");
		titleLbl.setFontSize(oFF.UiUnitValue.createByCss("20px"));
		titleLbl.setFontWeight(oFF.UiFontWeight.BOLD);
		titleLbl.setTextAlign(oFF.UiTextAlign.CENTER);
		titleLbl.setPadding(oFF.UiUnitValue.createByCss("20px"));
		...
		this.m_startBtn.setWidth(oFF.UiUnitValue.createByCss("120px"));
		...
		pusher.setMargin(oFF.UiUnitValue.createByCss("auto"));
		this.m_statusMessageLbl = mainLayout.addNewItemOfType(oFF.UiType.LABEL);
		this.m_statusMessageLbl.setText("");
		this.m_statusMessageLbl.setFontSize(oFF.UiUnitValue.createByCss("14px"));
		this.m_statusMessageLbl.setWidth(oFF.UiUnitValue.createByCss("90%"));
		...
		this.m_statusMessageLbl.setPadding(oFF.UiUnitValue.createByCss("10px"));
		this.m_statusMessageLbl.setCornerRadius(oFF.UiUnitValue.createByCss("5px"));
...
oFF.SphereClient.prototype.createFormLine = function(layout, text)
{
	...
	wrapperLayout.setWidth(oFF.UiUnitValue.createByCss("100%"));
	...
	inputLabel.setWidth(oFF.UiUnitValue.createByCss("200px"));
...
oFF.SphereClient.prototype.createProgramComboBox = function(layout)
{
	...
	tmpComboBox.setWidth(oFF.UiUnitValue.createByCss("100%"));
...
oFF.SphereClient.prototype.isLocalClientEvent = function(event)
{
	...
	if (this.getProgramDevice() !== oFF.ProgramDevice.EMBEDDED && oFF.XString.isEqual(oFF.DfUiProgram.DEFAULT_MENUBAR_PROGRAM_NAME_MENU_EXIT_BTN_TAG, event.getControl().getTag()))
	{
		return true;
	}
	return false;
...
oFF.SphereClient.prototype.terminateRemoteProgram = function()
{
	if (this.m_clientStarted)
	{
		this.m_clientStarted = false;
		var ocpFunction = this.prepareFunction();
		ocpFunction.getRequest().setIsFireAndForgetCall(true);
		var initEventList = this.prepareInitEvent(ocpFunction);
...
oFF.SphereClient.prototype.sendResizeEvent = function(event, eventDef)
{
	...
	{
		var newSizeStr = null;
		if (event.getNewSize() !== null)
		{
			newSizeStr = event.getNewSize().getAsString();
		}
		singleEvent.addString(newSizeStr);
	}
	catch (e)
	{
...
oFF.SphereClient.prototype.sendMoveEvent = function(event, eventDef)
{
	...
	try
	{
		var newPositionStr = null;
		if (event.getNewPosition() !== null)
		{
			newPositionStr = event.getNewPosition().getAsString();
		}
		singleEvent.addString(newPositionStr);
	}
	catch (e)
	{
...
oFF.SphereClient.prototype.sendDropEvent = function(event, eventDef)
{
	...
	try
	{
		...
		singleEvent.addString(event.getDropPosition());
	}
	catch (e)
	{
...
oFF.SphereClient.prototype.prepareFunction = function()
{
	...
	ocpFunction.getRequest().setMethod(oFF.HttpRequestMethod.HTTP_POST);
	return ocpFunction;
};
oFF.SphereClient.prototype.passiveValueTransfer = function(eventList)
{
	...
	if (oFF.notNull(select) && select.hasNext())
	{
		...
		while (select.hasNext())
		{
			...
			if (newIsOpen !== oldIsOpen)
			{
				...
				{
					this.addOperation(changedValueTransfer, oFF.UiRemoteProtocol.EV_ON_CHANGED_VALUE, element);
					changedValueTransfer.addString(oFF.UiMethod.OPEN.getMethodName());
				}
				else
				{
					this.addOperation(changedValueTransfer, oFF.UiRemoteProtocol.EV_ON_CHANGED_VALUE, element);
					changedValueTransfer.addString(oFF.UiMethod.CLOSE.getMethodName());
				}
			}
		}
	}
	...
	if (oFF.notNull(select) && select.hasNext())
	{
		...
		while (select.hasNext())
		{
			...
			{
				changedValueTransfer = eventList.addNewList();
				if (newIsMaximized === true)
				{
					this.addOperation(changedValueTransfer, oFF.UiRemoteProtocol.EV_ON_CHANGED_VALUE, element);
					changedValueTransfer.addString(oFF.UiMethod.MAXIMIZE.getMethodName());
					changedValueTransfer.addBoolean(false);
				}
				else
				{
					this.addOperation(changedValueTransfer, oFF.UiRemoteProtocol.EV_ON_CHANGED_VALUE, element);
					changedValueTransfer.addString(oFF.UiMethod.RESTORE.getMethodName());
					changedValueTransfer.addBoolean(false);
				}
			}
		}
	...
	if (oFF.notNull(select) && select.hasNext())
	{
		...
		while (select.hasNext())
		{
			...
			if (newIsHidden !== oldIsHidden)
			{
				...
				{
					this.addOperation(changedValueTransfer, oFF.UiRemoteProtocol.EV_ON_CHANGED_VALUE, element);
					changedValueTransfer.addString(oFF.UiMethod.HIDE.getMethodName());
					changedValueTransfer.addBoolean(false);
					changedValueTransfer.addNull();
				}
				else
				{
					this.addOperation(changedValueTransfer, oFF.UiRemoteProtocol.EV_ON_CHANGED_VALUE, element);
					changedValueTransfer.addString(oFF.UiMethod.SHOW.getMethodName());
					changedValueTransfer.addBoolean(false);
					changedValueTransfer.addNull();
				}
			}
...
{
	this.sendControlEvent(event, oFF.UiEventDef.ON_CONTEXT_MENU);
};
oFF.SphereClient.prototype.onSelect = function(event)
{
	this.sendSelectionEvent(event, oFF.UiEventDef.ON_SELECT);
};
oFF.SphereClient.prototype.onSelectionChange = function(event)
{
	this.sendSelectionEvent(event, oFF.UiEventDef.ON_SELECTION_CHANGE);
};
oFF.SphereClient.prototype.onChange = function(event)
{
	this.sendControlEvent(event, oFF.UiEventDef.ON_CHANGE);
};
oFF.SphereClient.prototype.onLiveChange = function(event)
{
	this.sendControlEvent(event, oFF.UiEventDef.ON_LIVE_CHANGE);
};
oFF.SphereClient.prototype.onClick = function(event)
{
	this.sendControlEvent(event, oFF.UiEventDef.ON_CLICK);
};
oFF.SphereClient.prototype.onDoubleClick = function(event)
{
	this.sendControlEvent(event, oFF.UiEventDef.ON_DOUBLE_CLICK);
};
oFF.SphereClient.prototype.onOpen = function(event)
{
	this.sendControlEvent(event, oFF.UiEventDef.ON_OPEN);
};
oFF.SphereClient.prototype.onClose = function(event)
{
	this.sendControlEvent(event, oFF.UiEventDef.ON_CLOSE);
};
oFF.SphereClient.prototype.onBeforeOpen = function(event)
{
	this.sendControlEvent(event, oFF.UiEventDef.ON_BEFORE_OPEN);
};
oFF.SphereClient.prototype.onBeforeClose = function(event)
{
	this.sendControlEvent(event, oFF.UiEventDef.ON_BEFORE_CLOSE);
};
oFF.SphereClient.prototype.onAfterOpen = function(event)
{
	this.sendControlEvent(event, oFF.UiEventDef.ON_AFTER_OPEN);
};
oFF.SphereClient.prototype.onAfterClose = function(event)
{
	this.sendControlEvent(event, oFF.UiEventDef.ON_AFTER_CLOSE);
};
oFF.SphereClient.prototype.onCollapse = function(event)
{
	this.sendSelectionEvent(event, oFF.UiEventDef.ON_COLLAPSE);
};
oFF.SphereClient.prototype.onExpand = function(event)
{
	this.sendSelectionEvent(event, oFF.UiEventDef.ON_EXPAND);
};
oFF.SphereClient.prototype.onEnter = function(event)
{
	if (this.m_clientStarted)
	{
		this.sendControlEvent(event, oFF.UiEventDef.ON_ENTER);
	}
	else
	{
		this.manualStart();
...
oFF.SphereClient.prototype.onPress = function(event)
{
	...
	{
		this.sendControlEvent(event, oFF.UiEventDef.ON_PRESS);
	}
};
oFF.SphereClient.prototype.onEditingBegin = function(event)
{
	this.sendControlEvent(event, oFF.UiEventDef.ON_EDITING_BEGIN);
};
oFF.SphereClient.prototype.onEditingEnd = function(event)
{
	this.sendControlEvent(event, oFF.UiEventDef.ON_EDITING_END);
};
oFF.SphereClient.prototype.onBack = function(event)
{
	this.sendControlEvent(event, oFF.UiEventDef.ON_BACK);
};
oFF.SphereClient.prototype.onRefresh = function(event)
{
	this.sendControlEvent(event, oFF.UiEventDef.ON_REFRESH);
};
oFF.SphereClient.prototype.onLoadFinished = function(event)
{
	this.sendControlEvent(event, oFF.UiEventDef.ON_LOAD_FINISHED);
};
oFF.SphereClient.prototype.onDelete = function(event)
{
	this.sendSelectionEvent(event, oFF.UiEventDef.ON_DELETE);
};
oFF.SphereClient.prototype.onDetailPress = function(event)
{
	this.sendControlEvent(event, oFF.UiEventDef.ON_DETAIL_PRESS);
};
oFF.SphereClient.prototype.onMove = function(event)
{
	this.sendMoveEvent(event, oFF.UiEventDef.ON_MOVE);
};
oFF.SphereClient.prototype.onMoveStart = function(event)
{
	this.sendMoveEvent(event, oFF.UiEventDef.ON_MOVE_START);
};
oFF.SphereClient.prototype.onMoveEnd = function(event)
{
	this.sendMoveEvent(event, oFF.UiEventDef.ON_MOVE_END);
};
oFF.SphereClient.prototype.onResize = function(event)
{
	this.sendResizeEvent(event, oFF.UiEventDef.ON_RESIZE);
};
oFF.SphereClient.prototype.onSuggestionSelect = function(event)
{
	this.sendSelectionEvent(event, oFF.UiEventDef.ON_SUGGESTION_SELECT);
};
oFF.SphereClient.prototype.onScroll = function(event)
{
	this.sendControlEvent(event, oFF.UiEventDef.ON_SCROLL);
};
oFF.SphereClient.prototype.onScrollLoad = function(event)
{
	this.sendControlEvent(event, oFF.UiEventDef.ON_SCROLL_LOAD);
};
oFF.SphereClient.prototype.onHover = function(event)
{
	this.sendControlEvent(event, oFF.UiEventDef.ON_HOVER);
};
oFF.SphereClient.prototype.onHoverEnd = function(event)
{
	this.sendControlEvent(event, oFF.UiEventDef.ON_HOVER_END);
};
oFF.SphereClient.prototype.onPaste = function(event)
{
	this.sendControlEvent(event, oFF.UiEventDef.ON_PASTE);
};
oFF.SphereClient.prototype.onSelectionFinish = function(event)
{
	this.sendSelectionEvent(event, oFF.UiEventDef.ON_SELECTION_FINISH);
};
oFF.SphereClient.prototype.onSearch = function(event)
{
	this.sendControlEvent(event, oFF.UiEventDef.ON_SEARCH);
};
oFF.SphereClient.prototype.onButtonPress = function(event)
{
	this.sendControlEvent(event, oFF.UiEventDef.ON_BUTTON_PRESS);
};
oFF.SphereClient.prototype.onError = function(event)
{
	this.sendControlEvent(event, oFF.UiEventDef.ON_ERROR);
};
oFF.SphereClient.prototype.onReadLineFinished = function(event)
{
	this.sendControlEvent(event, oFF.UiEventDef.ON_READ_LINE_FINISHED);
};
oFF.SphereClient.prototype.onExecute = function(event)
{
	this.sendControlEvent(event, oFF.UiEventDef.ON_EXECUTE);
};
oFF.SphereClient.prototype.onTerminate = function(event)
{
	this.sendControlEvent(event, oFF.UiEventDef.ON_TERMINATE);
};
oFF.SphereClient.prototype.onFileDrop = function(event)
{
	this.sendControlEvent(event, oFF.UiEventDef.ON_FILE_DROP);
};
oFF.SphereClient.prototype.onDrop = function(event)
{
	this.sendDropEvent(event, oFF.UiEventDef.ON_DROP);
};
...
oFF.UiServerControl.prototype.setTextDecoration = function(textDecoration)
{
	...
	return this.addOperation1Constant(this, oFF.UiProperty.TEXT_DECORATION.getSetterMethodName(), textDecoration);
};
...
oFF.UiServerControl.prototype.setPadding = function(padding)
{
	...
	this._addUnitValueOperation(oFF.UiProperty.PADDING.getSetterMethodName(), padding);
	return this;
};
oFF.UiServerControl.prototype.setMargin = function(margin)
{
	oFF.DfUiContext.prototype.setMargin.call( this , margin);
	this._addUnitValueOperation(oFF.UiProperty.MARGIN.getSetterMethodName(), margin);
	return this;
};
oFF.UiServerControl.prototype.setFontSize = function(fontSize)
{
	oFF.DfUiContext.prototype.setFontSize.call( this , fontSize);
	this._addUnitValueOperation(oFF.UiProperty.FONT_SIZE.getSetterMethodName(), fontSize);
	return this;
};
oFF.UiServerControl.prototype.setCornerRadius = function(cornerRadius)
{
	...
	this._addUnitValueOperation(oFF.UiProperty.CORNER_RADIUS.getSetterMethodName(), cornerRadius);
	return this;
};
oFF.UiServerControl.prototype.setBorderSize = function(borderSize)
{
	oFF.DfUiContext.prototype.setBorderSize.call( this , borderSize);
	this._addUnitValueOperation(oFF.UiProperty.BORDER_SIZE.getSetterMethodName(), borderSize);
	return this;
};
oFF.UiServerControl.prototype.setHeaderHeight = function(headerHeight)
{
	...
	this._addUnitValueOperation(oFF.UiProperty.HEADER_HEIGHT.getSetterMethodName(), headerHeight);
	return this;
};
oFF.UiServerControl.prototype.setFooterHeight = function(footerHeight)
{
	...
	this._addUnitValueOperation(oFF.UiProperty.FOOTER_HEIGHT.getSetterMethodName(), footerHeight);
	return this;
};
...
oFF.UiServerControl.prototype.setBorderColor = function(borderColor)
{
	...
	this._addColorOperation(oFF.UiProperty.BORDER_COLOR.getSetterMethodName(), borderColor);
	return this;
};
oFF.UiServerControl.prototype.setBackgroundColor = function(backgroundColor)
{
	...
	this._addColorOperation(oFF.UiProperty.BACKGROUND_COLOR.getSetterMethodName(), backgroundColor);
	return this;
};
oFF.UiServerControl.prototype.setFontColor = function(fontColor)
{
	oFF.DfUiContext.prototype.setFontColor.call( this , fontColor);
	this._addColorOperation(oFF.UiProperty.FONT_COLOR.getSetterMethodName(), fontColor);
	return this;
};
...
oFF.UiServerControl.prototype.setWidth = function(width)
{
	...
	this._addUnitValueOperation(oFF.UiProperty.WIDTH.getSetterMethodName(), width);
	return this;
};
oFF.UiServerControl.prototype.setHeight = function(height)
{
	oFF.DfUiContext.prototype.setHeight.call( this , height);
	this._addUnitValueOperation(oFF.UiProperty.HEIGHT.getSetterMethodName(), height);
	return this;
};
oFF.UiServerControl.prototype.setX = function(x)
{
	oFF.DfUiContext.prototype.setX.call( this , x);
	this._addUnitValueOperation(oFF.UiProperty.X_POS.getSetterMethodName(), x);
	return this;
};
oFF.UiServerControl.prototype.setY = function(y)
{
	oFF.DfUiContext.prototype.setY.call( this , y);
	this._addUnitValueOperation(oFF.UiProperty.Y_POS.getSetterMethodName(), y);
	return this;
};
...
oFF.UiServerControl.prototype.setColor = function(color)
{
	...
	this._addColorOperation(oFF.UiProperty.COLOR.getSetterMethodName(), color);
	return this;
};
...
{
	var master = this.getMasterNoCall();
	if (oFF.notNull(master) && oFF.notNull(param0))
	{
...
oFF.UiServerControl.prototype._addColorOperation = function(protocol, color)
{
	if (oFF.notNull(color))
	{
		this.addOperation1String(this, protocol, color.getRgbaColor());
	}
	else
	{
		this.addOperation1String(this, protocol, null);
	}
};
oFF.UiServerControl.prototype._addUnitValueOperation = function(protocol, unitValue)
{
	if (oFF.notNull(unitValue))
	{
		this.addOperation1String(this, protocol, unitValue.getCssValue());
	}
	else
	{
		this.addOperation1String(this, protocol, null);
...
oFF.UiRemoteModule.getInstance = function()
{
	if (oFF.isNull(oFF.UiRemoteModule.s_module))
	{
		...
		oFF.ProgramRegistration.setProgramFactory(oFF.SubSysPrgGuiServer.DEFAULT_PROGRAM_NAME, new oFF.SubSysPrgGuiServer());
