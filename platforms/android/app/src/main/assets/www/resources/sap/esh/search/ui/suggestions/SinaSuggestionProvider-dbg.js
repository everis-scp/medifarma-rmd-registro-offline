...
sap.ui.define([
    ...
    module.prototype = jQuery.extend(new SinaBaseSuggestionProvider(), {
        ...
        init: function () {
            ...
            this.suggestionLimit = jQuery.device.is.phone ? 5 : 7;
        ...
        createAllAndAppDsSuggestions: function () {
            ...
            for (var i = 0; i < dataSources.length; ++i) {
                ...
                if (oTestResult.bMatch === true) {
                    ...
                    suggestion.label =
                        "<i>" +
                            sap.esh.search.ui.resources.i18n.getText("searchInPlaceholder", [""]) +
                            "</i> " +
            ...
            for (var i = 0; i < sinaSuggestions.length; ++i) {
                ...
                switch (sinaSuggestion.uiSuggestionType) {
                    case SuggestionType.DataSource:
                        ...
                        //sinaSuggestion.label = /*<i>' + sap.esh.search.ui.resources.i18n.getText("searchInPlaceholder", [""]) + '</i> ' +*/ sinaSuggestion.label;
        ...
        assembleSearchInSuggestionLabel: function (sinaSuggestion) {
            return sap.esh.search.ui.resources.i18n.getText("resultsIn", [
