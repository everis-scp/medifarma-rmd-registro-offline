...
export const getInputDescription = function(
	...
	const oPropertyDataModelObjectPath = enhanceDataModelPath(oDataModelObjectPath, oPropertyPath);
	const oNonEditableValue = getUnitBinding(oPropertyDataModelObjectPath, fieldFormatOptions);
