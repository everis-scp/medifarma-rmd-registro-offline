...
], function (SearchText, SearchLink, SearchTweet, SearchHelper, SearchRelatedObjectsToolbar, Button, ButtonType, Label, Text, CheckBox, ListType, Icon, IconPool, InvisibleText) {
    "use strict";
    var noValue = "\u2013"; // dash
    return sap.ui.core.Control.extend("sap.esh.search.ui.controls.SearchResultListItem", {
        ...
        init: function () {
            ...
            that.setAggregation("_typeLinkAriaDescription", new InvisibleText({
                text: sap.esh.search.ui.resources.i18n.getText("result_list_item_type_link_description"),
            }));
        ...
        _renderExpandButtonContainer: function (oRm) {
            ...
            if (expanded) {
                ...
                tooltip = sap.esh.search.ui.resources.i18n.getText("hideDetailBtn_tooltip");
            }
            else {
                icon = IconPool.getIconURI("slim-arrow-down");
                tooltip = sap.esh.search.ui.resources.i18n.getText("showDetailBtn_tooltip");
            }
        ...
        _renderTitleContainer: function (oRm) {
            ...
            if (!that.getModel().config._eshClickableObjectType ||
                ...
                typeLink.setTooltip(sap.esh.search.ui.resources.i18n.getText("searchInDataSourceTooltip", [
        ...
        _renderAriaDescriptionElementForTitle: function (oRm, withPrefix, doRender) {
            ...
            that._searchResultListPrefix =
                that._searchResultListPrefix ||
                    sap.esh.search.ui.resources.i18n.getText("result_list_announcement_screenreaders");
        ...
        _renderAriaDescriptionElementForAttributes: function (oRm, doRender) {
            ...
            if ($attributes.length === 0) {
                labelledByText = sap.esh.search.ui.resources.i18n.getText("result_list_item_aria_no_attributes");
            }
            else {
                labelledByText = sap.esh.search.ui.resources.i18n.getText("result_list_item_aria_has_attributes");
                $attributes.each(function () {
                    ...
                    if ($this.is(":visible") && $this.attr("aria-hidden") !== "true") {
                        ...
                        labelledByText += sap.esh.search.ui.resources.i18n.getText("result_list_item_aria_attribute_and_value", [attributeKey, attributeValue]);
                    }
                });
            }
        ...
        _renderAriaDescriptionElementForCollapsedOrExpandedState: function (oRm, doRender) {
            ...
            if ($expandButton.css("visibility") !== "hidden") {
                if (that.isShowingDetails()) {
                    labelledByText = sap.esh.search.ui.resources.i18n.getText("result_list_item_aria_expanded");
                    var navigationObjects = this.getNavigationObjects();
                    if (navigationObjects && navigationObjects.length > 0) {
                        labelledByText =
                            sap.esh.search.ui.resources.i18n.getText("result_list_item_aria_has_links") +
                                labelledByText;
                    }
                }
                else {
                    labelledByText = sap.esh.search.ui.resources.i18n.getText("result_list_item_aria_collapsed");
                }
            }
                ...
                progress: function (animation, progress, remainingMs) {
                    if (!secondAnimationStarted && progress > 0.5) {
                        ...
                        jQuery.when(animation01, animation02).done(function () {
                            ...
                            var expandButton = that.getAggregation("_expandButton");
                            expandButton.setTooltip(sap.esh.search.ui.resources.i18n.getText("hideDetailBtn_tooltip"));
                ...
                progress: function (animation, progress, remainingMs) {
                    if (!secondAnimationStarted &&
                        ...
                        jQuery.when(deferredAnimation01, deferredAnimation02).done(function () {
                            ...
                            var expandButton = that.getAggregation("_expandButton");
                            expandButton.setTooltip(sap.esh.search.ui.resources.i18n.getText("showDetailBtn_tooltip"));
