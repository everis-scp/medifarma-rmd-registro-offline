sap.ui.define([
	...
	ContainerToolbar.prototype.init = function() {
		...
		this.oObserver.observe(this, {
			properties: ["enableVariantManagement", "showBirdEyeButton", "showLegendButton", "showTimeZoomControl", "showSettingButton",
	...
	ContainerToolbar.prototype.updateToolbarContents = function () {
		...
		fnInsertOrRemove(PlaceholderType.VariantManagement, this.getEnableVariantManagement(), this._genVariantManagement());
	};
	...
	ContainerToolbar.prototype._genSettings = function () {
		...
		this._oSettingsDialog = new ViewSettingsDialog(this.getId() + "-settingsDialog", {
			...
			confirm: function() {
				...
				if (this.getParent() && this.getParent().isA("sap.gantt.simple.GanttChartContainer")) {
